...
public class E2EMspAccountAdminLinuxAgent extends base.prepare.Is4Org {
	...
	public void beforeClass(String baseURI, String port, String browserType, String maxWaitTimeSec, String logFolder,
		...
		try {
			folderOrFileUtils.DeleteFileOrDirectorOnLinuxNode(Sources, linux_user, linux_pwd, linux_deleteFileOrDirectorScript, "/source/jdk-8u92-windows-x64nbQbt5HL.exe" );
...
//		//delete 
//		try {
//			folderOrFileUtils.mountNetDrive("\\\\10.57.46.89\\C$", "X:", "administrator", "123.com");
//			folderOrFileUtils.copyFile("x:\\source1\\jdk-8u92-windows-x64", "x:\\source\\jdk-8u92-windows-x64");
//			boolean fileExists=folderOrFileUtils.checkFileExist("x:\\source\\jdk-8u92-windows-x64");
