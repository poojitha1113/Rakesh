...
public class CreateCCorgsInfo {
	...
	public CreateCCorgsInfo(ISuite suite, PrintWriter writer) {
	...
	public void create() {
		...
		String direct_org_1 = spogServer.CreateOrganizationWithCheck(direct_org_1_name, SpogConstants.DIRECT_ORG, prefix + "direct_1_user_1@arcserve.com", common_password, "firstName", "lastname");
		...
		String direct_org_2 = spogServer.CreateOrganizationWithCheck(direct_org_2_name, SpogConstants.DIRECT_ORG, prefix + "direct_2_user_1@arcserve.com", common_password, "firstName", "lastname");
//		spogServer.postCloudhybridInFreeTrial(csrToken, direct_org_2, SpogConstants.DIRECT_ORG, false, false);
		...
		String root_msp_org_1 = spogServer.CreateOrganizationWithCheck(root_msp_org_1_name, SpogConstants.MSP_ORG, prefix + "root_msp_1_user_1@arcserve.com", common_password, "firstName", "lastname");
		spogServer.postCloudhybridInFreeTrial(csrToken, root_msp_org_1, SpogConstants.MSP_ORG, false, false);
		spogServer.convertToRootMsp(csrToken, root_msp_org_1, SpogConstants.SUCCESS_GET_PUT_DELETE, test);
		...
		String root_msp_org_2 = spogServer.CreateOrganizationWithCheck(root_msp_org_2_name, SpogConstants.MSP_ORG, prefix + "root_msp_2_user_1@arcserve.com", common_password, "firstName", "lastname");
//		spogServer.postCloudhybridInFreeTrial(csrToken, root_msp_org_2, SpogConstants.MSP_ORG, false, false);
		spogServer.convertToRootMsp(csrToken, root_msp_org_2, SpogConstants.SUCCESS_GET_PUT_DELETE, test);
		...
		String normal_msp_org_1 = spogServer.CreateOrganizationWithCheck(normal_msp_org_1_name, SpogConstants.MSP_ORG, prefix + "normal_msp_1_user_1@arcserve.com", common_password, "firstName", "lastname");
		...
		String normal_msp_org_2 = spogServer.CreateOrganizationWithCheck(normal_msp_org_2_name, SpogConstants.MSP_ORG, prefix + "normal_msp_2_user_1@arcserve.com", common_password, "firstName", "lastname");
//		spogServer.postCloudhybridInFreeTrial(csrToken, normal_msp_org_2, SpogConstants.MSP_ORG, false, false);
		...
		String msp_org1_submsp_org1_id = org4SPOGServer.createSubMSPAccountincc(msp_org1_submsp_org1_name, root_msp_org_1, "first_name", "last_name", prefix+"msp1_submsp1_user1@arcserve.com", datacenters[0], test);
		...
		String msp_org1_submsp_org2_id = org4SPOGServer.createSubMSPAccountincc(msp_org1_submsp_org2_name, root_msp_org_1, "first_name", "last_name", prefix+"msp1_submsp2_user1@arcserve.com", datacenters[0], test);
		...
		String msp_org2_submsp_org1_id = org4SPOGServer.createSubMSPAccountincc(msp_org2_submsp_org1_name, root_msp_org_2, "first_name", "last_name", prefix+"msp2_submsp1_user1@arcserve.com", datacenters[0],test);
		...
		String msp_org2_submsp_org2_id = org4SPOGServer.createSubMSPAccountincc(msp_org2_submsp_org2_name, root_msp_org_2, "first_name", "last_name", prefix+"msp2_submsp2_user1@arcserve.com", datacenters[0],test);
