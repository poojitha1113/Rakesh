...
public class CapacityUsageReportsHelperPage extends SPOGUIServer {

	ReportsPage reportsPage = new  ReportsPage();
	public CapacityUsageReportsHelperPage(String browserType, int maxTimeWaitSec) {
		super(browserType, maxTimeWaitSec);
		// TODO Auto-generated constructor stub
	}

	/*
	 * Create on Demand CapacityUsgae Reports  
	 * 
	 * @author Nagamalleswari.Sykam
	 * @param click 
	 */

	public void createOnDemandCapacityUsageReport(String reportName,
			...
			String toastMessage,
			ExtentTest test) {
		CapacityUsageReportsPage capacityUsageReportsPage = goToCapacityUsageReportPage();
	 ...
	 * @param click 
	 */
	public void createScheduleCapacityUsageReports(String reportName,
			String [] recepientMailIds,
			String reportSoucres,
			String generateType,
	...
	public void createcustomCapacityUsagereports( String reportName,
	 ...
	 *  
	 */
	public void checkreportnameinreportsTable(String reportName,String toastMessage,ExtentTest test) {
	...
	/*
	 * Deleted report form the ManagedReportSchedules table
	 * 
	 * @author Nagamalleswari.Sykam
	 *
	 */
	...
	public void saveSearchFilters(String reportName,String toastMessage,ExtentTest test) {
		CapacityUsageReportsPage capacityUsageReportsPage = goToCapacityUsageReportPage();
