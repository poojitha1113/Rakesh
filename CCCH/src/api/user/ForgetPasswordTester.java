...
public class ForgetPasswordTester  extends base.prepare.PrepareOrgInfo{
	
	 @Parameters({ "pmfKey"})
	 	public ForgetPasswordTester(String pmfKey) {
		super(pmfKey);
	  ...
	  public void beforeClass(String baseURI, String port, String logFolder,  String buildVersion,  String adminUserName, String adminPassword, String csrROAdminUserName, String csrROPwd ) throws UnknownHostException {
		  ...
		  rep = ExtentManager.getInstance("ForgetPasswordTest",logFolder);
	  ...
	  @DataProvider(name = "organizationAndUserInfo1")
		public final Object[][] getOrganizationAndUserInfo1() {
			return new Object[][] {
				{final_direct_user_name_email, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{final_msp_user_name_email, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{final_msp_account_admin_email, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{account_user_email, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{"",SpogConstants.REQUIRED_INFO_NOT_EXIST,ErrorCode.NOT_FIT_LENGTH},
				{"23432qwe",SpogConstants.REQUIRED_INFO_NOT_EXIST,ErrorCode.EMAIL_FORMAT},
				{"23432qwe@email.com",SpogConstants.RESOURCE_NOT_EXIST,ErrorCode.NOT_FOUND_RESOURCE_ID},
				{csrReadOnlyAdminUserName, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{final_root_msp_user_name_email, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{final_root_msp_account_admin_user_name_email, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{final_root_msp_direct_org_user_email, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{final_sub_msp1_user_name_email, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{final_sub_msp1_msp_account_user_name_email, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{final_sub_msp1_account1_user_email, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
	  ...
	  public void forgetPasswordTest(String email, int expectedStatusCode, String expectedErrorCode){
		  
		  test=ExtentManager.getNewTest(this.getClass().getName()+"."+Thread.currentThread() .getStackTrace()[1].getMethodName());
		  test.assignAuthor("shuo.zhang");
		  
		  Response response = userSpogServer.forgetPassword(email, test);
		  userSpogServer.checkForgetPassword(response, expectedStatusCode, expectedErrorCode, test);
