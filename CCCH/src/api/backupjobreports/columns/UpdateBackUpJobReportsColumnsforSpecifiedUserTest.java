...
public class UpdateBackUpJobReportsColumnsforSpecifiedUserTest extends base.prepare.Is4Org {
	...
	// cloudDedupe volume
	@DataProvider(name = "updateBackUpJobReportsColumnsforSpecifiedUserTest_valid")
	public final Object[][] updateBackUpJobReportsColumnsforSpecifiedUserTest_valid() {
		return new Object[][] {
				{ ti.csr_readonly_admin_user_id, ti.csr_readonly_token, "CSR-readonly", ti.csr_org_id,
						new String[] { "true", "false", "none" },
						new String[] { "2", "8", "6", "5", "3", "4", "1", "7", "9" } },
	...
	@Test(dataProvider = "updateBackUpJobReportsColumnsforSpecifiedUserTest_valid")
	public void updateBackUpJobReportsColumnsforSpecifiedUserTest_valid(String user_id, String adminToken,
			String organization_type, String organization_id, String[] visible, String[] order_id) {

		test = ExtentManager
				.getNewTest(organization_type + "Organization updateBackUpJobReportsColumnsforSpecifiedUser");
		...
		test.log(LogStatus.INFO, "update the backup job reports columns with valid scenario");
		response = spogReportServer.updateBackUpJobReportsColumnsForSpecifiedUser(adminToken, user_id, expected_columns,
	...
	@DataProvider(name = "updateBackUpJobReportsColumnsforSpecifiedUserTest_invalid")
	public final Object[][] updateBackUpJobReportsColumnsforSpecifiedUserTest_invalid() {
		return new Object[][] {
				...
				{ "INSUFFICIENT_PERMISSIONS of Direct_sub-org", ti.direct_org1_user1_token, ti.direct_org1_user1_id,
						ti.normal_msp1_suborg2_user1_token, "Direct", ti.direct_org1_id,
						new String[] { "true", "false", "none" },
						new String[] { "1", "8", "9", "5", "3", "4", "7", "2", "6" },
						SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY },
				...
				{ "INSUFFICIENT_PERMISSIONS of msp-suborg", ti.normal_msp_org1_user1_token, ti.normal_msp_org1_user1_id,
						ti.normal_msp1_suborg2_user1_token, "MSP", ti.normal_msp_org1_id,
						new String[] { "true", "false", "none" },
						new String[] { "7", "2", "9", "4", "6", "5", "1", "8", "3" },
						SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY },
				{ "INSUFFICIENT_PERMISSIONS of suborg-direct", ti.normal_msp1_suborg1_user1_token,
						ti.normal_msp1_suborg1_user1_id, ti.direct_org1_user1_token, "SUB_ORG",
						ti.normal_msp1_suborg1_id, new String[] { "true", "false", "none" },
				...
				/*
				 * { "column_id_already_exist", ti.root_msp_org1_user1_token,
				 * ti.root_msp_org1_user1_id, ti.root_msp_org1_user1_token, "MSP",
				 * ti.root_msp_org1_id, new String[] { "true", "false", "none" }, new String[] {
				 * "1", "8", "9", "5", "3", "4", "7", "2", "6" },
				 * SpogConstants.SUCCESS_GET_PUT_DELETE, SpogMessageCode.SUCCESS_GET_PUT_DEL },
				 * { "order_id_already_exist", ti.normal_msp_org1_user1_token,
				 * ti.normal_msp_org1_user1_id, ti.normal_msp_org1_user1_token, "MSP",
				 * ti.normal_msp_org1_id, new String[] { "true", "false", "none" }, new String[]
				 * { "1", "8", "9", "5", "3", "4", "7", "2", "6" },
				 * SpogConstants.SUCCESS_GET_PUT_DELETE, SpogMessageCode.SUCCESS_GET_PUT_DEL },
				 */
				...
				{ "INSUFFICIENT_PERMISSIONS of csrreadonly-direct", ti.csr_readonly_token,
						ti.csr_readonly_admin_user_id, ti.direct_org1_user1_token, "csrreadonly", ti.csr_org_id,
						new String[] { "true", "false", "none" },
						new String[] { "1", "4", "5", "7", "6", "8", "3", "9", "2" },
						SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY },
				...
				{ "order_id_lessthan_1", ti.csr_readonly_token, ti.csr_readonly_admin_user_id, ti.csr_readonly_token,
						...
						SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ORDER_ID_ATLEAST_1 },
				/*
				 * { "column_id_already_exist", ti.csr_readonly_token,
				 * ti.csr_readonly_admin_user_id, ti.csr_readonly_token, "csrreadonly",
				 * ti.csr_org_id, new String[] { "true", "false", "none" }, new String[] { "1",
				 * "8", "9", "5", "3", "4", "7", "2", "6" },
				 * SpogConstants.SUCCESS_GET_PUT_DELETE, SpogMessageCode.SUCCESS_GET_PUT_DEL },
				 * { "order_id_already_exist", ti.csr_readonly_token,
				 * ti.csr_readonly_admin_user_id, ti.csr_readonly_token, "csrreadonly",
				 * ti.csr_org_id, new String[] { "true", "false", "none" }, new String[] { "1",
				 * "8", "9", "5", "3", "4", "7", "2", "6" },
				 * SpogConstants.SUCCESS_GET_PUT_DELETE, SpogMessageCode.SUCCESS_GET_PUT_DEL },
	...
	@Test(dataProvider = "updateBackUpJobReportsColumnsforSpecifiedUserTest_invalid")
	public void updateBackUpJobReportsColumnsforSpecifiedUserTest_invalid(String invalidTestCase, String adminToken,
		...
		test = ExtentManager.getNewTest(
				organization_type + "Organization updateBackUpJobReportsColumnsforSpecifiedUser" + invalidTestCase);
		...
		test.log(LogStatus.INFO, "update the backup job reports columns with invalid scenario" + invalidTestCase);
		response = spogReportServer.updateBackUpJobReportsColumnsForSpecifiedUser(InValidToken, user_id,
