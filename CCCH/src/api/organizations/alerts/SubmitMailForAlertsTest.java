...
public class SubmitMailForAlertsTest extends base.prepare.Is4Org {
	...
	public void beforeClass(String baseURI, String port, String logFolder, String runningMachine, String buildVersion) {
		...
		// get cloud account for the normal msp organization
	...
	public void submitEmailsForAlerts(String org_type, String org_id, String token, String recipient, String alertName,
		...
		for (String item : type) {
			...
			alert_email_id = spogAlertServer.submitEmailsForAlertswithcheck(token, expectedData, user_id, user_email,
			...
			spogAlertServer.deleteEmailsForSpecifiedAlert(token, alert_email_id, SpogConstants.SUCCESS_GET_PUT_DELETE,
	...
	public void submitEmailsForAlerts_invalid(String testcase, String org_id, String alert_type, String token,
		...
		spogAlertServer.submitEmailsForAlertswithcheck(token, expectedData, user_id, user_email, allowed_actions,
