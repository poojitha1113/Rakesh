...
public class UploadPictureForAccount {
	...
	private String initial_msp_account_user_ID = "";
	
	private String initial_msp_account_email_added = "spog_qa_msp_account_zhaoguo_added@arcserve.com";
	private String initial_msp_account_email_full_added = "";
	private String initial_msp_account_first_name_added = "spog_qa_msp_ma";
	private String initial_msp_account_last_name_added = "spog_qa_msp_zhaoguo";
	private String initial_msp_account_user_ID_added = "";
	...
	public void beforeClass(String baseURI, String port, String csrAdminUserName, String csrAdminPassword,
		...
		this.initial_msp_user_ID_added = spogServer.createUserAndCheck(initial_msp_email_full_added, password,
				prefix + initial_msp_first_name_added, prefix + initial_msp_last_name_added, "msp_admin",
				initial_msp_orgID, test);
		
		this.initial_msp_account_email_full = prefix + this.initial_msp_account_email;
		this.initial_msp_account_user_ID = spogServer.createUserAndCheck(initial_msp_account_email_full, password, 
				prefix + initial_msp_account_first_name, prefix + initial_msp_account_last_name, SpogConstants.MSP_ACCOUNT_ADMIN, initial_msp_orgID, test);
		
		this.initial_msp_account_email_full_added = prefix + this.initial_msp_account_email_added;
		this.initial_msp_account_user_ID_added = spogServer.createUserAndCheck(initial_msp_account_email_full_added, password, 
				prefix + initial_msp_account_first_name_added, prefix + initial_msp_account_last_name_added, SpogConstants.MSP_ACCOUNT_ADMIN, initial_msp_orgID, test);
		
		this.initial_sub_orgID_a = spogServer.createAccountWithCheck(initial_msp_orgID, initial_sub_org_name_a,
				initial_msp_orgID);
		
		String[] userIds = new String[] {initial_msp_account_user_ID}; 
		...
		this.initial_sub_user_ID_a_added = spogServer.createUserAndCheck(prefix + this.initial_sub_email_a_added,
				password, prefix + this.initial_sub_first_name_a_added, prefix + this.initial_sub_last_name_a_added,
				SpogConstants.DIRECT_ADMIN, initial_sub_orgID_a, test);
		...
		this.initial_direct_user_ID_added = spogServer.createUserAndCheck(prefix + this.initial_direct_email_added,
				password, prefix + this.initial_direct_first_name_added, prefix + this.initial_direct_last_name_added,
	...
	public final Object[][] uploadPictureValidParams() {
		return new Object[][] {
			{initial_msp_email_full, password, initial_msp_orgID, initial_sub_orgID_a, "./testdata/images/1.PNG"},
			{initial_msp_email_full, password, initial_msp_orgID, initial_sub_orgID_a, "./testdata/images/2.JPG"},
			{initial_msp_email_full, password, initial_msp_orgID, initial_sub_orgID_a, "./testdata/images/3.GIF"},
			{initial_msp_account_email_full, password, initial_msp_orgID, initial_sub_orgID_a, "./testdata/images/3.GIF"},
			{initial_sub_email_full_a, password, initial_msp_orgID, initial_sub_orgID_a, "./testdata/images/3.GIF"},
			};
		}
	...
	public final Object[][] uploadPictureInvalidParams() {
		return new Object[][] {
			{initial_msp_email_full, password, initial_msp_orgID, initial_sub_orgID_a, "./testdata/images/exceed_size.gif", 400, "00100005"},
			{initial_msp_email_full, password, initial_msp_orgID, initial_sub_orgID_a, "./testdata/images/bitmap.bmp", 400, "00100006"},
			{initial_msp_email_full, password, initial_msp_orgID, initial_sub_orgID_a, "", 400, "00900005"},
			{initial_msp_email_full, password, initial_msp_orgID, initial_sub_orgID_a, "./testdata/images/py2exe.exe", 400, "00100006"},
			{initial_msp_account_email_full_added, password, initial_msp_orgID, initial_sub_orgID_a, "./testdata/images/3.GIF", 403, "00100101"},
			{initial_direct_email_full, password, initial_msp_orgID, initial_sub_orgID_a, "./testdata/images/3.GIF", 403, "00100101"},
			{csr_readonly_email, csr_readonly_password, initial_msp_orgID, initial_sub_orgID_a, "./testdata/images/3.GIF", 403, "00100101"},
			};
		}
