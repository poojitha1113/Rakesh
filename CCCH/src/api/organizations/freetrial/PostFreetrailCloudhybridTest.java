...
public class PostFreetrailCloudhybridTest extends base.prepare.PrepareOrgInfo{
	@Parameters({ "pmfKey"})
	public PostFreetrailCloudhybridTest(String pmfKey) {
		super(pmfKey);
	...
	private SPOGServer spogServer;
	  ...
	  @DataProvider(name = "checkCloudhybrid")
	  public final Object[][] checkCloudhybrid() {
			return new Object[][] {
	  ...
	  @Test(dataProvider = "checkCloudhybrid")
	  public void checkCloudhybrid(
		  ...
		  if(checkorg_type!="account"){
			  spogServer.postCloudhybridInFreeTrial(spogServer.getJWTToken(), org_id,checkorg_type,false,false);
		  }		  
		  spogServer.checkCloudhybridInFreeTrial(spogServer.getJWTToken(), org_id,checkorg_type,false,false);
		  
  }
	  
	  @DataProvider(name = "checkCloudhybridNoPermission")
	  public final Object[][] checkCloudhybridNoPermission() {
			return new Object[][] {
				{"msp",this.directOrgId,400,"0030002E","Forbidden to visit the resource."},
				{"msp",this.mspOrgId,400,"0030002E","Forbidden to visit the resource."},
				{"msp",this.accountOrgId,400,"0030002C","Forbidden to visit the resource."},
				{"direct",this.directOrgId,400,"0030002E","Forbidden to visit the resource."},
				{"account",this.accountOrgId,400,"0030002C","Forbidden to visit the resource."},
				{"direct",this.mspOrgId,400,"0030002E","Forbidden to visit the resource."},
				{"account",this.mspOrgId,400,"0030002E","Forbidden to visit the resource."},
				{"account",this.directOrgId,400,"0030002E","Forbidden to visit the resource."},
				
				{"submspaccount",this.directOrgId,400,"0030002E","Forbidden to visit the resource."},
				{"submspaccount",this.accountOrgId,400,"0030002C","Forbidden to visit the resource."},
				{"submspaccountadmin",this.directOrgId,400,"0030002E","Forbidden to visit the resource."},
				{"submspaccountadmin",this.accountOrgId,400,"0030002C","Forbidden to visit the resource."},
				{"submsp",this.directOrgId,400,"0030002E","Forbidden to visit the resource."},
				{"submsp",this.accountOrgId,400,"0030002C","Forbidden to visit the resource."},
				{"rootmspaccount",this.directOrgId,400,"0030002E","Forbidden to visit the resource."},
				{"rootmspaccount",this.accountOrgId,400,"0030002C","Forbidden to visit the resource."},
				{"rootmspaccountadmin",this.directOrgId,400,"0030002E","Forbidden to visit the resource."},
				{"rootmspaccountadmin",this.accountOrgId,400,"0030002C","Forbidden to visit the resource."},
				{"rootmsp",this.directOrgId,400,"0030002E","Forbidden to visit the resource."},
				{"rootmsp",this.accountOrgId,400,"0030002C","Forbidden to visit the resource."},
			};	
		}
	  
	  @Test(dataProvider = "checkCloudhybridNoPermission")
	  public void checkCloudhybridNoPermission(
		  ...
		  spogServer.postCloudhybridInFreeTrialFailed(spogServer.getJWTToken(), org_id,expect_status,error_code,error_message);
  }
	  
	  @DataProvider(name = "checkCloudhybridInvalidOrgId")
	  public final Object[][] checkCloudhybridInvalidOrgId() {
			return new Object[][] {
				{"msp","",404,"00900001","Unable to find the resource."},
				{"msp",null,400,"40000005","The element organizationId is not a UUID."},
				{"msp",spogServer.returnRandomUUID(),404,"0030000A","Forbidden to visit the resource."},
				{"direct","",404,"00900001","Unable to find the resource."},
				{"direct",null,400,"40000005","The element organizationId is not a UUID."},
				{"direct",spogServer.returnRandomUUID(),404,"0030000A","Forbidden to visit the resource."},
				{"account","",404,"00900001","Unable to find the resource."},
				{"account",null,400,"40000005","The element organizationId is not a UUID."},
				{"account",spogServer.returnRandomUUID(),404,"0030000A","Forbidden to visit the resource."}};	
		}
	  
	  @Test(dataProvider = "checkCloudhybridInvalidOrgId")
	  public void checkCloudhybridInvalidOrgId(
			  String loginUserType,String org_id,
			  int expect_status, String error_code, String error_message ) {
		  test=ExtentManager.getNewTest(this.getClass().getName()+"."+Thread.currentThread() .getStackTrace()[1].getMethodName());
		  test.assignAuthor("Shan, Jing");
