...
public class PostFreetrialClouddirectTest extends base.prepare.PrepareOrgInfo{
	@Parameters({ "pmfKey"})
	public PostFreetrialClouddirectTest(String pmfKey) {
		super(pmfKey);
	...
	private SPOGServer spogServer;
	  ...
	  public void checkClouddirect(
		  ...
		  if(checkOrg_type!="account"){
			  spogServer.postClouddirectInFreeTrialFailed(spogServer.getJWTToken(), org_id,400,"0030002E","License already exists.");
		  }else{
			  spogServer.postClouddirectInFreeTrialFailed(spogServer.getJWTToken(), org_id,400,"0030002C","Free trial cannot be added for the given organization type");
		  }
	  ...
	  public final Object[][] checkClouddirectNoPermission() {
			return new Object[][] {
				{"msp",this.directOrgId,403,"00100101","Forbidden to visit the resource."},
				...
				{"direct",this.mspOrgId,403,"00100101","Forbidden to visit the resource."},
				{"account",this.mspOrgId,403,"00100101","Forbidden to visit the resource."},
				{"account",this.directOrgId,403,"00100101","Forbidden to visit the resource."},
			
				{"submspaccount",this.directOrgId,403,"00100101","Forbidden to visit the resource."},
				{"submspaccount",this.accountOrgId,403,"00100101","Forbidden to visit the resource."},
				{"submspaccountadmin",this.directOrgId,403,"00100101","Forbidden to visit the resource."},
				{"submspaccountadmin",this.accountOrgId,403,"00100101","Forbidden to visit the resource."},
				{"submsp",this.directOrgId,403,"00100101","Forbidden to visit the resource."},
				{"submsp",this.accountOrgId,403,"00100101","Forbidden to visit the resource."},
				{"rootmspaccount",this.directOrgId,403,"00100101","Forbidden to visit the resource."},
				{"rootmspaccount",this.accountOrgId,403,"00100101","Forbidden to visit the resource."},
				{"rootmspaccountadmin",this.directOrgId,403,"00100101","Forbidden to visit the resource."},
				{"rootmspaccountadmin",this.accountOrgId,403,"00100101","Forbidden to visit the resource."},
				{"rootmsp",this.directOrgId,403,"00100101","Forbidden to visit the resource."},
				{"rootmsp",this.accountOrgId,403,"00100101","Forbidden to visit the resource."},
			};		
		}
	  ...
	  public void checkClouddirectNoPermission(
		  ...
		  spogServer.postClouddirectInFreeTrialFailed(spogServer.getJWTToken(), org_id,expect_status,error_code,error_message);
  }
