...
public class GetFreetrailCloudhybridTest extends base.prepare.PrepareOrgInfo{
	@Parameters({ "pmfKey"})
	public GetFreetrailCloudhybridTest(String pmfKey) {
		super(pmfKey);
	  ...
	  public void beforeClass(String baseURI, String port, String csrAdminUserName, String csrAdminPassword, String logFolder, String runningMachine, String buildVersion) {
		//this is for update portal
		  ...
		  this.accountOrgId= spogServer.createAccountWithCheck(this.mspOrgId, spogServer.ReturnRandom("spogqa_account_jing_1")+org_prefix,this.mspOrgId);
	  ...
	  public void checkCloudhybrid(
		  ...
		  spogServer.checkCloudhybridInFreeTrial(spogServer.getJWTToken(), org_id,checkorg_type,false,true);
	  ...
	  public void checkCloudhybridNoPermission(
		  ...
		  spogServer.checkCloudhybridInFreeTrialFailed(spogServer.getJWTToken(), org_id,expect_status,error_code,error_message);
    }
