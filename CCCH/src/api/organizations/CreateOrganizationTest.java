...
public class CreateOrganizationTest extends base.prepare.Is4Org{
...
//	  private String buildVersion;
  ...
  public final Object[][] getMspOrDirectOrganizationInfo() {
		return new Object[][] { { spogServer.ReturnRandom(org_prefix) , SpogConstants.DIRECT_ORG, "c_jing_spogqa_direct_org@arcserve.com", "Caworld_2017", "ci","direc_org"}};
  }
  /*
  ...
  public void csrCreateMSPOrDirectOrg(String organizationName, 
	  ...
	  String orgId = spogServer.CreateOrganizationWithCheck(orgName, organizationType,organizationEmail , organizationPwd, organizationFirstName, organizationLastName,test);
	  ...
	  if (organizationEmail!=null ){
		  spogServer.CreateOrganizationFailedWithExpectedStatusCode(spogServer.ReturnRandom(organizationName), organizationType,organizationEmail , organizationPwd, organizationFirstName, organizationLastName,SpogConstants.REQUIRED_INFO_NOT_EXIST,ErrorCode.EMAIL_EXISTS,test);
  ...
  public final Object[][] getMspOrDirectOrganizationInfoWithUser() {
		return new Object[][] { { spogServer.ReturnRandom(org_prefix) , SpogConstants.DIRECT_ORG, "c_jing_spogqa_direct_org@arcserve.com", "Caworld_2017", "ci","direc_org"}, 
			                    { spogServer.ReturnRandom(org_prefix), SpogConstants.MSP_ORG, "c_jing_spogqa_msp_org@arcserve.com", "Caworld_2017", "ci","msp_org"}};
  }
  ...
  public void CreateDuplicateUserUnderDifferentOrgFail(String organizationName, 
	  ...
	  spogServer.DeleteOrganizationWithCheck(orgId, test);
	  orgId = spogServer.CreateOrganizationWithCheck(spogServer.ReturnRandom(organizationName), organizationType, organizationEmail, organizationPwd, organizationFirstName, organizationLastName,test);
	  spogServer.CreateOrganizationFailedWithExpectedStatusCode(spogServer.ReturnRandom(organizationName), organizationType, organizationEmail, organizationPwd, organizationFirstName, organizationLastName,SpogConstants.REQUIRED_INFO_NOT_EXIST,ErrorCode.EMAIL_EXISTS,test);
	  test.log(LogStatus.INFO,"Csr admin can create "+ organizationType + " organization");
	  spogServer.userLogin(organizationEmail, organizationPwd,test);
	  test.log(LogStatus.INFO,organizationType + " organization admin can login successfully");
  ...
  public final Object[][] getIncompleteSubOrganizationInfo() {
		return new Object[][] { { spogServer.ReturnRandom(org_prefix), "", "c_jing_spogqa_sub_org@arcserve.com", "Caworld_2017", "ci","msp_org"},
								{ spogServer.ReturnRandom(org_prefix), "", "","","",""},
								{ spogServer.ReturnRandom(org_prefix), null, "","","",""},
								{ "", SpogConstants.MSP_ORG, "c_jing_spogqa_sub_org@arcserve.com", "Caworld_2017", "ci","msp_org"},
  ...
  public void CreateOrgFailWithIncompleteInfo(String organizationName, 
	  ...
	  spogServer.userLogin(this.csrAdmin, this.csrPwd,test);
	  test.log(LogStatus.INFO,"Login as csr admin");
	  spogServer.CreateOrganizationFailedWithExpectedStatusCode(organizationName, organizationType, spogServer.ReturnRandom(organizationEmail), organizationPwd, organizationFirstName, organizationLastName,SpogConstants.REQUIRED_INFO_NOT_EXIST,ErrorCode.ELEMENT_BLANK,test);
	  test.log(LogStatus.INFO,"Can not create organization with incompleted information such as type or name");
  } 
  
  @DataProvider(name = "csrOrgInfo")
  public final Object[][] getCsrOrgInfo() {
		return new Object[][] { { spogServer.ReturnRandom(org_prefix), SpogConstants.CSR_ORG, "g_jing_spogqa_csr_org@arcserve.com", "welcomeA02", "ci","msp_org"}};
  }
  
 
  //@Test(dataProvider = "csrOrgInfo")
  public void CreateCsrOrgFailed(String organizationName, 
		  String organizationType,
		  String organizationEmail, 
		  String organizationPwd,
		  String organizationFirstName, 
	  ...
	  spogServer.userLogin(this.csrAdmin, this.csrPwd,test);
	  test.log(LogStatus.INFO,"Login as csr admin");
	  spogServer.CreateOrganizationFailedWithExpectedStatusCode(organizationName, organizationType, organizationEmail, organizationPwd, organizationFirstName, organizationLastName,SpogConstants.INSUFFICIENT_PERMISSIONS,ErrorCode.ENROLLMENT_IS_NOT_ALLOWED_ORG_TYPE,test);
	  test.log(LogStatus.INFO,"Can't create another csr org");
  } 
  ...
  public void notLoggedCreateMspOrDirectOrg(String organizationName, 
	  ...
	  //set token as null
	  spogServer.setToken("");
	  spogServer.CreateOrganizationFailedWithExpectedStatusCode(spogServer.ReturnRandom(organizationName), organizationType, spogServer.ReturnRandom(organizationEmail), organizationPwd, organizationFirstName, organizationLastName,SpogConstants.NOT_LOGGED_IN,ErrorCode.AUTHORIZATION_HEADER_BLANK,test);
