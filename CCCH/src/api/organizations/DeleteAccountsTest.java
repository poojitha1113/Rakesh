...
public class DeleteAccountsTest extends base.prepare.PrepareOrgInfo{
	@Parameters({ "pmfKey"})
	public DeleteAccountsTest(String pmfKey) {
		super(pmfKey);
...
//	  private String buildVersion;
	  ...
	  private String accountOrgId1,accountOrgId2,accountOrgId3,mspOrg1accountOrgId,msp_account_admin_token;
	  //end 
	  @BeforeClass
	  ...
	  public void beforeClass(String baseURI, String port, String csrAdminUserName, String csrAdminPassword, String logFolder, String runningMachine, String buildVersion) {
		  ...
		  this.accountOrgId1= spogServer.createAccountWithCheck(this.mspOrgId, "spogqa_account_shaji02"+org_prefix,"");
		  this.accountOrgId2= spogServer.createAccountWithCheck(this.mspOrgId, "spogqa_account_shaji02"+org_prefix,"");	  
		  this.accountOrgId3= spogServer.createAccountWithCheck(this.mspOrgId, "spogqa_account_shaji02"+org_prefix,"");	  
		  ...
		  response = userSpogServer.assignMspAccountAdmins(mspOrgId, accountOrgId3, mspAccountAdminUserIds, csrToken);
...
//			  
			  ...
			  spogServer.deleteMSPAccountsWithCheck(this.mspOrgId, accountOrgIdTmp+","+this.accountOrgId3);
			  ...
			  spogServer.deleteMSPAccountWithExpectedStatusCode(this.mspOrgId1, this.mspOrg1accountOrgId,SpogConstants.INSUFFICIENT_PERMISSIONS, errorCode,test);
			  spogServer.deleteMSPAccountWithExpectedStatusCode(this.root_msp_org_id,this.root_msp_direct_org_id,SpogConstants.INSUFFICIENT_PERMISSIONS, errorCode,test);
			  spogServer.deleteMSPAccountWithExpectedStatusCode(this.sub_msp2_org_id,this.sub_msp2_account1_id,SpogConstants.INSUFFICIENT_PERMISSIONS, errorCode,test);
			  spogServer.deleteMSPAccountsWithCheck(this.sub_msp1_org_id, sub_msp1_account1_id+","+sub_msp1_account2_id);
			  ...
			  spogServer.deleteMSPAccountWithExpectedStatusCode(this.mspOrgId1, this.mspOrg1accountOrgId,SpogConstants.NOT_ALLOWED_ON_RESOURCE, "00300016",test);
			  spogServer.deleteMSPAccountWithExpectedStatusCode(this.root_msp_org_id,this.root_msp_direct_org_id,SpogConstants.NOT_ALLOWED_ON_RESOURCE, "00300016",test);
			  spogServer.deleteMSPAccountWithExpectedStatusCode(this.sub_msp2_org_id,this.sub_msp2_account1_id,SpogConstants.NOT_ALLOWED_ON_RESOURCE, "00300016",test);
			  
		  }else if(usertype.equalsIgnoreCase("rootmsp")) {
			  spogServer.userLogin(this.final_root_msp_user_name_email, OrgPwdForPrepare,test);
			  spogServer.deleteMSPAccountWithExpectedStatusCode(this.mspOrgId1, this.mspOrg1accountOrgId,SpogConstants.INSUFFICIENT_PERMISSIONS, errorCode,test);
			  spogServer.deleteMSPAccountWithExpectedStatusCode(this.sub_msp2_org_id,this.sub_msp2_account1_id,SpogConstants.INSUFFICIENT_PERMISSIONS, errorCode,test);
			  spogServer.deleteMSPAccountsWithCheck(this.root_msp_org_id, root_msp_direct_org_id+","+root_msp_direct_org1_id);
	  ...
	  public void deleteAccountWithDifferentLoginUser(String loginUserType){	 
		  ...
		  if (loginUserType.equalsIgnoreCase("csr")){
			  ...
			  spogServer.userLogin(this.csrAdmin, this.csrPwd,test);
			  test.log(LogStatus.INFO,"Login as csr admin");
			  spogServer.deleteMSPAccountsWithCheck(this.mspOrgId,accountOrgId+","+accountOrgId1);
			  test.log(LogStatus.INFO,"Csr admin can delete accounts"); 
			  ...
			  spogServer.deleteMSPAccountsWithCheck(this.mspOrgId,accountOrgId+","+accountOrgId1);
			  test.log(LogStatus.INFO,"Msp admin can delete accounts"); 
			  spogServer.deleteMSPAccountWithExpectedStatusCode(this.mspOrgId, accountOrgId,SpogConstants.RESOURCE_NOT_EXIST, errorCode,test);
			  test.log(LogStatus.INFO,"Csr admin can not delete the deleted account again"); 
			  ...
			  spogServer.deleteMSPAccountsWithExpectedStatusCode(this.mspOrgId, accountOrgId+","+accountOrgId1, SpogConstants.INSUFFICIENT_PERMISSIONS,ErrorCode.RESOURCE_PERMISSION,test);
			  ...
			  spogServer.deleteMSPAccountsWithExpectedStatusCode(this.mspOrgId, accountOrgId+","+accountOrgId1, SpogConstants.NOT_ALLOWED_ON_RESOURCE,ErrorCode.NO_PERMISSION_DEL_ITSELF,test);
			  ...
			  spogServer.userLogin(this.csrAdmin, this.csrPwd,test);
			  Response response = userSpogServer.assignMspAccountAdmins(mspOrgId, accountOrgId1, mspAccountAdminUserIds, spogServer.getJWTToken());
			  userSpogServer.assignMspAccountAdminsWithCheck(response, mspAccountAdminUserIds, spogServer.getJWTToken());
			  spogServer.userLogin(this.mspAccountAdminEmailForPrepare, OrgPwdForPrepare);
			  test.log(LogStatus.INFO,"Login as msp account admin");			 
			  spogServer.deleteMSPAccountsWithExpectedStatusCode(this.mspOrgId, accountOrgId+","+accountOrgId1, SpogConstants.NOT_ALLOWED_ON_RESOURCE,ErrorCode.MSP_AA_CAN_NOT_DEL_ORG,test);
			  test.log(LogStatus.INFO,"Account admin can not delete assigned account");
			  spogServer.deleteMSPAccountsWithExpectedStatusCode(this.mspOrgId, this.accountOrgId1, SpogConstants.NOT_ALLOWED_ON_RESOURCE,ErrorCode.MSP_AA_CAN_NOT_DEL_ORG,test);
			  test.log(LogStatus.INFO,"Account admin can not delete assigned account");
		  }		  
	  }
	  ...
	  public void CanNotDeleteAccountWithInvalidParentId(String loginUserType,String parentId){	 
		  ...
		  if (loginUserType.equalsIgnoreCase("csr")){
			  if(uuidValid){
				  spogServer.deleteMSPAccountsWithExpectedStatusCode(parentId,  this.accountOrgId+","+this.accountOrgId1,SpogConstants.RESOURCE_NOT_EXIST,ErrorCode.RESOURCE_NOT_FOUND_OR_REMOVED,test);
				  test.log(LogStatus.INFO,"Csr admin can not delete account with non standard uuid as parent id will be failed");
			  }else{
				  spogServer.deleteMSPAccountsWithExpectedStatusCode(parentId,this.accountOrgId+","+this.accountOrgId1, SpogConstants.REQUIRED_INFO_NOT_EXIST,errorCode,test);
			  ...
			  test.log(LogStatus.INFO,"Login as prepared msp admin");
			  if(uuidValid){
				  spogServer.deleteMSPAccountsWithExpectedStatusCode(parentId, this.accountOrgId+","+this.accountOrgId1,SpogConstants.RESOURCE_NOT_EXIST,ErrorCode.RESOURCE_PERMISSION,test);
				  test.log(LogStatus.INFO,"Msp admin can not delete account with non standard uuid as parent id will be failed");
			  }else{
				  spogServer.deleteMSPAccountsWithExpectedStatusCode(parentId, this.accountOrgId+","+this.accountOrgId1,SpogConstants.REQUIRED_INFO_NOT_EXIST,ErrorCode.RESOURCE_PERMISSION,test);
			  ...
			  if(uuidValid){
				  ...
				  spogServer.deleteMSPAccountsWithExpectedStatusCode(parentId,this.accountOrgId+","+this.accountOrgId1,SpogConstants.REQUIRED_INFO_NOT_EXIST,ErrorCode.ELEMENT_NOT_UUID,test);
	  ...
	  public void notLoggedDeleteAccount(){	 
		  ...
		  test.assignAuthor("Shan, Jing");
		  spogServer.setToken("");
		  spogServer.deleteMSPAccountsWithExpectedStatusCode(this.mspOrgId,this.accountOrgId+","+this.accountOrgId1,SpogConstants.NOT_LOGGED_IN,ErrorCode.AUTHORIZATION_HEADER_BLANK, test);
		  spogServer.deleteMSPAccountsWithExpectedStatusCode(this.csrOrgId,this.accountOrgId+","+this.accountOrgId1, SpogConstants.NOT_LOGGED_IN, ErrorCode.AUTHORIZATION_HEADER_BLANK,test);
		  spogServer.deleteMSPAccountsWithExpectedStatusCode(this.directOrgId, this.accountOrgId+","+this.accountOrgId1,SpogConstants.NOT_LOGGED_IN,ErrorCode.AUTHORIZATION_HEADER_BLANK, test);
		  spogServer.deleteMSPAccountsWithExpectedStatusCode(this.accountOrgId,this.accountOrgId+","+this.accountOrgId1, SpogConstants.NOT_LOGGED_IN,ErrorCode.AUTHORIZATION_HEADER_BLANK, test);
