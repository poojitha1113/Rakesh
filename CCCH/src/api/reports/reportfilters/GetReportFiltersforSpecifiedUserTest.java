...
public class GetReportFiltersforSpecifiedUserTest extends base.prepare.Is4Org {
	...
	public final Object[][] createreportfilters() {
		...
		return new Object[][] {
				...
				{ "Create report filter for backup jobs for direct org", ti.direct_org1_id, ti.direct_org1_id,
						...
						"is_default;=;" + true + ",report_filter_type;=;backup_jobs",
				...
				{ "get report filter for backup jobs for direct org", ti.direct_org1_id, ti.direct_org1_id,
						...
						DestinationType.cloud_direct_volume.toString(), "backup",
						spogServer.ReturnRandom("filter_name"), "Tue,Wed,Mon", "backup_jobs", true,
						"is_default;=;true,report_filter_type;=;backup_jobs", spogServer.ReturnRandom("groupName"),
				...
				{ "get report filter for jobs and destinations for direct org", ti.direct_org1_id, ti.direct_org1_id,
						...
						"is_default;=;true,report_filter_type;=;jobs_and_destinations",
						spogServer.ReturnRandom("groupName"), spogServer.ReturnRandom("groupDescription"), 2, 1, 20,
						SpogConstants.SUCCESS_POST, null },
				{ "get report filter for jobs and destinations for direct org", ti.direct_org1_id, ti.direct_org1_id,
						ti.direct_org1_user1_id, ti.direct_org1_user1_token, spogServer.ReturnRandom("source_name"),
				...
				{ "get report filter for restore jobs for direct org", ti.direct_org1_id, ti.direct_org1_id,
						...
						"Thu,Sat", "restore_jobs", true, "is_default;=;true,report_filter_type;=;restore_jobs",
						spogServer.ReturnRandom("groupName"), spogServer.ReturnRandom("groupDescription"), 2, 1, 20,
						SpogConstants.SUCCESS_POST, null },
				{ "get report filter for data transfer for direct org", ti.direct_org1_id, ti.direct_org1_id,
						...
						"Thu,Sat", "data_transfer", true, "is_default;=;true,report_filter_type;=;data_transfer",
						spogServer.ReturnRandom("groupName"), spogServer.ReturnRandom("groupDescription"), 2, 1, 20,
						SpogConstants.SUCCESS_POST, null },
				{ "get report filter for capacity usage for direct org", ti.direct_org1_id, ti.direct_org1_id,
						...
						DestinationType.cloud_direct_volume.toString(), "merge", spogServer.ReturnRandom("filter_name"),
						"Thu,Sat", "capacity_usage", true, "is_default;=;true,report_filter_type;=;capacity_usage",
						spogServer.ReturnRandom("groupName"), spogServer.ReturnRandom("groupDescription"), 2, 1, 20,
						SpogConstants.SUCCESS_POST, null },
				// MSP

				{ "get report filter for backup jobs for msp", ti.normal_msp_org1_id, ti.normal_msp_org1_id,
						...
						"is_default;=;true,report_filter_type;=;backup_jobs", spogServer.ReturnRandom("groupName"),
						spogServer.ReturnRandom("groupDescription"), 2, 1, 20, SpogConstants.SUCCESS_POST, null },
				{ "get report filter for jobs and destinations for msp", ti.normal_msp_org1_id, ti.normal_msp_org1_id,
						ti.normal_msp_org1_user1_id, ti.normal_msp_org1_user1_token,
						spogServer.ReturnRandom("source_name"), spogServer.ReturnRandom("destination_name"),
				...
				{ "get report filter for jobs and destinations for msp", ti.normal_msp_org1_id, ti.normal_msp_org1_id,
						...
						spogServer.ReturnRandom("groupName"), spogServer.ReturnRandom("groupDescription"), 2, 1, 20,
						SpogConstants.SUCCESS_POST, null },
				{ "get report filter for restore jobs for msp", ti.normal_msp_org1_id, ti.normal_msp_org1_id,
						ti.normal_msp_org1_user1_id, ti.normal_msp_org1_user1_token,
						spogServer.ReturnRandom("source_name"), spogServer.ReturnRandom("destination_name"),
						...
						spogServer.ReturnRandom("groupName"), spogServer.ReturnRandom("groupDescription"), 2, 1, 20,
						SpogConstants.SUCCESS_POST, null },
				{ "get report filter for data transfer for msp", ti.normal_msp_org1_id, ti.normal_msp_org1_id,
						ti.normal_msp_org1_user1_id, ti.normal_msp_org1_user1_token,
						spogServer.ReturnRandom("source_name"), spogServer.ReturnRandom("destination_name"),
						...
						spogServer.ReturnRandom("groupName"), spogServer.ReturnRandom("groupDescription"), 2, 1, 20,
						SpogConstants.SUCCESS_POST, null },
				{ "get report filter for capacity usage for msp", ti.normal_msp_org1_id, ti.normal_msp_org1_id,
						ti.normal_msp_org1_user1_id, ti.normal_msp_org1_user1_token,
						spogServer.ReturnRandom("source_name"), spogServer.ReturnRandom("destination_name"),
				...
				{ "get report filter for capacity usage for suborg using msp account admin token",
						...
						spogServer.ReturnRandom("groupName"), spogServer.ReturnRandom("groupDescription"), 2, 1, 20,
						SpogConstants.SUCCESS_POST, null },
				{ "get report filter for capacity usage for suborg using unassigned msp account admin token",
						ti.normal_msp_org1_id, ti.normal_msp_org1_id, ti.normal_msp_org1_msp_accountadmin1_id,
						ti.normal_msp_org1_msp_accountadmin1_token, spogServer.ReturnRandom("source_name"),
						spogServer.ReturnRandom("destination_name"), UUID.randomUUID().toString(), "last_1_year",
						System.currentTimeMillis(), System.currentTimeMillis() + 3600000, "capacity_usage", "forever",
						DestinationType.cloud_direct_volume.toString(), "merge", spogServer.ReturnRandom("filter_name"),
				...
				{ "get report filter for backup jobs for suborg using msp token", ti.normal_msp1_suborg1_id,
						ti.normal_msp1_suborg1_id, ti.normal_msp1_suborg1_user1_id, ti.normal_msp_org1_user1_token,
						spogServer.ReturnRandom("source_name"), spogServer.ReturnRandom("destination_name"),
						UUID.randomUUID().toString(), "last_7_days", System.currentTimeMillis(),
						System.currentTimeMillis() + 3600000, "backup_jobs", "7D",
						DestinationType.cloud_direct_volume.toString(), "backup",
				...
				{ "Get report filter for backup jobs for msp using csrreadonly token",
						ti.normal_msp_org1_id + "," + ti.direct_org1_id, ti.csr_org_id, ti.csr_readonly_admin_user_id,
						ti.csr_readonly_token, spogServer.ReturnRandom("source_name"),
						spogServer.ReturnRandom("destination_name"), UUID.randomUUID().toString(), "last_7_days",
						System.currentTimeMillis(), System.currentTimeMillis() + 3600000, "backup_jobs", "7D",
						DestinationType.cloud_direct_volume.toString(), "backup",
				...
				{ "Get report filter for capacity usage for msp using csrreadonly token", ti.normal_msp_org1_id,
						...
						SpogConstants.SUCCESS_POST, null },
				// monitor cases
				{ "Create report filter for backup jobs for direct org using monitor token", ti.direct_org1_id,
				...
				{ "Create report filter for backup jobs for msp org using monitor token", ti.normal_msp_org1_id,
				...
				{ "Create report filter for backup jobs for sub org using monitor token", ti.normal_msp1_suborg1_id,
				...
				{ "Create report filter for backup jobs for root msp org using monitor token", ti.root_msp_org1_id,
				...
				{ "Create report filter for backup jobs for root sub org using monitor token", ti.root_msp1_suborg1_id,
				...
				{ "Create report filter for backup jobs for root submsp org using monitor token",
				...
				{ "Create report filter for backup jobs for submsp sub org using monitor token",
						ti.msp1_submsp1_sub_org1_id, ti.msp1_submsp1_sub_org1_id,
	...
	public void getereportfiltersforloggedInUser_200(String caseType, String organization_ids, String org_id,
			...
			String report_filter_type, boolean is_default, String filterStr, String groupName, String groupDescription,
			int noOfSourceGroupsToCreate, int curr_page, int page_size, int expectedStatusCode,
	...
	/*	if (!(caseType.contains("csrreadonly"))) {
		...
		String filter_id = spogReportServer.createReportFilterForSpecifiedUserWithCheck(user_id, org_id, validToken,
				composefilter1, expectedStatusCode, expectedErrorMessage, test);
		...
		composefilter2 = spogReportServer.composeReportFilterInfo(null, destination_name, policy_id, destination_id,
				...
				destination_type, job_type, retention_id, null, filter_name + 2, is_default, report_filter_type);

		test.log(LogStatus.INFO, caseType);
		filter_id = spogReportServer.createReportFilterForSpecifiedUserWithCheck(user_id, org_id, validToken,
				composefilter2, expectedStatusCode, expectedErrorMessage, test);
		...
		composefilter3 = spogReportServer.composeReportFilterInfo(null, destination_name, policy_id, destination_id,
				...
				job_type, retention_id, null, filter_name + 3, is_default, report_filter_type);

		test.log(LogStatus.INFO, caseType);
		filter_id = spogReportServer.createReportFilterForSpecifiedUserWithCheck(user_id, org_id, validToken,
				composefilter3, expectedStatusCode, expectedErrorMessage, test);

		expectedData.add(composefilter3);
		filter_ids.add(filter_id);

		test.log(LogStatus.INFO, "Get Report Filters");
		spogReportServer.getReportFilterForSpecifiedUserWithCheck(validToken, user_id, org_id, expectedData, filterStr,
				curr_page, page_size, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);

		for (int j = 0; j < filter_ids.size(); j++) {

			test.log(LogStatus.INFO, " Deleting filters");
			spogReportServer.deleteReportFiltersForSpecifiedUser(validToken, user_id, filter_ids.get(j),
	...
	public Object[][] getReportFiltersInvalid() {
		...
		return new Object[][] {
				{ "Get report filters with invalid token", "INVALID TOKEN", UUID.randomUUID().toString(),
						UUID.randomUUID().toString(), "is_default;=;true,report_filter_type;=;restore_jobs", 2, 20,
				...
				/*{ "Get report filters with user id that doesnot exist for direct organization",
							...
							"", 2, 20, SpogConstants.RESOURCE_NOT_EXIST,
	...
	public void getReportFiltersInvalid_401_404(String caseType, String token, String user_id, String org_id,
		...
		test.log(LogStatus.INFO, caseType);
		spogReportServer.getReportFilterForSpecifiedUserWithCheck(token, user_id, org_id, expectedData, filterStr,
				curr_page, page_size, expectedStatusCode, expectedErrorMessage, test);
	...
	public Object[][] getReportFiltersInvalid_403() {
		...
		return new Object[][] {
				{ "Get report filters in msp org using sub org token", ti.normal_msp_org1_id,
						...
						"is_default;=;true,report_filter_type;=;restore_jobs", 2, 20,
				...
				{ "Get report filters in direct org using suborg token", ti.direct_org1_id, ti.direct_org1_user1_id,
						ti.normal_msp1_suborg1_user1_token, "is_default;=;true,report_filter_type;=;restore_jobs", 2,
						20, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY },
				...
				{ "Get report filters in direct org using rootsuborg token", ti.direct_org1_id, ti.direct_org1_user1_id,
						ti.root_msp1_suborg1_user1_token, "is_default;=;true,report_filter_type;=;restore_jobs", 2, 20,
						SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY },
				...
				{ "Get report filters in direct org using submsp token", ti.direct_org1_id, ti.direct_org1_user1_id,
						ti.root_msp1_submsp1_user1_token, "is_default;=;true,report_filter_type;=;restore_jobs", 2, 20,
						SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY },
				...
				{ "Get report filters in csr org using direct token", ti.csr_org_id, ti.csr_readonly_admin_user_id,
						ti.direct_org1_user1_token, "is_default;=;true,report_filter_type;=;restore_jobs", 2, 20,
						SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY },
				{ "Get report filters in csr org using msp token", ti.csr_org_id, ti.csr_readonly_admin_user_id,
						ti.normal_msp_org1_user1_token, "is_default;=;true,report_filter_type;=;restore_jobs", 2, 20,
						SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY },
...
/*
	...
	public void getReportFiltersInvalid_403(String caseType, String org_id, String user_id, String token,
		...
		test.log(LogStatus.INFO, caseType);
		spogReportServer.getReportFilterForSpecifiedUserWithCheck(token, user_id, org_id, new ArrayList<>(), filterStr,
				curr_page, page_size, expectedStatusCode, expectedErrorMessage, test);
