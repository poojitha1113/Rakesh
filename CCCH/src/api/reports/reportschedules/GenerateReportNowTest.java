...
public class GenerateReportNowTest extends base.prepare.Is4Org {
   ...
   /* private ExtentReports rep;
	...
	ArrayList<String> direct_schedule_id = new ArrayList<>();
	ArrayList<String> msp_schedule_id = new ArrayList<>();
	ArrayList<String> submsp_schedule_id = new ArrayList<>();
	ArrayList<String> suborg_schedule_id = new ArrayList<>();
	ArrayList<String> mspAccAdmin_schedule_id = new ArrayList<>();
	...
	public void generateReportNowValid(String organizationType, String token, String report_name, String report_type, String date_range_type, long date_range_start_ts,
		...
		test.log(LogStatus.INFO, "Generate report now for a scheduled item");
		spogReportServer.generateReportNowWithCheck(token, schedule_id, scheduleInfo, SpogConstants.SUCCESS_GET_PUT_DELETE, expectedErrorMessage, test);
		
		if (organizationType.equalsIgnoreCase("direct")) {
			direct_schedule_id.add(schedule_id);
		}else if(organizationType.equalsIgnoreCase("submsp")){
			submsp_schedule_id.add(schedule_id);
		} else if(organizationType.equalsIgnoreCase("msp")){
			msp_schedule_id.add(schedule_id);
		}else if (organizationType.equalsIgnoreCase("suborg")) {
			suborg_schedule_id.add(schedule_id);
		}else if(organizationType.contains("mspAccAdminToken")) {
			mspAccAdmin_schedule_id.add(schedule_id);
		}
	}
	
	@DataProvider(name="reportInvalid403")
	public Object[][] reportInvalid403(){
		return new Object[][] {
			{"direct with msp token", ti.root_msp_org1_user1_token, direct_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"direct with suborg token", ti.root_msp1_suborg1_user1_token, direct_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"direct with msp account admin token", ti.root_msp_org1_msp_accountadmin1_token, direct_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			
			{"msp with direct token", ti.direct_org1_user1_token, msp_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"msp with suborg token", ti.root_msp1_suborg1_user1_token, msp_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"msp with msp2 token", ti.root_msp_org2_user1_token, msp_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"msp with submsp token", ti.root_msp1_submsp1_user1_token, msp_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"msp with submsp suborg token", ti.msp1_submsp1_suborg1_user1_token, msp_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			
			{"submsp with direct token", ti.direct_org1_user1_token, submsp_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"submsp with suborg token", ti.root_msp1_suborg1_user1_token, submsp_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"submsp with msp token", ti.root_msp_org2_user1_token, submsp_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"submsp with submsp2 token", ti.root_msp1_submsp2_user1_token, submsp_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"submsp with submsp suborg2 token", ti.msp1_submsp1_suborg2_user1_token, submsp_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			
			
			{"suborg with direct token", ti.direct_org1_user1_token, suborg_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"suborg with direct token", ti.root_msp1_suborg2_user1_token, suborg_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			
			//csr readonly user token
			{"direct with csr_readonly_token", ti.csr_readonly_token, direct_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"msp with csr_readonly_token", ti.csr_readonly_token, msp_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"suborg with csr_readonly_token", ti.csr_readonly_token, suborg_schedule_id, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY},
		};
	}
	@Test(dataProvider="reportInvalid403",dependsOnMethods="generateReportNowValid")
	public void generateReportNowInvalid_403(String caseType, String token, ArrayList<String> schedule_ids, int expectedStatusCode, SpogMessageCode expectedErrorMessage) {
		
		for (int i = 0; i < schedule_ids.size(); i++) {
			test.log(LogStatus.INFO, "generate report now for "+caseType);
			spogReportServer.generateReportNowWithCheck(token, schedule_ids.get(i), null, expectedStatusCode, expectedErrorMessage, test);	
		}		
	}
	
	@DataProvider(name="reportInvalid")
	public Object[][] reportInvalid(){
		return new Object[][]{
			{"Generate report now with invalid schedule_id of direct org", ti.direct_org1_user1_token, "invalidID", SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_IS_NOT_UUID},
			{"Generate report now with invalid schedule_id of msp org", ti.root_msp_org1_user1_token, "invalidID", SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_IS_NOT_UUID},
			{"Generate report now with invalid schedule_id of sub org", ti.root_msp1_suborg1_user1_token, "invalidID", SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_IS_NOT_UUID},
			{"Generate report now with invalid schedule_id of sub org with msp account admin token", ti.root_msp_org1_msp_accountadmin1_token, "invalidID", SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_IS_NOT_UUID},
			{"Generate report now with null as schedule_id of direct org", ti.direct_org1_user1_token, null, SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_IS_NOT_UUID},
			{"Generate report now with null as schedule_id of msp org", ti.root_msp_org1_user1_token, null, SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_IS_NOT_UUID},
			{"Generate report now with null as schedule_id of sub org", ti.root_msp1_suborg1_user1_token, null, SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_IS_NOT_UUID},
			{"Generate report now with null as schedule_id of sub org with msp account admin token", ti.root_msp_org1_msp_accountadmin1_token, null, SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_IS_NOT_UUID},
			{"Generate report now with invalid schedule_id of msp org", ti.root_msp1_submsp1_user1_token, "invalidID", SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_IS_NOT_UUID},
			{"Generate report now with invalid schedule_id of sub org", ti.msp1_submsp1_suborg1_user1_token, "invalidID", SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_IS_NOT_UUID},
			{"Generate report now with invalid schedule_id of sub org with msp account admin token", ti.root_msp1_submsp1_account_admin_token, "invalidID", SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_IS_NOT_UUID},
			
			{"Generate report now with invalid token", "token", UUID.randomUUID().toString(), SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT},
			{"Generate report now with missing token", "", UUID.randomUUID().toString(), SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED},
			
			{"Generate report now with schedule_id that does not exist of direct org", ti.direct_org1_user1_token, UUID.randomUUID().toString(), SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.NOT_FOUND_SCHEDULE_WITH_ID},
			{"Generate report now with schedule_id that does not exist of msp org", ti.root_msp_org1_user1_token, UUID.randomUUID().toString(), SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.NOT_FOUND_SCHEDULE_WITH_ID},
			{"Generate report now with schedule_id that does not exist of sub org", ti.root_msp1_suborg1_user1_token, UUID.randomUUID().toString(), SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.NOT_FOUND_SCHEDULE_WITH_ID},
			{"Generate report now with schedule_id that does not exist of sub org with msp account admin token", ti.root_msp_org1_msp_accountadmin1_token, UUID.randomUUID().toString(), SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.NOT_FOUND_SCHEDULE_WITH_ID},
			{"Generate report now with schedule_id that does not exist of sub msp org", ti.root_msp1_submsp1_user1_token, UUID.randomUUID().toString(), SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.NOT_FOUND_SCHEDULE_WITH_ID},
			{"Generate report now with schedule_id that does not exist of sub msp sub org", ti.msp1_submsp1_suborg1_user1_token, UUID.randomUUID().toString(), SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.NOT_FOUND_SCHEDULE_WITH_ID},
			{"Generate report now with schedule_id that does not exist of sub org with sub msp account admin token", ti.root_msp1_submsp1_account_admin_token, UUID.randomUUID().toString(), SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.NOT_FOUND_SCHEDULE_WITH_ID},
		};
	}
	
	@Test(dataProvider="reportInvalid",enabled=true)
	public void generateReportNowInvalid(String caseType, String token, String schedule_id, int expectedStatusCode, SpogMessageCode expectedErrorMessage) {
		
		test.log(LogStatus.INFO, caseType);
		spogReportServer.generateReportNowWithCheck(token, schedule_id, null, expectedStatusCode, expectedErrorMessage, test);
