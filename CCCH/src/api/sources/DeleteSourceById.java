...
public class DeleteSourceById extends base.prepare.Is4Org {
	...
	public final Object[][] getSourceInfo() {
		return new Object[][] {
				/*{ ti.normal_msp1_suborg1_user1_email, ti.common_password, "suborg", SourceType.machine,
						...
						ConnectionStatus.online, OSMajor.windows.name().toString(), "sql;exchange", "Ramya_vm2", null,
				...
				{ ti.direct_org1_user1_email, ti.common_password, "direct", SourceType.machine, SourceProduct.udp,
						...
						OSMajor.windows.name().toString(), "", "Ramya_vm1", null, null, null, null, null, null, null },

				{ ti.normal_msp1_suborg1_user1_email, ti.common_password, "suborg", SourceType.machine,
						SourceProduct.udp, ti.normal_msp1_suborg1_id, msp_cloud_account_id, ProtectionStatus.unprotect,
						ConnectionStatus.online, OSMajor.windows.name().toString(), "sql;exchange", null, null, null, null, "64",
						null, null, null },
				{ ti.normal_msp1_suborg1_user1_email, ti.common_password, "suborg", SourceType.machine,
						SourceProduct.udp, ti.normal_msp1_suborg1_id, msp_cloud_account_id, ProtectionStatus.unprotect,
						ConnectionStatus.online, OSMajor.windows.name().toString(), "", null, null, null, null, null, "1.0.0",
						null, null },
				{ ti.normal_msp1_suborg1_user1_email, ti.common_password, "suborg", SourceType.machine,
						SourceProduct.udp, ti.normal_msp1_suborg1_id, msp_cloud_account_id, ProtectionStatus.unprotect,
						ConnectionStatus.online, OSMajor.windows.name().toString(), "sql;exchange", "Ramya_vm2", null,
				...
				{ ti.normal_msp1_suborg1_user1_email, ti.common_password, "suborg", SourceType.machine,
						SourceProduct.udp, ti.normal_msp1_suborg1_id, msp_cloud_account_id, ProtectionStatus.unprotect,
						ConnectionStatus.online, OSMajor.windows.name().toString(), "sql;exchange", null, null, null, null, null,
						"1.0.0", null, null },
				{ ti.normal_msp_org1_msp_accountadmin1_email, ti.common_password, "msp_account_admin",
						...
						ProtectionStatus.unprotect, ConnectionStatus.online, OSMajor.windows.name().toString(), "sql;exchange",
				...
				{ ti.direct_org1_user1_email, ti.common_password, "direct", SourceType.one_drive, SourceProduct.udp,
						ti.direct_org1_id, Direct_cloud_id, ProtectionStatus.unprotect, ConnectionStatus.online,
						OSMajor.windows.name().toString(), "sql;exchange", null, null, null, null, null, "1.0.0", null, null },
				{ ti.normal_msp1_suborg1_user1_email, ti.common_password, SourceType.one_drive, SourceProduct.udp,
						ti.normal_msp1_suborg1_id, msp_cloud_account_id, ProtectionStatus.unprotect,
						ConnectionStatus.online, OSMajor.windows.name().toString(), "sql;exchange", null, null, null, null, null,
						"1.0.0", null, null },
				// 3 tier cases
				{ ti.root_msp1_suborg1_user1_email, ti.common_password, "suborg", SourceType.machine, SourceProduct.udp,
						...
						OSMajor.windows.name().toString(), "sql;exchange", null, null, null, null, "64", null, null, null },
				{ ti.root_msp1_suborg1_user1_email, ti.common_password, "suborg", SourceType.machine, SourceProduct.udp,
						ti.root_msp1_suborg1_id, root_cloud_id, ProtectionStatus.unprotect, ConnectionStatus.online,
						OSMajor.windows.name().toString(), "", null, null, null, null, null, "1.0.0", null, null },
				{ ti.root_msp1_suborg1_user1_email, ti.common_password, "suborg", SourceType.machine, SourceProduct.udp,
						ti.root_msp1_suborg1_id, root_cloud_id, ProtectionStatus.unprotect, ConnectionStatus.online,
						OSMajor.windows.name().toString(), "sql;exchange", "Ramya_vm2", null, "Ramya_agent1", "windows 2012", "64",
						"1.0.0", "2.0", "http://upgrade" },
				{ ti.root_msp1_suborg1_user1_email, ti.common_password, "suborg", SourceType.machine, SourceProduct.udp,
						ti.root_msp1_suborg1_id, root_cloud_id, ProtectionStatus.unprotect, ConnectionStatus.online,
						OSMajor.windows.name().toString(), "sql;exchange", null, null, null, null, null, "1.0.0", null, null },
	...
	public void deleteSourceByIdForValidToken(String userName, String password, String org_type, SourceType sourceType,
	...
	public final Object[][] sourceInfo1() {
		return new Object[][] {
				...
				{ "invalid token", ti.direct_org1_user1_email, ti.common_password, SourceType.machine,
						...
						ConnectionStatus.online, OSMajor.windows.name().toString(), "", "Ramya_vm1", null, null, null, null, null,
				...
				{ "Insufficient permissions rootsuborg-rootsuborgb", ti.root_msp1_suborg1_user1_email,
						...
						root_cloud_id, ProtectionStatus.unprotect, ConnectionStatus.online, OSMajor.windows.name().toString(),
	...
	public void deleteSourceByIdForInValidToken(String testcase, String username, String password,
			SourceType sourceType, SourceProduct sourceProduct, String org_id, String siteId,
			ProtectionStatus protectionStatus, ConnectionStatus connectionStatus, String os_major, String applications,
			String vm_name, String hypervisor_id, String agent_name, String os_name, String os_architecture,
		...
		// Deleting the source by id
		test.log(LogStatus.INFO, "delete source by id");
		response = spogServer.deleteSourcesById(invalidToken, source_id, test);
		spogServer.deleteSourcesWithCheck(response, spogContant, errorMessage, test);

		// Get the source by id
		test.log(LogStatus.INFO, "get source by id should fail for invalid source_id");
		String source_id1 = UUID.randomUUID().toString();

		response = spogServer.deleteSourcesById(Token, source_id1, test);
		spogServer.deleteSourcesWithCheck(response, SpogConstants.RESOURCE_NOT_EXIST,
				SpogMessageCode.RESOURCE_NOT_FOUND, test);
