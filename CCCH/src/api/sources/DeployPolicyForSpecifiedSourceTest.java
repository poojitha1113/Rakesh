...
public class DeployPolicyForSpecifiedSourceTest extends base.prepare.Is4Org {
	...
	public void PostDeploySourceById(String organizationType, String organization_id, String validToken,
		...
		policy4SpogServer.postDeploySourceById(validToken, source_id, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	...
	public final Object[][] policy_info_invalid() {
		return new Object[][] {
				...
				{ "Invalid Scenario - random UUID as source_id", "sub", ti.normal_msp1_suborg1_id, "cloud_direct_baas",
						ti.normal_msp1_suborg1_user1_token, SpogConstants.RESOURCE_NOT_EXIST,
						SpogMessageCode.RESOURCE_NOT_FOUND, UUID.randomUUID().toString() },
				{ "Invalid Scenario - invalid UUID as source_id", "sub", ti.normal_msp1_suborg1_id, "cloud_direct_baas",
						ti.normal_msp1_suborg1_user1_token, SpogConstants.REQUIRED_INFO_NOT_EXIST,
						SpogMessageCode.ELEMENT_ELEMENT_IS_NOT_A_UUID, "abcd" },

		};
	}

	@Test(dataProvider = "policy_info_invalid", dependsOnMethods = "PostDeploySourceById")
	public void PostDeploySourceById_invalid(String Testcase, String org_type, String org_id, String policy_type,
			String validToken, int ExpectedStatusCode, SpogMessageCode ErrorMessage, String source_id) {

		test = ExtentManager.getNewTest(this.getClass().getName() + "."
				+ Thread.currentThread().getStackTrace()[1].getMethodName() + "_" + org_type);
		test.log(LogStatus.INFO, "deploy policy with" + Testcase);

		policy4SpogServer.postDeploySourceById(validToken, source_id, ExpectedStatusCode, ErrorMessage, test);
	}
