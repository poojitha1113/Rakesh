...
public class TurnOffBrandingEmailer extends base.prepare.Is4Org {
	...
	@DataProvider(name = "Turn_off_Brandingemailer")
	...
	@Test(dataProvider = "Turn_off_Brandingemailer")
	public void turnoffBrandingEmailerOrganization_200(String testcase,
			String validToken,
		...
		test.log(LogStatus.INFO, "Turn on Branding with the Invalid user token");
		brandingSpogSever.TurnoffBrandingEmailerFororganizationwithchcek(organization_id,"", SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	...
	@Test(dataProvider = "Turn_off_Brandingemailer")
	public void turnoffBrandingEmailerOrganization_401(String testcase,
			String validToken,
			String organization_id,
			String organization_name, 
			String portal_url, 
		...
		brandingSpogSever.TurnoffBrandingEmailerFororganizationwithchcek(organization_id,validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);


	}

	@DataProvider(name = "Turn_off_Branding_Emailer_Deleted_Org")
	public final Object[][] TurnOffBrandingDletedOrg() {
		return new Object[][] {

			{ "Turn_off_Branding emailer to the randomuuid of org with the valid direct user token",ti.direct_org1_user1_token, "eswari","https://tspog.zetta.com"+prefix,"#000455","#000455","test brandinginfo"},
			{ "Turn_off_Branding  emailerto the randomuuid of org with the msp org user valid token",ti.normal_msp_org1_user1_token,"eswari","https://tspog.arcserve.net"+prefix,"#000455","#000455","test brandinginfo"},
			{ "Turn_off_Branding emailer to the randomuuid of org with the msp account admin user valid token",ti.root_msp_org1_user1_token, "eswari","https://tspog.yahoo.net"+prefix,"#000455","#000455","test brandinginfo"},

			{ "Turn_off_Branding emailer to the randomuuid of org with the direct user valid token",ti.csr_token, "eswari","https://tspog.zetta.com"+prefix,"#000456","#000455","test brandinginfo"},
			{ "Turn_off_Branding emailerto the randomuuid of org with the msp org user valid token",ti.csr_token,"eswari","https://tspog.arcserve.net"+prefix,"#000457","#000455","test brandinginfo"},
			{ "Turn_off_Branding emailer to the randomuuid of org with the msp account admin user valid token", ti.csr_token,"eswari","https://tspog.yahoo.net"+prefix,"#000455","#000495","test brandinginfo"},
	...
	@Test(dataProvider = "Turn_off_Branding_Emailer_Deleted_Org")
	public void turnoffBrandingEmailerOrganization_404(String testcase,
			String validToken,
			String organization_name, 
			String portal_url, 
			String primary_color, 
		...
		test.log(LogStatus.INFO, "Create branding eamiler  in org of type");
		brandingSpogSever.TurnoffBrandingEmailerFororganizationwithchcek(random,ti.csr_token, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	...
	@DataProvider(name = "Turn_off_branding_Emailer_403")
	public final Object[][] turnoffBrandingEmailerValidParams1() {
		return new Object[][] {
	...
	@Test(dataProvider = "Turn_off_branding_Emailer_403")
	public void turnoffBrandingEmailerOrganization_403(String testcase,
			String validToken,
			String organization_id,
		...
		test.log(LogStatus.INFO, "Create branding eamiler  in org of type");
		brandingSpogSever.TurnoffBrandingEmailerFororganizationwithchcek(organization_id,validToken, SpogConstants.INSUFFICIENT_PERMISSIONS,SpogMessageCode.RESOURCE_PERMISSION_DENY, test);
