...
public class GetJobColumnsTest extends base.prepare.Is4Org{
...
//	  private String buildVersion;
	  ...
	  @DataProvider(name = "loginUserToCheckJobColumns")
	  public final Object[][] getloginUserToCheckJobColumns() {
			return new Object[][] {  {"csr"},{"csr_readonly"},{"msp"},{"direct"},{"account"},{"rootmsp"},{"submsp"},{"rootmspaccount"},{"submspaccount"}};
	  }
	  @Test(dataProvider = "loginUserToCheckJobColumns")
	  public void checkJobColumnsWithDifferentUsers(String loginUserType){	 
		  ...
		  if (loginUserType.equalsIgnoreCase("csr") || loginUserType.equalsIgnoreCase("msp")|| loginUserType.equalsIgnoreCase("rootmsp")|| loginUserType.equalsIgnoreCase("submsp")|| loginUserType.equalsIgnoreCase("csr_readonly")){
			  spogServer.getJobsColumnsWithCheck4Msp(test);
		  }else{
			  spogServer.getJobsColumnsWithCheck(test);
		  }
	  ...
	  public void notLoggedGetDestinationColumns(){	 
		  ...
		  //set token as null
		  spogServer.setToken("");
		  spogServer.getJobsColumnsWithExpectedStatusCode(SpogConstants.NOT_LOGGED_IN,ErrorCode.AUTHORIZATION_HEADER_BLANK,test);
