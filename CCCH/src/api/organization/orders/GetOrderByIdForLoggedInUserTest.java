...
public class GetOrderByIdForLoggedInUserTest extends base.prepare.Is4Org{
...
//		  csr_user_id =spogServer.createUserAndCheck(csr_email, sharePassword, "yuefen", "liu", "csr_admin", csrOrg_id, test);
	  ...
	  public void csrReadOnlyUserGetOrderSuccessful() {
		  ...
		  //add order
		  String orderId="SKUTESTDATA_50_8_0_1_"+RandomStringUtils.randomNumeric(8);
		  String fulfillmentId="SKUTESTDATA_50_8_0_1_"+RandomStringUtils.randomNumeric(8);
		  ...
		  Response response =userSpogServer.getOrderByIdForLoggedInUser(orderId);
...
//		  spogDestinationServer.recycleCloudVolumesAndDelOrg(orgId,test);
	  ...
	  public final Object[][] getOrderInfo2() {
		  return new Object[][] { 
					  ...
					  {direct_token,SpogConstants.REQUIRED_INFO_NOT_EXIST,"00300023"}, 
					  {msp2_token,SpogConstants.REQUIRED_INFO_NOT_EXIST,"00300023"}, 
					  {msp_account_admin_token,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"}, 
					  {account_token,SpogConstants.REQUIRED_INFO_NOT_EXIST,"00300023"}, 
		  }; 
		}
	  ...
	  @Test 
	  public void getOrderWithInvalidOrderID() {
		  System.out.println("getOrderWithInvalidOrderID");
		  test = rep.startTest("getOrderWithInvalidOrderID");
		  test.assignAuthor("Liu Yuefen");
		  ...
		  Response response =userSpogServer.getOrderByIdForLoggedInUser(spogServer.returnRandomUUID());
		  spogServer.checkResponseStatus(response, SpogConstants.REQUIRED_INFO_NOT_EXIST);
          spogServer.checkErrorCode(response, "00300023");  
      }
	  ...
	  public void getOrderFail401(){
		  ...
		  //get oder
		  Response response =userSpogServer.getOrderByIdForLoggedInUser("");
