...
public class GetOrdersForSpecifiedOrgTest extends base.prepare.Is4Org {
...
//		  csr_user_id =spogServer.createUserAndCheck(csr_email, sharePassword, "yuefen", "liu", "csr_admin", csrOrg_id, test);
	  ...
	  public final Object[][] getOrderInfo10() {
		  return new Object[][] { 
					  {this.rootMsp_admin_email, sharePassword, this.rootMspOrg_id,SpogConstants.SUCCESS_GET_PUT_DELETE, ""},
					  {this.rootMsp_admin_email, sharePassword, this.subMsp1_id, SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"},
					  {this.rootMsp_admin_email, sharePassword, this.account1_subMsp1_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"},
					  {this.rootMsp_admin_email, sharePassword, this.account1_rootMsp_id,SpogConstants.SUCCESS_GET_PUT_DELETE,""},
					  
					  {this.subMsp1_admin_email, sharePassword, this.subMsp1_id,SpogConstants.SUCCESS_GET_PUT_DELETE,""}, 
					  {this.subMsp1_admin_email, sharePassword, this.rootMspOrg_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"},
					  {this.subMsp1_admin_email, sharePassword, this.account1_subMsp1_id, SpogConstants.SUCCESS_GET_PUT_DELETE,""},
					  {this.subMsp1_admin_email, sharePassword, this.account1_rootMsp_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"},
					  
					  {this.account1_rootMsp_user_email, sharePassword, this.account1_rootMsp_id, SpogConstants.SUCCESS_GET_PUT_DELETE,""},
					  {this.account1_rootMsp_user_email, sharePassword, this.rootMspOrg_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"},
					  {this.account1_rootMsp_user_email, sharePassword, this.subMsp1_id, SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"},
					  {this.account1_rootMsp_user_email, sharePassword, this.account1_subMsp1_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"},
					  
					  {this.account1_subMsp1_user_email, sharePassword, this.account1_subMsp1_id,SpogConstants.SUCCESS_GET_PUT_DELETE,""},		  
					  {this.account1_subMsp1_user_email, sharePassword, this.rootMspOrg_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"},
					  {this.account1_subMsp1_user_email, sharePassword, this.subMsp1_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"},
					  {this.account1_subMsp1_user_email, sharePassword, this.account1_rootMsp_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"},
		  };
		}
	  @Test (dataProvider = "orderInfo10")
	  public void rootMspGetOrderCheck(String loginUser, String loginPassword, String orgId, int ResponseStatusCode, String errorCode) {
		  System.out.println("rootMspGetOrderCheck");
		  test = rep.startTest("rootMspGetOrderCheck");
		  ...
		  Response response =userSpogServer.getOrderByOrgId(orgId);
	  ...
	  @Test
	  public void csrReadOnlyGetOrderSuccessfulWithCheck() {
		  System.out.println("csrReadOnlyGetOrderSuccessfulWithCheck");
		  test = rep.startTest("csrReadOnlyGetOrderSuccessfulWithCheck");
		  test.assignAuthor("Liu Yuefen");
		  ...
		  //create org
		  String orgEmail = spogServer.ReturnRandom("yuefen_direct_name")+"@spogqa.com";
		  ...
		  for (int i=0;i<num;i++) {
			  ...
			  userSpogServer.addOrderByOrgId(orgId, orderIds[i], fulfillmentIds[i], test);
		  }
		  
		  //login with csr readonly
		  ...
		  ArrayList<HashMap<String, Object>> orderList = response.then().extract().path("data");
...
//		  spogDestinationServer.recycleCloudVolumesAndDelOrg(orgId,test);
	  ...
	  public final Object[][] getOrderInfo2() {
		  return new Object[][] { 
					  {csr_token, csrOrg_id, SpogConstants.SUCCESS_GET_PUT_DELETE,""}, 
					  {csr_token, directOrg_id,SpogConstants.SUCCESS_GET_PUT_DELETE,""}, 
					  {csr_token, mspOrg_id,SpogConstants.SUCCESS_GET_PUT_DELETE,""},
					  {direct_token, directOrg_id,SpogConstants.SUCCESS_GET_PUT_DELETE,""},
					  {msp_token, mspOrg_id,SpogConstants.SUCCESS_GET_PUT_DELETE,""},
					  
					  {msp_account_admin_token,mspOrg_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"}, 
					  {direct_token,mspOrg_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"},
					  {account_token,mspOrg_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"},
					  {msp2_token,mspOrg_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"},
					  {msp_token, directOrg_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"}, 
					  {account_token, directOrg_id,SpogConstants.INSUFFICIENT_PERMISSIONS,"00100101"}
		  }; 
		}
	  
	  @Test (dataProvider = "orderInfo2")
	  public void getOrderByDifferentUser(String token, String orgId, int expectedStatusCode, String expectedErrorCode) {
	  ...
	  public void getOrderFail(String getOrderToken, String organizationName, String organizationType, String organizationEmail,
		  ...
		  for(int i=0; i<orderList.size();i++) {
			  HashMap<String, Object> orderInfo = orderList.get(i);
			  if(orderInfo.get("order_id").equals(orderID)&&orderInfo.get("fulfillment_id").equals(fulfillmentID)&&orderInfo.get("organization_id").equals(orgId)) {
	              assertTrue("compare orders pass",true);
...
//		  spogServer.DeleteOrganizationWithCheck(orgId, test);
	  ...
	  public void getOrderFail401(){
		  ...
		  //get oder
		  Response response =userSpogServer.getOrderByOrgId(directOrg_id);
