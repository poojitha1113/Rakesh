...
public class GetOrganizationSupportTest extends base.prepare.Is4Org {
	...
	// scenario
	@DataProvider(name = "getOrganizationSupportDetailsForLoggedInOrganization_valid")
	public final Object[][] getOrganizationSupportDetailsForLoggedInOrganization_valid() {
		return new Object[][] {
				...
				{ ti.normal_msp_org1_user1_token, "", "msp", ti.normal_msp_org1_id, ti.normal_msp_org1_name,
						...
						"https://www.arcserve.com/saleschat" },
				{ ti.root_msp_org1_user1_token, "", "msp", ti.root_msp_org1_id, ti.root_msp_org1_name,
						"ramya.nagepalli456@arcserve.com", "+1 877-469-3882", "https://www.arcserve.com/supportchat",
						"https://www.arcserve.com/saleschat" },
				{ ti.csr_readonly_token, "organization_id=" + ti.direct_org1_id, "csr", ti.csr_org_id, "Arcserve CSR",
						"ramya.nagepalli123@arcserve.com", "+1 877-469-3882", "https://www.arcserve.com/supportchat",
						"https://www.arcserve.com/saleschat" },
	...
	@Test(dataProvider = "getOrganizationSupportDetailsForLoggedInOrganization_valid")
	public void getOrganizationSupportDetailsForLoggedInOrganization(String adminToken, String additionalURL,
			String organization_type, String organization_id, String organization_name, String email,
			String phone_number, String support_url, String sales_url) {
		...
		test.log(LogStatus.INFO, "get OrganizationSupportDetails with valid token");
		response = spogJobServer.getOrganizationSupport(adminToken, additionalURL, SpogConstants.SUCCESS_GET_PUT_DELETE,
				test);
	...
	@DataProvider(name = "getOrganizationSupportTest_invalid")
	public final Object[][] getOrganizationSupportTest_invalid() {
		return new Object[][] {
	...
	@Test(dataProvider = "getOrganizationSupportTest_invalid")
	public void getOrganizationSupportTest_invalid(String invalidTestCase, String InValidToken,
		...
		test = ExtentManager
				.getNewTest(organization_type + "Organization getOrganizationSupportTest_invalid" + invalidTestCase);

		test.log(LogStatus.INFO, "get the backup job reports columns with invalid token");
		Response response = spogJobServer.getOrganizationSupport(InValidToken, "", ExpectedStatusCode, test);
