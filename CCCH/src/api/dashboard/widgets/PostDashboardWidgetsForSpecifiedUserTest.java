...
public class PostDashboardWidgetsForSpecifiedUserTest extends base.prepare.Is4Org {
	...
	@DataProvider(name = "postDashboardWidgetsForSpecifiedUser_valid")
	public final Object[][] postDashboardWidgetsForSpecifiedInUser_valid() {
		return new Object[][] {
	...
	@Test(dataProvider = "postDashboardWidgetsForSpecifiedUser_valid")
	public void postDashboardWidgetsForSpecifiedUser(String OrganizationType, String ValidToken, String user_id,
			String[] order_id, String[] visibility, String[] isExpandable) {
		test.log(LogStatus.INFO, "postDashboardWidgetsForSpecifiedUser of the organization type" + OrganizationType);
	...
	@DataProvider(name = "postDashboardWidgetsForSpecifiedUser_invalid")
	public final Object[][] postDashboardWidgetsForSpecifiedUser_invalid() {
		return new Object[][] {
				{ "postDashboardWidgetsForSpecifiedUser with invalid token", "1234", ti.direct_org1_user1_id,
						SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT },
				{ "postDashboardWidgetsForSpecifiedUser with missed token", "", ti.direct_org1_user1_id,
						SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED } };

	}

	@Test(dataProvider = "postDashboardWidgetsForSpecifiedUser_invalid")
	public void postDashboardWidgetsForSpecifiedUser_401(String Testcase, String token, String user_id,
	...
	@DataProvider(name = "postDashboardWidgetsForSpecifiedUser_400")
	public final Object[][] postDashboardWidgetsForSpecifiedUser_400() {
		return new Object[][] {
				{ "Post same widget_id twice", "direct", ti.direct_org1_user1_id, ti.direct_org1_user1_token,
						new String[] { "9", "7", "5", "2", "3", "1", "4", "6", "8" },
						new String[] { "true", "false", "none", "true", "false", "true", "false", "none", "true" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" }, 2,
						SpogConstants.SUCCESS_POST, SpogMessageCode.SUCCESS_POST },

				{ "Post same order_id twice", "msp", ti.normal_msp_org1_user1_id, ti.normal_msp_org1_user1_token,
						new String[] { "9", "9", "9", "2", "3", "1", "4", "6", "8" },
						new String[] { "true", "false", "none", "true", "false", "true", "false", "none", "true" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" }, 2,
						SpogConstants.SUCCESS_POST, SpogMessageCode.SUCCESS_POST },

				{ "Post randomUUID as widget_id", "sub", ti.normal_msp1_suborg1_user1_id,
				...
				{ "Post invalid widget_id", "mspAccount", ti.normal_msp1_suborg1_user1_id,
				...
				// csr read only cases
				{ "Post same widget_id twice", "csrreadonly", ti.csr_readonly_admin_user_id, ti.csr_readonly_token,
						new String[] { "9", "7", "5", "2", "3", "1", "4", "6", "8" },
						new String[] { "true", "false", "none", "true", "false", "true", "false", "none", "true" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" }, 2,
						SpogConstants.SUCCESS_POST, SpogMessageCode.SUCCESS_POST },

				{ "Post same order_id twice", "csrreadonly", ti.csr_readonly_admin_user_id, ti.csr_readonly_token,
						new String[] { "9", "9", "9", "2", "3", "1", "4", "6", "8" },
						new String[] { "true", "false", "none", "true", "false", "true", "false", "none", "true" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" }, 2,
						SpogConstants.SUCCESS_POST, SpogMessageCode.SUCCESS_POST },

				{ "Post randomUUID as widget_id", "csrreadonly", ti.csr_readonly_admin_user_id, ti.csr_readonly_token,
						new String[] { "9", "9", "9", "2", "3", "1", "4", "6", "8" },
						new String[] { "true", "false", "none", "true", "false", "true", "false", "none", "true" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" }, 1,
						SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.WIDGET_DOESNOT_EXISTS },

				{ "Post invalid widget_id", "csrreadonly", ti.csr_readonly_admin_user_id, ti.csr_readonly_token,
						new String[] { "9", "9", "9", "2", "3", "1", "4", "6", "8" },
						new String[] { "true", "false", "none", "true", "false", "true", "false", "none", "true" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" }, 1,
						SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.WIDGET_NOT_UUID },
	...
	@Test(dataProvider = "postDashboardWidgetsForSpecifiedUser_400")
	public void postDashboardWidgetsForSpecifiedUser_invalidScenario(String testcase, String organization,
	...
	@DataProvider(name = "postDashboardWidgetsForSpecifiedUser_403")
	public final Object[][] postDashboardWidgetsForSpecifiedUser_403() {
		return new Object[][] {
				...
				{ "INSUFFICIENT_PERMISSIONS of rootsub-submsp_sub", ti.root_msp1_suborg1_user1_token,
						...
						SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY },
				// monitor role
				{ "INSUFFICIENT_PERMISSIONS of rootsub-submsp_sub_monitor", ti.root_msp1_suborg1_user1_token,
						ti.root_msp1_suborg1_user1_id, ti.msp1_submsp1_suborg1_monitor_user1_token, "MSP",
						SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY },

		};
	}

	@Test(dataProvider = "postDashboardWidgetsForSpecifiedUser_403")
	public void postDashboardWidgetsForSpecifiedUser_invalid(String invalidTestCase, String adminToken, String user_id,
			String InValidToken, String organization_type, int ExpectedStatusCode, SpogMessageCode Errormessage) {

		test.log(LogStatus.INFO, "invalid Scenario for postDashboardWidgetsForSpecifiedUser" + invalidTestCase);
		...
		Response response = spogReportServer.postDashboardWidgetsForSpecifiedUser(expected_widgets, user_id,
				InValidToken, test);
