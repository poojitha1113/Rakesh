...
public class GetDashboardWidgetsForLoggedInUserTest extends base.prepare.Is4Org {
	...
	@DataProvider(name = "getDashboardWidgetsForLoggedInUser_valid")
	public final Object[][] getDashboardWidgetsForLoggedInUser_valid() {
		return new Object[][] {
				...
				// monitor cases
				{ "Direct_monitor", ti.direct_org1_user1_token,
						new String[] { "9", "7", "5", "2", "3", "1", "4", "6", "8" },
						new String[] { "true", "false", "none", "true", "false", "true", "false", "none", "true" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" },
						ti.direct_org1_monitor_user1_token },
				{ "MSP_monitor", ti.normal_msp_org1_user1_token,
						new String[] { "9", "7", "5", "2", "3", "1", "4", "6", "8" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" },
						ti.normal_msp_org1_monitor_user1_token },
				{ "suborg_monitor", ti.normal_msp1_suborg1_user1_token,
						new String[] { "9", "7", "5", "2", "3", "1", "4", "6", "8" },
						new String[] { "true", "false", "none", "true", "false", "true", "false", "none", "true" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" },
						ti.normal_msp1_suborg1_monitor_user1_token },
				{ "RootMSP_monitor", ti.root_msp_org1_user1_token,
						new String[] { "9", "7", "5", "2", "3", "1", "4", "6", "8" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" },
						ti.root_msp_org1_monitor_user1_token },
				{ "RootSub_monitor", ti.root_msp1_suborg1_user1_token,
						new String[] { "9", "7", "5", "2", "3", "1", "4", "6", "8" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" },
						ti.root_msp1_suborg1_monitor_user1_token },
				{ "submsp_sub_monitor", ti.msp1_submsp1_suborg1_user1_token,
						new String[] { "9", "7", "5", "2", "3", "1", "4", "6", "8" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" },
						ti.msp1_submsp1_suborg1_monitor_user1_token },
				{ "SubMSP_monitor", ti.root_msp1_submsp1_user1_token,
						new String[] { "9", "7", "5", "2", "3", "1", "4", "6", "8" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" },
						new String[] { "true", "false", "none", "true", "false", "false", "none", "true", "false" },
	...
	@Test(dataProvider = "getDashboardWidgetsForLoggedInUser_valid")
	public void getDashboardWidgetsForLoggedInUser(String OrganizationType, String ValidToken, String[] order_id,
			String[] visibility, String[] isExpandable, String monitorToken) {
		test.log(LogStatus.INFO, "getDashboardWidgetsForLoggedInUser of the organization type" + OrganizationType);
		...
		if (OrganizationType.contains("monitor")) {
			test.log(LogStatus.INFO, "get the create dashboard widgets of the logged in user with valid token");
			response = spogReportServer.getDashboardWidgetsForLoggedInUser(monitorToken,
					SpogConstants.SUCCESS_GET_PUT_DELETE, SpogMessageCode.SUCCESS_GET_PUT_DEL, test);
			...
			test.log(LogStatus.INFO, "get the create dashboard widgets of the logged in user with valid token");
			response = spogReportServer.getDashboardWidgetsForLoggedInUser(ValidToken,
					SpogConstants.SUCCESS_GET_PUT_DELETE, SpogMessageCode.SUCCESS_GET_PUT_DEL, test);
		...
		test.log(LogStatus.INFO, "get the create dashboard widgets of the logged in user with valid token");
		response = spogReportServer.getDashboardWidgetsForLoggedInUser(ValidToken, SpogConstants.SUCCESS_GET_PUT_DELETE,
				SpogMessageCode.SUCCESS_GET_PUT_DEL, test);
	...
	@DataProvider(name = "getDashboardWidgetsForLoggedInUser_invalid")
	public final Object[][] getDashboardWidgetsForLoggedInUser_invalid() {
		return new Object[][] {
				{ "getDashboardWidgetsForLoggedInUser with invalid token", "1234", SpogConstants.NOT_LOGGED_IN,
						SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT },
				{ "getDashboardWidgetsForLoggedInUser with missed token", "", SpogConstants.NOT_LOGGED_IN,
						SpogMessageCode.COMMON_AUTHENTICATION_FAILED } };

	}

	@Test(dataProvider = "getDashboardWidgetsForLoggedInUser_invalid")
	public void getDashboardWidgetsForLoggedInUser_401(String Testcase, String token, int expectedStatusCode,
		...
		spogReportServer.getDashboardWidgetsForLoggedInUser(token, expectedStatusCode, expectedErrorMessage, test);
