...
public class CreateRestoreJobReportsColumnsForLoggedInUserTest extends base.prepare.Is4Org {
   ...
   /* private ExtentReports rep;
	...
	public final Object[][] CreateRestoreJobReportsColumns_201() {
		...
		return new Object[][] {
				...
				new String[] { "true", "false","none"},new String[]{"2","12","10","11","3","1","4","7","5","6","9","8"},4},
				...
				{ "direct", ti.direct_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true"},new String[]{"2","3","1","12","10","11","4","7","5","6","9","8"},4},
				{ "direct", ti.direct_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
								new String[] {"false"},new String[]{"2","3","12","10","11","1","4","7","5","6","9","8"},4},
				
				{ "msp", ti.root_msp_org1_user1_token, new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"3","12","10","11","13","6","2","9","8","1","4","5","7"},7},
...
//				Delete the existing user recovered resource columns and create the same columns 
				...
				{ "direct-sameorderid", ti.direct_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
										new String[] { "true", "false","none"},new String[]{"2","3","2","2","3","3","2","3","8","12"},4},
				
		};
	}
	@Test(dataProvider="CreateRestoreJobReportsColumns_201")
	public void createRestoreJobReportsColumnsForLoggedinUserTest_201(String organizationType,
			  												String validToken,
			  												String[] sort,
			  												String[] filter,
			  												String[] visible,
...
//				int index4 = gen_random_index(orderId);
			...
			test.log(LogStatus.INFO, "Create RestoreJobReports columns for Loggedin user in the org: "+organizationType);
			Response response= spogReportServer.createRestoreJobReportsColumnsForLoggedInUser(validToken, expected_columns, test);
			
			test.log(LogStatus.INFO, "Compare the RestoreJobReports columns created for loggedin user in org: "+organizationType);
			if(organizationType.contains("direct-sameColId"))
			{
			...
			test.log(LogStatus.INFO, "delete RestoreJobReports columns for loggedin user in org: "+organizationType);
...
//			Delete the existing user job columns and create the same columns 
			...
			{
				test.log(LogStatus.INFO, "Create RestoreJobReports columns for loggedin user in the org: "+organizationType);
				response= spogReportServer.createRestoreJobReportsColumnsForLoggedInUser(validToken, expected_columns, test);
	...
	public final Object[][] CreateRestoreJobReportsColumns_400() {
		...
		return new Object[][] {
			...
			{ "direct-noColId", ti.direct_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
				new String[] { "true", "false","none"},new String[]{"2","3","10","11","1","4","7","5","6","12","9","8"},4},
			...
			{ "direct-moreOrderIds", ti.direct_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","14","13","1","10","7","5","6","9","8","4","11","12","3"},10},	
	...
	@Test(dataProvider="CreateRestoreJobReportsColumns_400")
	public void createRestoreJobReportsColumnsForLoggedinUserTest_400(String organizationType,
			  												String validToken,
			  												String[] sort,
			  												String[] filter,
			  												String[] visible,
...
//				int index4 = gen_random_index(orderId);
	...
	@Test(dataProvider="CreateRestoreJobReportsColumns_401")
	public void createRestoreJobReportsColumnsForLoggedinUserTest_401(String organizationType,
			  												String validToken,
			  												String[] sort,
			  												String[] filter,
			  												String[] visible,
...
//				int index4 = gen_random_index(orderId);
	...
	public final Object[][] CreateRestoreJobReportsColumns_404() {
		...
		return new Object[][] {
				//csr & csr readonly token
				{ "csr-colIdNotExist", ti.csr_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","10","11","12","4","7","5","6","9","8"},1},
				...
				{ "msp-colIdNotExist", ti.root_msp_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","3","1","13","10","12","11","4","7","5","6","9","8"},1},
				{ "suborg-colIdNotExist", ti.root_msp1_suborg1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
								new String[] { "true", "false","none"},new String[]{"2","3","10","12","11","1","4","7","5","6","9","8"},1},
								
		};
	}
	@Test(dataProvider="CreateRestoreJobReportsColumns_404")
	public void createRestoreJobReportsColumnsForLoggedinUserTest_404(String organizationType,
			  												String validToken,
			  												String[] sort,
			  												String[] filter,
			  												String[] visible,
