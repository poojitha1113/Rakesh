...
public class UpdateRestoreJobReportsColumnsForLoggedInUserTest extends base.prepare.Is4Org {
   ...
   /* private ExtentReports rep;
	...
	@DataProvider(name="updateRestoreJobReportsColumnsForLoggedInUser_201")
	public Object[][] updateRestoreJobReportsColumnsForLoggedInUser_201(){
		
		return new Object[][] {
			{"csr", ti.csr_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
				new String[] { "true", "false","none"},new String[]{"2","12","3","10","11","1","4","7","5","6","9","8"},new String[] { "true"},new String[]{"4","7","5","6","9","8"},4,2},
			...
			{"msp", ti.root_msp_org1_user1_token,  new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
				new String[] { "true", "false","none"},new String[]{"2","13","3","12","10","11","1","4","7","5","6","9","8"},new String[] { "false"},new String[]{"1","6","9","8"},4,3},
			{"suborg", ti.root_msp1_suborg1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","12","1","10","11","4","7","5","6","9","8"},new String[] { "true"},new String[]{"7","5","6","9","8"},4,1},
				
			{"suborg-mspT", ti.root_msp_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","12","1","10","11","4","7","5","6","9","8"},new String[] { "false"},new String[]{"7","5","6","9","8"},4,2},
			{"suborg-mspAccAdminT", ti.root_msp_org1_msp_accountadmin1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","12","1","10","11","4","7","5","6","9","8"},new String[] { "false"},new String[]{"7","5","6","9","8"},4,2}
		};
	}

	@Test(dataProvider="updateRestoreJobReportsColumnsForLoggedInUser_201")
	public void updateRestoreJobReportsColumnsForLoggedInUser_201(String organizationType,
													String validToken,
													String[] sort,
													String[] filter,
													String[] visible,
		...
		test.log(LogStatus.INFO, "Create RestoreJobReports columns for Loggedin user in org : "+ organizationType);
		...
		test.log(LogStatus.INFO, "Update RestoreJobReports columns for Loggedin User in org : "+organizationType);
		spogReportServer.updateRestoreJobReportsColumnsForLoggedinUser(validToken, expected_updated_columns, columnsHeadContent, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	...
	public final Object[][] UpdateRestoreJobReportsColumns_400() {
		...
		return new Object[][] {
			...
			{ "direct-moreOrderIds", ti.direct_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","3","10","12","11","1","4","7","5","6","9","8","10","11"},11},
	...
	public void updateRestoreJobReportsColumnsByUserIdTest_400(String organizationType,
			...
			String[] moreOrderIds = new String[]{"2","14","1","10","7","5","6","9","8","4","11","12","3"};
...
//				int index4 = gen_random_index(orderId);
			...
			test.log(LogStatus.INFO, "Update the RestoreJobReports columns created for Loggedin user in org: "+organizationType);
			spogReportServer.updateRestoreJobReportsColumnsForLoggedinUser(validToken, expected_columns1, columnsHeadContent, SpogConstants.REQUIRED_INFO_NOT_EXIST, expectedErrorMessage, test);
									
			test.log(LogStatus.INFO, "Delete RestoreJobReports columns for Loggedin user in org: "+organizationType);
			spogReportServer.deleteRestoreJobReportsColumnsforLoggedInUserwithCheck(validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
						
		}
	@DataProvider(name="UpdateRestoreJobReportsColumnsForLoggedinUser_401")
	public final Object[][] UpdateRestoreJobReportsColumnsForLoggedinUser_401() {
		...
		return new Object[][] {
			// different users
				...
				{ "msp", ti.root_msp_org1_user1_token,"invalid_token",new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"3","6","2","9","13","8","1","12","10","11","4","5","7"},7},
				
				{ "suborg", ti.root_msp1_suborg1_user1_token,"invalid_token",new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"5","2","9","4","1","6","12","10","11","7","8","3"},1},
						
		};
	}
	@Test(dataProvider="UpdateRestoreJobReportsColumnsForLoggedinUser_401")
	public void updateRestoreJobReportsColumnsForLoggedinUserTest_401(String organizationType,
															String validToken,
															String invalidToken,
															String[] sort,
															String[] filter,
		...
		test.log(LogStatus.INFO, "Update the RestoreJobReports columns for the Loggedin user in the org: "+organizationType);
		spogReportServer.updateRestoreJobReportsColumnsForLoggedinUser(invalidToken, expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT, test);
					
		test.log(LogStatus.INFO, "Update the RestoreJobReports columns for the Loggedin user in the org: "+organizationType);
		spogReportServer.updateRestoreJobReportsColumnsForLoggedinUser("", expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED, test);
						
		test.log(LogStatus.INFO, "Delete the RestoreJobReports columns for the Loggedin user in the org: "+organizationType);
		spogReportServer.deleteRestoreJobReportsColumnsforLoggedInUserwithCheck(validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	}
