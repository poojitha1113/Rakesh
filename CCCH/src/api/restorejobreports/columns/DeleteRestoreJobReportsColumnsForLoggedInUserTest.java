...
public class DeleteRestoreJobReportsColumnsForLoggedInUserTest extends base.prepare.Is4Org {
   ...
   /* private ExtentReports rep;
	...
	public final Object[][] deleteRestoreJobReportsColumnsValidData() {
		
		return new Object[][] {
			// different users
				{ "direct", ti.direct_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","4","10","11","7","5","6","9","8","12"},4},
				{ "msp", ti.root_msp_org1_user1_token, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"2","1","3","13","7","10","12","11","9","6","4","8","5"},7},
				{ "suborg", ti.root_msp1_suborg1_user1_token, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"5","8","3","4","1","12","10","11","6","7","2","9"},1},
				...
				{ "msp-csrT", ti.root_msp_org1_user1_token, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"2","1","3","13","12","7","10","11","9","6","4","8","5"},7},
				{ "suborg-csrT", ti.root_msp1_suborg1_user1_token, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"5","8","12","3","4","10","11","1","6","7","2","9"},1},	
					
				{ "suborg-mspAccAdminT", ti.root_msp_org1_msp_accountadmin1_token, new String[] { "true", "false"}, new String[] { "true", "false"},
						new String[] { "true", "false"},new String[]{"5","12","8","3","4","10","11","1","6","7","2","9"},1},	
				
		};
	}
	
	@Test(dataProvider = "Delete_RestoreJobReports_coloumns_valid")
	public void deleteRestoreJobReportsColumnsForLoggedinUser_200(String organizationType,
												 String validToken,
												 String[] sort,
												 String[] filter,
												 String[] visible,
...
//		delete without creating columns
		test.log(LogStatus.INFO, "Delete the RestoreJobReports columns for the logged in user for the org: "+organizationType);	
	...
	@Test(dataProvider="Delete_RestoreJobReports_coloumns_valid")
	public void deleteRestoreJobReportsColumnsForLoggedinUser_401(String organizationType,
														String validToken,
														String[] sort,
														String[] filter,
														String[] visible,
		...
		test.log(LogStatus.INFO, "Delete the RestoreJobReports columns for the logged in user for the org: "+organizationType);	
		spogReportServer.deleteRestoreJobReportsColumnsforLoggedInUserwithCheck("InvalidData", SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT, test);
		
		test.log(LogStatus.INFO, "Delete the RestoreJobReports columns for the logged in user for the org: "+organizationType);	
		spogReportServer.deleteRestoreJobReportsColumnsforLoggedInUserwithCheck(null, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT, test);
		
		test.log(LogStatus.INFO, "Delete the RestoreJobReports columns for the logged in user for the org: "+organizationType);	
		spogReportServer.deleteRestoreJobReportsColumnsforLoggedInUserwithCheck("", SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED, test);
