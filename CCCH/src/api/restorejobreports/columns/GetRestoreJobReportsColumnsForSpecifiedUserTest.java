...
public class GetRestoreJobReportsColumnsForSpecifiedUserTest extends base.prepare.Is4Org {
   ...
   /* private ExtentReports rep;
	...
	@DataProvider(name="getRestoreJobReportsColumns_valid")
	public final Object[][] getRestoreJobReportsColumns_valid() {
		
		return new Object[][] {
			// different users
				{ "csr", ti.csr_token,ti.csr_admin_user_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6","9","12","8","10","11"},11},
				...
				{ "msp", ti.root_msp_org1_user1_token,ti.root_msp_org1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"3","6","2","9","13","10","11","8","1","12","4","5","7"},7},
				{ "suborg", ti.root_msp1_suborg1_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","2","3","4","10","11","5","6","12","7","8","9"},4},
				
//				Get RestoreJobReports columns by user id of sub org using msp token should return  200 and validate the response
				{ "suborg-mspT", ti.root_msp_org1_user1_token,ti.root_msp1_suborg1_user1_id,new String[] { "true", "false"}, new String[] { "true", "false"},
						new String[] { "true", "false"},new String[]{"1","2","3","4","10","11","5","12","6","7","8","9"},5},	
				{ "suborg-mspAccAdminT", ti.root_msp_org1_msp_accountadmin1_token,ti.root_msp1_suborg1_user1_id,new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"1","2","3","4","10","11","12","5","6","7","8","9"},5},	
		};
	}
	
	@Test(dataProvider="getRestoreJobReportsColumns_valid")
	public void getRestoreJobReportsColumnForSpecifiedUserTest_200(String organizationType,
															String validToken,
															String user_Id,
															String[] sort,
															String[] filter,
		...
		spogReportServer.getRestoreJobReportsColumnsForSpecifiedUser(user_Id, validToken, expected_columns, columnsHeadContent, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
		
		//getRestoreJobReportsColumns with csr token
		test.log(LogStatus.INFO, "Get the RestoreJobReports columns for the specified user in the org: "+organizationType);
		spogReportServer.getRestoreJobReportsColumnsForSpecifiedUser(user_Id, ti.csr_token, expected_columns, columnsHeadContent, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
		...
		{	//creating with suborg token
			...
			test.log(LogStatus.INFO, "Get the RestoreJobReports columns for the specified user in the org: "+organizationType);
			spogReportServer.getRestoreJobReportsColumnsForSpecifiedUser(user_Id, ti.root_msp_org1_user1_token, expected_columns, columnsHeadContent, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
			...
			test.log(LogStatus.INFO, "Create the RestoreJobReports columns for the specified user in the org: "+organizationType);
			response= spogReportServer.createRestoreJobReportsColumnsForSpecifiedUser(user_Id,ti.root_msp_org1_user1_token,expected_columns,test);
	...
	@DataProvider(name="GetRestoreJobReportsColumns_401")
	public final Object[][] GetRestoreJobReportsColumns_401() {
		...
		return new Object[][] {
			// different users
				{ "direct", ti.direct_org1_user1_token,"invalid_token",ti.direct_org1_user1_id,new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","10","11","4","7","12","5","6","9","8"},4},
								
				{ "msp", ti.root_msp_org1_user1_token,"invalid_token",ti.root_msp_org1_user1_id,new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"3","6","2","9","13","8","10","11","1","12","4","5","7"},7},
				...
				{ "suborg", ti.root_msp1_suborg1_user1_token,"invalid_token",ti.root_msp1_suborg1_user1_id,new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"5","2","9","4","1","10","11","6","12","7","8","3"},1},
						
		};
	}
	@Test(dataProvider="GetRestoreJobReportsColumns_401",enabled=true)
	public void getRestoreJobReportsColumnForSpecifiedUserTest_401(String organizationType,
															String validToken,
															String invalidToken,
															String user_Id,
															String[] sort,
		...
		test.log(LogStatus.INFO, "Get the RestoreJobReports columns for the specified user in the org: "+organizationType);
		spogReportServer.getRestoreJobReportsColumnsForSpecifiedUser(user_Id, invalidToken, expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT, test);
			
		test.log(LogStatus.INFO, "Get the RestoreJobReports columns for the specified user in the org: "+organizationType);
		spogReportServer.getRestoreJobReportsColumnsForSpecifiedUser(user_Id, "", expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED, test);
	...
	//403
	@DataProvider(name="getRestoreJobReportsColumns_403")
	public final Object[][] getRestoreJobReportsColumns_403() {
		...
		return new Object[][] {
			// different users
				{ "direct-mspT", ti.direct_org1_user1_token,ti.root_msp_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","10","11","4","12","7","5","6","9","8"},4},
				...
				{ "direct-suborgT", ti.direct_org1_user1_token,ti.root_msp1_suborg1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","1","4","10","12","11","7","5","6","9","8"},4},
				...
				{ "msp-directT", ti.root_msp_org1_user1_token,ti.direct_org1_user1_token,ti.root_msp_org1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"3","6","13","2","9","8","10","12","11","1","4","5","7"},7},	
				{ "msp-suborgT", ti.root_msp_org1_user1_token,ti.root_msp1_suborg1_user1_token,ti.root_msp_org1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
								new String[] { "true", "false"},new String[]{"3","13","6","2","9","10","12","11","8","1","4","5","7"},7},
				{ "msp-mspbT", ti.root_msp_org1_user1_token, ti.root_msp_org2_user1_token,ti.root_msp_org1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
									new String[] { "true", "false"},new String[]{"3","13","6","2","10","12","11","9","8","1","4","5","7"},7},
				...
				{ "suborg-directT", ti.root_msp1_suborg1_user1_token,ti.direct_org1_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","7","10","12","11","8","9"},1},
				...
				{ "suborg-suborgbT", ti.root_msp1_suborg1_user1_token,ti.root_msp1_suborg2_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
						new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","10","12","11","7","8","9"},1},
	...
	@Test(dataProvider="getRestoreJobReportsColumns_403",enabled=true)
	public void getRestoreJobReportsColumnForSpecifiedUserTest_403(String organizationType,
															String validToken,
		...
		test.log(LogStatus.INFO, "Get the RestoreJobReports columns for the specified user in the org: "+organizationType);
		spogReportServer.getRestoreJobReportsColumnsForSpecifiedUser(user_Id, otherUserValidToken, expected_columns, columnsHeadContent, SpogConstants.INSUFFICIENT_PERMISSIONS, expected_errormessage, test);
	...
	//400 and 404
	@DataProvider(name="getRestoreJobReportsColumns_404")
	public final Object[][] getRestoreJobReportsColumns_404() {
		...
		return new Object[][] {
			// different users
				{ "direct-invalidUserId", ti.direct_org1_user1_token,ti.direct_org1_user1_id,"invalid_user_id", new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","4","10","11","7","5","12","6","9","8"},4},
				{ "msp-invalidUserId", ti.root_msp_org1_user1_token,ti.root_msp_org1_user1_id,"invalid_user_id", new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"3","13","6","2","9","10","11","8","1","12","4","5","7"},7},
				{ "suborg-invalidUserId", ti.root_msp1_suborg1_user1_token,ti.root_msp1_suborg1_user1_id,"invalid_user_id", new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","10","11","7","8","12","9"},1},
				{ "csr-invalidUserId", ti.csr_token,ti.csr_admin_user_id,"invalid_user_id", new String[] { "true", "false"}, new String[] { "true", "false"},
						new String[] { "true", "false"},new String[]{"1","2","4","6","5","10","11","3","12","7","8","9"},1},
				...
				{ "direct-randomUserId", ti.direct_org1_user1_token,ti.direct_org1_user1_id,UUID.randomUUID().toString(), new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","1","4","10","11","12","7","5","6","9","8"},4},
				{ "msp-randomUserId", ti.root_msp_org1_user1_token,ti.root_msp_org1_user1_id,UUID.randomUUID().toString(), new String[] { "true", "false"}, new String[] { "true", "false"},
						new String[] { "true", "false"},new String[]{"3","6","13","2","9","8","1","10","11","12","4","5","7"},7},	
				{ "suborg-randomUserId", ti.root_msp1_suborg1_user1_token,ti.root_msp1_suborg1_user1_id,UUID.randomUUID().toString(), new String[] { "true", "false"}, new String[] { "true", "false"},
						new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","10","11","12","7","8","9"},1},
				{ "csr-randomUserId", ti.csr_token,ti.csr_admin_user_id,UUID.randomUUID().toString(), new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"1","2","4","6","10","11","5","12","3","7","8","9"},1},
	...
	@Test(dataProvider="getRestoreJobReportsColumns_404",enabled=true)
	public void getRestoreJobReportsColumnForSpecifiedUserTest_404(String organizationType,
															String validToken,
		...
		{	//400
			test.log(LogStatus.INFO, "Get the RestoreJobReports columns for the specified user in the org: "+organizationType);
			spogReportServer.getRestoreJobReportsColumnsForSpecifiedUser(invalid_user_Id, validToken, expected_columns, columnsHeadContent, SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_USERID_IS_NOT_UUID, test);
		}
		
		else
		{	//404
			test.log(LogStatus.INFO, "Get the RestoreJobReports columns for the specified user in the org: "+organizationType);
			spogReportServer.getRestoreJobReportsColumnsForSpecifiedUser(invalid_user_Id, validToken, expected_columns, columnsHeadContent, SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.USER_ID_DOESNOT_EXIST, test);
		}
	...
	//403 csr user id
			...
			return new Object[][] {
				// different users
					{ "direct-csrUserId", ti.direct_org1_user1_token, ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","1","4","12","7","10","11","5","6","9","8"},4},
					
					{ "msp-csrUserId", ti.root_msp_org1_user1_token, ti.root_msp_org1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
								new String[] { "true", "false"},new String[]{"3","13","6","10","12","11","2","9","8","1","4","5","7"},7},
					...
					{ "suborg-csrUserId", ti.root_msp1_suborg1_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
						new String[] { "true", "false"},new String[]{"1","2","3","10","12","11","4","5","6","7","8","9"},1}
			};
		}
		@Test(dataProvider="getRestoreJobReportsColumns_403_csrUserId",enabled=true)
		public void getRestoreJobReportsColumnForSpecifiedUserTest_403_csrUserId(String organizationType,
			...
			test.log(LogStatus.INFO, "Get the RestoreJobReports columns for the specified user in the org: "+organizationType);
			spogReportServer.getRestoreJobReportsColumnsForSpecifiedUser(ti.csr_admin_user_id, validToken, expected_columns, columnsHeadContent, SpogConstants.INSUFFICIENT_PERMISSIONS, expectedMessageCode, test);	
