...
public class CreateRestoreJobReportsColumnsForSpecifiedUserTest extends base.prepare.Is4Org {
   ...
   /* private ExtentReports rep;
	...
	@DataProvider(name="CreateRestoreJobReportsColumns_201")
	public final Object[][] CreateRestoreJobReportsColumns_201() {
		
		return new Object[][] {
			// different users
				{ "csr", ti.csr_token,ti.csr_admin_user_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","4","12","10","11","7","5","6","9","8"},4},
				...
				{ "direct-csrT", ti.csr_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","1","12","10","11","4","7","5","6","9","8"},4},
				...
				{ "direct-visibleTrue", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true"},new String[]{"2","3","1","4","10","11","12","7","5","6","9","8"},4},
				...
				{ "suborg-mspAccAdminT", ti.root_msp_org1_msp_accountadmin1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
								new String[] { "true", "false"},new String[]{"3","2","12","10","11","1","4","5","7","6","8","9"},1},
...
//				Delete the existing user job columns and create the same columns 
				{ "direct-deleteCreateSame", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
								new String[] { "true", "false","none"},new String[]{"2","10","12","11","3","1","4","7","5","6","9","8"},4},
				...
				{ "direct-sameColId", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
									new String[] { "true", "false","none"},new String[]{"2","12","10","11","3","1","4","7","5","6","9","8"},2},
				...
				{ "direct-sameColIdOrderId", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
										new String[] { "true", "false","none"},new String[]{"2","12","10","11","2","2","2","3","3","3","2","2"},2},
				...
				{ "direct-sameorderid", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","3","12","2","2","3","3","2","3","10","11","8"},4},
		};
	}
	@Test(dataProvider="CreateRestoreJobReportsColumns_201")
	public void createRestoreJobReportsColumnsForSpecifiedUserTest_201(String organizationType,
			  												String validToken,
			  												String user_Id,
			  												String[] sort,
			  												String[] filter,
			...
			for(int i=0;i<noofcolstocreate ;i++)
			{
				...
				{
					temp = spogReportServer.composeRestoreJobReports_Column(columnIdList.get(0), sort[index1], filter[index2], visible[index3], orderId[i]);
					if(i!=1) {
			...
			test.log(LogStatus.INFO, "Compare the RestoreJobReports columns created for specified user in org: "+organizationType);
			if(organizationType.contains("direct-sameColId"))
			{
				spogReportServer.compareReportJobReportsColumnsContent(response, expected_columns1, columnsHeadContent, SpogConstants.SUCCESS_POST, null, test);
			}
			else {
			spogReportServer.compareReportJobReportsColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.SUCCESS_POST, null, test);
			}
...
//			Delete the existing user job columns and create the same columns 
			...
			{
				test.log(LogStatus.INFO, "Create RestoreJobReports columns again for specified user in the org: "+organizationType);
				response= spogReportServer.createRestoreJobReportsColumnsForSpecifiedUser(user_Id, validToken, expected_columns, test);
				
				test.log(LogStatus.INFO, "Compare the RestoreJobReports columns created again for specified user in org: "+organizationType);
				spogReportServer.compareReportJobReportsColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.SUCCESS_POST, null, test);
				
				test.log(LogStatus.INFO, "delete RestoreJobReports columns created again for specified user in org: "+organizationType);
				spogReportServer.deleteRestoreJobReportsColumnsforSpecifiedUserwithCheck(user_Id, validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
				
			}			
	}
	  
	@DataProvider(name="CreateRestoreJobReportsColumns_400")
	public final Object[][] CreateRestoreJobReportsColumns_400() {
		...
		return new Object[][] {
			...
			{ "direct-invalidUid", ti.direct_org1_user1_token,"invalidUid", new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","12","4","10","11","7","5","6","9","8"},4},		
			...
			{ "direct-moreOrderIds", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","15","14","1","10","7","10","11","5","6","9","8","4","11","12","3"},11},
	...
	@Test(dataProvider="CreateRestoreJobReportsColumns_400",enabled=true)
	public void createRestoreJobReportsColumnsForSpecifiedUserTest_400(String organizationType,
			  												String validToken,
			  												String user_Id,
			  												String[] sort,
			  												String[] filter,
...
//				int index4 = gen_random_index(orderId);
				...
				{
					temp = spogReportServer.composeRestoreJobReports_Column("", sort[index1], filter[index2], visible[index3], orderId[i]);
				}
				else {
					temp = spogReportServer.composeRestoreJobReports_Column(columnIdList.get(i), sort[index1], filter[index2], visible[index3], orderId[i]);				
				}
			...
			test.log(LogStatus.INFO, "Compare the RestoreJobReports columns created for specified user in org: "+organizationType);
			spogReportServer.compareReportJobReportsColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.REQUIRED_INFO_NOT_EXIST, expectedErrorMessage, test);
			
		}
	
	@DataProvider(name="CreateRestoreJobReportsColumns_401")
	public final Object[][] CreateRestoreJobReportsColumns_401() {
		...
		return new Object[][] {
			// different users
				...
				{ "direct-missingT", "",ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","10","11","12","3","1","4","7","5","6","9","8"},4},
		};
	}
	@Test(dataProvider="CreateRestoreJobReportsColumns_401",enabled=true)
	public void createRestoreJobReportsColumnsForSpecifiedUserTest_401(String organizationType,
			  												String validToken,
			  												String user_Id,
			  												String[] sort,
			  												String[] filter,
...
//				int index4 = gen_random_index(orderId);
			...
			test.log(LogStatus.INFO, "Compare the RestoreJobReports columns created for specified user in org: "+organizationType);
			spogReportServer.compareReportJobReportsColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, expectedErrorMessage, test);
							
	}
	
	@DataProvider(name="createRestoreJobReportsColumns_403")
	public final Object[][] createRestoreJobReportsColumns_403() {
		...
		return new Object[][] {
			// different users
				...
				{ "direct-suborgT", ti.direct_org1_user1_token,ti.root_msp1_suborg1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","10","11","3","12","1","4","7","5","6","9","8"},4},
				...
				{ "msp-directT", ti.root_msp_org1_user1_token,ti.direct_org1_user1_token,ti.root_msp_org1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"3","6","10","13","11","2","12","9","8","1","4","5","7"},7},
				{ "msp-suborgT", ti.root_msp_org1_user1_token,ti.root_msp1_suborg1_user1_token,ti.root_msp_org1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
								new String[] { "true", "false"},new String[]{"3","6","10","13","11","12","2","9","8","1","4","5","7"},7},
				{ "msp-mspbT", ti.root_msp_org1_user1_token, ti.root_msp_org2_user1_token,ti.root_msp_org1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
									new String[] { "true", "false"},new String[]{"3","10","13","11","6","12","2","9","8","1","4","5","7"},7},
				...
				{ "suborg-directT", ti.root_msp1_suborg1_user1_token,ti.direct_org1_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","2","3","10","11","4","5","6","12","7","8","9"},1},
				...
				{ "csr-dirctT",ti.csr_token, ti.direct_org1_user1_token,ti.csr_admin_user_id, new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"4","2","3","10","11","1","12","5","6","9","8","7"},1},
				
				{ "csr-mspT", ti.csr_token,ti.root_msp_org1_user1_token,ti.csr_admin_user_id, new String[] { "true", "false"}, new String[] { "true", "false"},
								new String[] { "true", "false"},new String[]{"1","2","10","11","3","12","8","5","4","7","6","9"},1},
				...
				{ "csr-suborgT", ti.csr_token,ti.root_msp1_suborg1_user1_token,ti.csr_admin_user_id, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","7","5","4","3","10","11","6","12","2","8","9"},1},
				
		
		};
	}
	@Test(dataProvider="createRestoreJobReportsColumns_403",enabled=true)
	public void createRestoreJobReportsColumnForSpecifiedUserTest_403(String organizationType,
															String validToken,
		...
		Response response= spogReportServer.createRestoreJobReportsColumnsForSpecifiedUser(user_Id,otherUserValidToken,expected_columns,test);
		...
		test.log(LogStatus.INFO, "Get the RestoreJobReports columns for the specified user in the org: "+organizationType);
		spogReportServer.compareReportJobReportsColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.INSUFFICIENT_PERMISSIONS, expected_errormessage, test);

	}
	
	
	@DataProvider(name="CreateRestoreJobReportsColumns_404")
	public final Object[][] CreateRestoreJobReportsColumns_404() {
		
		return new Object[][] {
			// different users
				{ "csr-uidNotExist", ti.csr_token,UUID.randomUUID().toString(), new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","10","11","3","1","4","7","5","12","6","9","8"},1},
				{ "csr-colIdNotExist", ti.csr_token,ti.csr_admin_user_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","10","11","3","1","4","7","12","5","6","9","8"},1},
				...
				{ "msp-uidNotExist", ti.root_msp_org1_user1_token,UUID.randomUUID().toString(), new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","13","3","10","11","1","4","7","12","5","6","9","8"},1},
				...
				{ "suborg-uidNotExist", ti.root_msp1_suborg1_user1_token,UUID.randomUUID().toString(), new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","10","11","1","4","7","5","12","6","9","8"},1},
	...
	@Test(dataProvider="CreateRestoreJobReportsColumns_404",enabled=true)
	public void createRestoreJobReportsColumnsForSpecifiedUserTest_404(String organizationType,
			  												String validToken,
			  												String user_Id,
			  												String[] sort,
			  												String[] filter,
...
//				int index4 = gen_random_index(orderId);
				...
				{
					temp = spogReportServer.composeRestoreJobReports_Column(columnid, sort[index1], filter[index2], visible[index3], orderId[i]);
				}
				else {
					temp = spogReportServer.composeRestoreJobReports_Column(columnIdList.get(i), sort[index1], filter[index2], visible[index3], orderId[i]);	
				}
			...
			if(organizationType.contains("uidNotExist")) {
				test.log(LogStatus.INFO, "Compare the RestoreJobReports columns created for specified user in org: "+organizationType);
				spogReportServer.compareReportJobReportsColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.USER_ID_DOESNOT_EXIST, test);	
			}
			else {
				test.log(LogStatus.INFO, "Compare the RestoreJobReports columns created for specified user in org: "+organizationType);
				spogReportServer.compareReportJobReportsColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.COLUMN_ID_DOESNOT_EXIST, test);
			}
