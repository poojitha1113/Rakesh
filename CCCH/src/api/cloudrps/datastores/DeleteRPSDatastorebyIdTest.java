...
/** This is to test whether the datastore deletion on a RPS machine successful or not
...
public class DeleteRPSDatastorebyIdTest extends base.prepare.Is4Org {
	...
	public Object datastoreInvalid() {
		return new Object[][] {
			//400
			{"Delete the datastore with invalid datastore id","invalid", ti.csr_token, SpogConstants.REQUIRED_INFO_NOT_EXIST,SpogMessageCode.ELEMENT_IS_NOT_UUID},
			{"Delete the datastore with null datastore id",null, ti.csr_token, SpogConstants.REQUIRED_INFO_NOT_EXIST,SpogMessageCode.ELEMENT_IS_NOT_UUID},
			
			//401
			{ "Delete the datastore with missing token",datastoreid, "", SpogConstants.NOT_LOGGED_IN,SpogMessageCode.COMMON_AUTHENTICATION_FAILED},
			{"Delete the datastore with invalid token",datastoreid, ti.csr_token+1, SpogConstants.NOT_LOGGED_IN,SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT},
			
			//403
			{"Delete the datastore of csr org using direct org token",datastoreid, ti.direct_org1_user1_token, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY,},
			{"Delete the datastore of csr org using msp org token",datastoreid, ti.root_msp_org1_user1_token, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY,},
			{"Delete the datastore of csr org using sub org token",datastoreid, ti.root_msp1_suborg1_user1_token, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY,},
			{"Delete the datastore of csr org using msp_account_admin_validToken",datastoreid, ti.root_msp_org1_msp_accountadmin1_token, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY,},
			{"Delete the datastore of csr org using sub msp org token",datastoreid, ti.root_msp1_submsp1_user1_token, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY,},
			{"Delete the datastore of csr org using sub msp sub org token",datastoreid, ti.msp1_submsp1_suborg1_user1_token, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY,},
			{"Delete the datastore of csr org using sub msp account_admin_validToken",datastoreid, ti.root_msp1_submsp1_account_admin_token, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY,},
			{"Delete the datastore of csr org using csr_readonly user token",datastoreid, ti.csr_readonly_token, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY,},
			
			//404
			{"Delete the cloud rps datastore that is already deleted",UUID.randomUUID().toString(), ti.csr_token, SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.DATASTORE_WITH_ID_DOESNOT_EXIST},
			
			//405
			{"Delete the cloud rps datastore without un assigning from destination",datastoreid, ti.csr_token, SpogConstants.NOT_ALLOWED_ON_RESOURCE, SpogMessageCode.DATASTORE_USED_BY_CLOUDHYBRIDSTORE_UNABLE_TO_DELETE},
			
			//200
			{"Delete the cloud rps datastore valid",datastoreid, ti.csr_token, SpogConstants.SUCCESS_GET_PUT_DELETE, null}
		};
	}
	
	@Test(dataProvider = "datastoreInvalid",dependsOnMethods="postcloudRPSDatastore")
	public void deletecloudRPSDatastoreInvalid(String caseType, String datastore_id, String validToken, int expectedStatusCode, SpogMessageCode expectedErrorMessage) {
		...
		if (expectedStatusCode == SpogConstants.SUCCESS_GET_PUT_DELETE) {
			...
			test.log(LogStatus.INFO, "Delete the destination with id:"+destination_id);
		...
		spogcloudRPSServer.deleteCloudRPSDataStore(datastore_id, validToken, expectedStatusCode, expectedErrorMessage, test);
