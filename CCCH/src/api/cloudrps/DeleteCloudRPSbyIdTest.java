...
/** This is to test whether CSR user can un-register(remove/delete) the RPS form CC or not
 * 
 * Prerequisites:
...
public class DeleteCloudRPSbyIdTest extends base.prepare.Is4Org {
	...
	public void beforeClass(String baseURI, String port,String logFolder,String runningMachine,String buildVersion) {
		...
		rep = ExtentManager.getInstance("DeleteCloudRPSbyIdTest", logFolder);
	...
	@DataProvider(name = "deletecloudRPS_data")
	public final Object[][] deletecloudRPS_data() {
		return new Object[][] {
			//400 cases
			{"Delete cloud rps by id with invalid cloud rps id",ti.csr_token,"invalidRPSid",SpogConstants.REQUIRED_INFO_NOT_EXIST,SpogMessageCode.ELEMENT_IS_NOT_UUID},
			{"Delete cloud rps by id with null as cloud rps id",ti.csr_token,null,SpogConstants.REQUIRED_INFO_NOT_EXIST,SpogMessageCode.ELEMENT_IS_NOT_UUID},
			
			//401 cases
			{"Delete cloud rps by id with invalid token","invalidtoken",cloudRPS_id,SpogConstants.NOT_LOGGED_IN,SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT},
			{"Delete cloud rps by id with missing token","",cloudRPS_id,SpogConstants.NOT_LOGGED_IN,SpogMessageCode.COMMON_AUTHENTICATION_FAILED},
			
			//404 cases
			{"Delete cloud rps by id with cloud rps id that does not exist",ti.csr_token,UUID.randomUUID().toString(),SpogConstants.RESOURCE_NOT_EXIST,SpogMessageCode.RECOVERY_POINT_SERVER_WITH_ID_DOESNOT_EXIST},
			
			//403 cases
			{"Delete cloud rps by id with cloud rps id with direct user token",ti.direct_org1_user1_token,cloudRPS_id,SpogConstants.INSUFFICIENT_PERMISSIONS,SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"Delete cloud rps by id with cloud rps id with msp user token",ti.root_msp_org1_user1_token,cloudRPS_id,SpogConstants.INSUFFICIENT_PERMISSIONS,SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"Delete cloud rps by id with cloud rps id with sub org user token",ti.root_msp1_suborg1_user1_token,cloudRPS_id,SpogConstants.INSUFFICIENT_PERMISSIONS,SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"Delete cloud rps by id with cloud rps id with msp_account_admin token",ti.root_msp_org1_msp_accountadmin1_token,cloudRPS_id,SpogConstants.INSUFFICIENT_PERMISSIONS,SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"Delete cloud rps by id with cloud rps id with sub msp user token",ti.root_msp1_submsp1_user1_token,cloudRPS_id,SpogConstants.INSUFFICIENT_PERMISSIONS,SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"Delete cloud rps by id with cloud rps id with sub msp sub org user token",ti.msp1_submsp1_suborg1_user1_token,cloudRPS_id,SpogConstants.INSUFFICIENT_PERMISSIONS,SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"Delete cloud rps by id with cloud rps id with sub msp_account_admin token",ti.root_msp1_submsp1_account_admin_token,cloudRPS_id,SpogConstants.INSUFFICIENT_PERMISSIONS,SpogMessageCode.RESOURCE_PERMISSION_DENY},
			{"Delete cloud rps by id with cloud rps id with csr_readonly token",ti.csr_readonly_token,cloudRPS_id,SpogConstants.INSUFFICIENT_PERMISSIONS,SpogMessageCode.RESOURCE_PERMISSION_DENY},
			
			//200 case
			{"Delete cloud rps by id with cloud rps id with csr token",ti.csr_token,cloudRPS_id,SpogConstants.SUCCESS_GET_PUT_DELETE,null},
		
		};
	}
	
	@Test(dataProvider = "deletecloudRPS_data",dependsOnMethods= {"postcloudRPS"},enabled=true)
	public void deletecloudRPS(String caseType,
									String token,
									String cloudRPS_id,							
