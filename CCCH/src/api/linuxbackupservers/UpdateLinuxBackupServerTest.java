...
public class UpdateLinuxBackupServerTest extends base.prepare.Is4Org{
	...
	public final Object[][] updateHypervisorfilterValidParams() {
		return new Object[][] {
			...
			{"none", "server_name01", "https", "8014", "root", "cnbjrdqa1@", initial_direct_orgID, UUID.randomUUID().toString(), "normal", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 
				"server_name01_updated", "http","8014",  "rootroot", "cnbjrdqa1!", initial_direct_orgID, UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c"},
			{"none", "server_name01", "https", "8014", "root", "cnbjrdqa1@", initial_direct_orgID, UUID.randomUUID().toString(), "normal", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 
				"", "http","8015",  "rootroot", "cnbjrdqa1!", initial_direct_orgID, UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c"},
		};
	}
// zhaoguo: comment this out as we need to connect linux web service to valid
//	@Test(dataProvider = "update_linux_backup_server_valid")
	public void updateLinuxServerValid(String server_id, String server_name, String server_protocol, String server_port, String server_username, String server_password, String organization_id, 
			String site_id, String status, String datacenter_id, String server_name_update, String server_protocol_update, String server_port_update, String server_username_update, String server_password_update, String organization_id_update, 
			String site_id_update, String status_update, String datacenter_id_update) {
		spogServer.userLogin(csrAdmin, csrPwd);
		String prefix = RandomStringUtils.randomAlphanumeric(8);
		linux4spogServer.setToken(spogServer.getJWTToken());
		server_name = prefix + server_name;
		server_name_update = prefix + server_name_update;
		...
		linux4spogServer.updateLinuxBackupServer(server_id_response, server_id_response, server_name_update, server_protocol_update, server_port_update, server_username_update, server_password_update, organization_id_update, site_id_update, status_update, datacenter_id_update, test);
	...
	public final Object[][] updateHypervisorfilterinValidParams() {
		return new Object[][] {
			{csrAdmin, csrPwd, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
				"server_name01_updated", "", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "warning", datacenter_id, 400, "40000001"},
//			{csrAdmin, csrPwd, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
//				"server_name02_updated", "https","8014",  "", "cnbjrdqa1!", initial_direct_orgID, UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 400, "40000001"},
//			{csrAdmin, csrPwd, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id,
//				"server_name03_updated", "https","8014",  "rootroot", "", initial_direct_orgID, UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 400, "40000001"},
//			{csrAdmin, csrPwd, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
//				"server_name04_updated", "https", "8014", "rootroot", "", initial_direct_orgID, UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 400, "40000001"},
//			{csrAdmin, csrPwd, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
//				longString, "https", "8014", "rootroot", "", initial_direct_orgID, UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 400, "40000002"},
//			{csrAdmin, csrPwd, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
//				"server_name06_updated", "https","8014",  longString, "cnbjrdqa1!", initial_direct_orgID, UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 400, "40000002"},
//			{csrAdmin, csrPwd, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
//				"server_name07_updated", "https", "8014", "rootroot", longString, initial_direct_orgID, UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 400, "40000002"},
//			{csrAdmin, csrPwd, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
//				"server_name08_updated", "protocol", "8014", "rootroot", "cnbjrdqa1!", initial_direct_orgID, UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 400, "40000006"},
//			{csrAdmin, csrPwd, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
//				"server_name09_updated", "http", "8014", "rootroot", "cnbjrdqa1!", initial_direct_orgID, UUID.randomUUID().toString(), "status", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 400, "40000006"},
//			{csrAdmin, csrPwd, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
//				"server_name10_updated", "http", "8014", "rootroot", "cnbjrdqa1!", "initial_direct_orgID", UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 400, "40000005"},
//			{csrAdmin, csrPwd, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
//				"server_name11_updated", "http", "8014", "rootroot", "cnbjrdqa1!", UUID.randomUUID().toString(), UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 404, "0030000A"},
//			{initial_direct_email_full, password, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
//				"server_name12_updated", "http", "8014", "rootroot", "cnbjrdqa1!", initial_direct_orgID, UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 403, "00100101"},
//			{initial_msp_email_full, password, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
//				"server_name13_updated", "http", "8014", "rootroot", "cnbjrdqa1!", initial_direct_orgID, UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 403, "00100101"},
//			{initial_sub_email_full_a, password, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
//				"server_name14_updated", "http", "8014", "rootroot", "cnbjrdqa1!", initial_direct_orgID, UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 403, "00100101"},
		};
	}
...
//	@Test(dataProvider = "update_linux_backup_server_invalid")
	public void updateLinuxServerInvalid(String username, String password, String server_id, String server_name, String server_protocol, String server_port, String server_username, String server_password, String organization_id, 
			String site_id, String status, String datacenter_id, String server_name_update, String server_protocol_update, String server_port_update, String server_username_update, String server_password_update, String organization_id_update, 
			String site_id_update, String status_update, String datacenter_id_update, int status_code, String error_code) {
		spogServer.userLogin(csrAdmin, csrPwd);
		String prefix = RandomStringUtils.randomAlphanumeric(8);
		linux4spogServer.setToken(spogServer.getJWTToken());
		String server_id_response = linux4spogServer.createLinuxBackupServer(server_id, server_name, server_protocol, server_port, server_username, server_password, organization_id, site_id, status, datacenter_id, test);
		...
		linux4spogServer.setToken(spogServer.getJWTToken());
		linux4spogServer.updateLinuxBackupServerWithErrorCheck(server_id_response, server_id_response, server_name_update, server_protocol_update, server_port_update, server_username_update, server_password_update, organization_id_update, site_id_update, status_update, datacenter_id_update, status_code, error_code, test);
	...
	@DataProvider(name = "update_linux_backup_server_notoken")
	public final Object[][] updateHypervisorfilternotokenParams() {
		return new Object[][] {
			{csrAdmin, csrPwd, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 
				"server_name01_updated", "", "8014", "rootroot", "cnbjrdqa1!", initial_direct_orgID, UUID.randomUUID().toString(), "warning", "91a9b48e-6ac6-4c47-8202-614b5cdcfe0c", 401, "00900006"},
		};}
	
	@Test(dataProvider = "update_linux_backup_server_notoken")
	public void updateLinuxServerNotoken(String username, String password, String server_id, String server_name, String server_protocol, String server_port, String server_username, String server_password, String organization_id, 
			String site_id, String status, String datacenter_id, String server_name_update, String server_protocol_update, String server_port_update, String server_username_update, String server_password_update, String organization_id_update, 
			String site_id_update, String status_update, String datacenter_id_update, int status_code, String error_code) {
		spogServer.userLogin(csrAdmin, csrPwd);
		linux4spogServer.setToken(spogServer.getJWTToken());
		...
		// csr readonly user cannot update linux backup server
		spogServer.userLogin(csr_readonly_email, csr_readonly_password);
		linux4spogServer.setToken(spogServer.getJWTToken());
		linux4spogServer.updateLinuxBackupServerWithErrorCheck(server_id_response, server_id_response, server_name_update, server_protocol_update, server_port_update,server_username_update, server_password_update, organization_id_update, site_id_update, status_update, datacenter_id_update, 403, "00100101", test);
	...
	public final Object[][] updateHypervisorfilterInvalidIDParams() {
		return new Object[][] {
			{"none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id,},
		};}
	
	@Test(dataProvider = "update_linux_backup_server_invalidID")
	public void updateLinuxServerinvalidID(String server_id, String server_name, String server_protocol, String server_port, String server_username, String server_password, String organization_id, 
			String site_id, String status, String datacenter_id) {
		spogServer.userLogin(csrAdmin, csrPwd);
		linux4spogServer.setToken(spogServer.getJWTToken());
		String server_id_response = linux4spogServer.createLinuxBackupServer(server_id, server_name, server_protocol, server_port, server_username, server_password, organization_id, site_id, status, datacenter_id, test);
		linux4spogServer.updateLinuxBackupServerWithErrorCheck(UUID.randomUUID().toString(), server_id_response, server_name, server_protocol, server_port, server_username, server_password, organization_id, site_id, status, datacenter_id, 404, "01400002", test);
		linux4spogServer.updateLinuxBackupServerWithErrorCheck("serverID", server_id_response, server_name, server_protocol, server_username, server_port, server_password, organization_id, site_id, status, datacenter_id, 400, "40000005", test);
		spogServer.userLogin(csrAdmin, csrPwd);
		linux4spogServer.setToken(spogServer.getJWTToken());
		linux4spogServer.deleteLinuxBackupServer(server_id_response, test);
	}
