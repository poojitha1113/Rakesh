...
public class GetLinuxBackupServerTest extends base.prepare.Is4Org{
...
//	private String buildVersion;
	...
	@DataProvider(name = "get_linux_backup_server_valid")
	...
	@Test(dataProvider = "get_linux_backup_server_valid")
	public void getLinuxServerValid(String server_id, String server_name, String server_protocol, String server_port, String server_username, String server_password, String organization_id, 
		...
		Response response = linux4spogServer.getLinuxBackupServer(server_id_response, test);
		linux4spogServer.verifyLinuxServerInfo(response, server_name, server_protocol, server_port, server_username, organization_id, site_id, status, datacenter_id);
		linux4spogServer.deleteLinuxBackupServer(server_id_response, test);
	}
	
	@DataProvider(name = "get_linux_backup_server_invalid")
...
// need to confirm if csr_readonly_admin can get linux backup servers
//			{csr_readonly_email, csr_readonly_password, "none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id, 403, "00100101"},
	...
	@Test(dataProvider = "get_linux_backup_server_invalid")
	public void getLinuxServerInvalid(String username, String password, String server_id, String server_name, String server_protocol, String server_port, String server_username, String server_password, String organization_id, 
		...
		linux4spogServer.setToken(spogServer.getJWTToken());
		linux4spogServer.getLinuxBackupServerWithErrorCheck(server_id_response, status_code, error_code, test);
		spogServer.userLogin(csrAdmin, csrPwd);
		linux4spogServer.setToken(spogServer.getJWTToken());
		linux4spogServer.deleteLinuxBackupServer(server_id_response, test);
	}
	
	@DataProvider(name = "get_linux_backup_server_notoken")
	...
	@Test(dataProvider = "get_linux_backup_server_notoken")
	public void getLinuxServerNotoken(String username, String password, String server_id, String server_name, String server_protocol, String server_port, String server_username, String server_password, String organization_id, 
			String site_id, String status, String datacenter_id, int status_code, String error_code) {
		spogServer.userLogin(csrAdmin, csrPwd);
		linux4spogServer.setToken(spogServer.getJWTToken());
		String server_id_response = linux4spogServer.createLinuxBackupServer(server_id, server_name, server_protocol, server_port, server_username, server_password, organization_id, site_id, status, datacenter_id, test);
	...
	@DataProvider(name = "get_linux_backup_server_invalidID")
	public final Object[][] updateHypervisorfilterInvalidIDParams() {
		return new Object[][] {
			{"none", "10.57.10.12", "https", "8014", "root", "cnbjrdqa1@", csr_organization_id, siteID, "normal", datacenter_id},
		};}
	
	@Test(dataProvider = "get_linux_backup_server_invalidID")
	public void getLinuxServerinvalidID(String server_id, String server_name, String server_protocol, String server_port, String server_username, String server_password, String organization_id, 
			String site_id, String status, String datacenter_id) {
		spogServer.userLogin(csrAdmin, csrPwd);
		linux4spogServer.setToken(spogServer.getJWTToken());
		...
		linux4spogServer.getLinuxBackupServerWithErrorCheck(UUID.randomUUID().toString(), 404, "01400002", test);
		linux4spogServer.getLinuxBackupServerWithErrorCheck("serverID", 400, "40000005", test);
	}
