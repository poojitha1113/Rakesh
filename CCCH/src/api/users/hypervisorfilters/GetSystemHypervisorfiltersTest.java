...
public class GetSystemHypervisorfiltersTest {
	...
	public final Object[][] getHypervisorfilterValidParams() {
		return new Object[][] {
			...
			{initial_msp_account_email_full},
		};
	}
	
	@Test(dataProvider = "get_hypervisorfilters_valid")
	public void getHypervisorfilterValid(String username) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken(spogServer.getJWTToken());

		Response response = userSpogServer.getSystemHypervisorfilters(test);
	}
	...
	public final Object[][] getHypervisorfilterNoTokenParams() {
		return new Object[][] {
			...
			{initial_msp_email_full_added, 401, "00900006"},
			{initial_sub_email_full_a_added, 401, "00900006"},
			{initial_direct_email_full_added, 401, "00900006"},
			
		};
	}
	
	@Test(dataProvider = "get_hypervisorfilters_no_token")
	public void getHypervisorfilterNoToken(String username, int statusCode, String expectedErrorCode) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken("");
	
		userSpogServer.getSystemHypervisorfiltersWithErrorCheck(statusCode, expectedErrorCode,test);
	}
