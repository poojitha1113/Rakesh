...
public class DeleteHypervisorfilterForLoggedinUserTest {
	...
	public final Object[][] deleteHypervisorfilterValidParams() {
		return new Object[][] {
			...
			{initial_msp_email_full_added,  "filterName01", "status", "udp", "xen", "hypervisorName", "true"},
			{initial_sub_email_full_a_added,  "filterName01", "status", "udp", "xen", "hypervisorName", "true"},
			{initial_msp_account_email_full,  "filterName01", "status", "udp", "xen", "hypervisorName", "true"},
		};
	}
	
	@Test(dataProvider = "delete_hypervisorfilter_valid")
	public void deleteHypervisorfilterValid(String username, String filterName, String status, String hypervisorProduct, 
		...
		userSpogServer.deleteHypervisorFilterForLoggedinUser(filterID, test);
		
		userSpogServer.getHypervisorFilterForLoggedinUserWithCodeCheck(filterID, 404, "00A00502", test);
	}
	...
	public void deleteHypervisorfilterNoToken(String username, String usernameGet, String filterName, String status, String hypervisorProduct, 
		...
		userSpogServer.deleteHypervisorFilterForLoggedinUserWithCodeCheck(filterID, statusCode, expectedErrorCode, test);
	}
	...
	public void deleteHypervisorfilterNoExisting(String username, String filterID, int statusCode, String expectedErrorCode) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken(spogServer.getJWTToken());
		userSpogServer.deleteHypervisorFilterForLoggedinUserWithCodeCheck(filterID, statusCode, expectedErrorCode, test);
	}
