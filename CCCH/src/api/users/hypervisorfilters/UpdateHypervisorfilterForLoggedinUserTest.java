...
public class UpdateHypervisorfilterForLoggedinUserTest {
	...
	public final Object[][] updateHypervisorfilterValidParams() {
		return new Object[][] {
			...
			{initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 
				"filterName01_updated", "status", "udp", "xen", "hypervisorName", "false"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 
				"", "status", "udp", "xen", "hypervisorName", "true"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 
				null, "status", "udp", "xen", "hypervisorName", "true"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 
				"none", "status", "udp", "xen", "hypervisorName", "true"},

			// TODO: update filter with different status
			// TODO: update filter with different hypervisorProduct
			{initial_direct_email_full_added, "filterName01", "status", "udp", "none", "hypervisorName", "true", 
					null, "status", "udp,cloud_direct", "vmware,xen", "hypervisorName", "false"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "none", "hypervisorName", "true", 
					null, "status", "emptyarray", "vmware,xen", "hypervisorName", "false"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "none", "hypervisorName", "true", 
					null, "status", "none", "vmware,xen", "hypervisorName", "false"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "none", "hypervisorName", "true", 
					null, "status", null, "vmware,xen", "hypervisorName", "false"},
			
			// update filter with different hypervisorType
			{initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 
				null, "status", "udp", "vmware,xen", "hypervisorName", "true"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "vmware,xen", "hypervisorName", "true", 
				null, "status", "udp", "xen", "hypervisorName", "true"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "vmware,xen", "hypervisorName", "true", 
				null, "status", "udp", "emptyarray", "hypervisorName", "true"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "vmware,xen", "hypervisorName", "true", 
				null, "status", "udp", null, "hypervisorName", "true"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "vmware,xen", "hypervisorName", "true", 
				null, "status", "udp", "none", "hypervisorName", "true"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "none", "hypervisorName", "true", 
				null, "status", "udp", "vmware,xen", "hypervisorName", "true"},
			
			// update filter with different hypervisorName
			{initial_direct_email_full_added, "filterName01", "status", "udp", "none", "hypervisorName", "true", 
				null, "status", "udp", "vmware,xen", "", "true"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "none", "hypervisorName", "true", 
				null, "status", "udp", "vmware,xen", null, "true"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "none", "hypervisorName", "true", 
				null, "status", "udp", "vmware,xen", "none", "true"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "none", "", "true", 
				null, "status", "udp", "vmware,xen", "", "true"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "none", "", "true", 
				null, "status", "udp", "vmware,xen", "hypervisorName", "true"},
			...
			{initial_direct_email_full_added, "filterName01", "status", "udp", "none", "hypervisorName", "true", 
				null, "status", "udp", "vmware,xen", "hypervisorName", "false"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "none", "hypervisorName", "true", 
				null, "status", "udp", "vmware,xen", "hypervisorName", null},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "none", "hypervisorName", "true", 
				null, "status", "udp", "vmware,xen", "hypervisorName", "none"},
		
			// msp account admin
			{initial_msp_account_email_full, "filterName01", "status", "udp", "none", "hypervisorName", "true", 
					null, "status", "udp", "vmware,xen", "hypervisorName", "none"},
		};
	}
	
	@Test(dataProvider = "update_hypervisorfilter_valid")
	public void updateHypervisorfilterValid(String username, String filterName, String status, String hypervisorProduct, 
			String hypervisorType, String hypervisorName, String isDefault, String filterNameUpdate, String statusUpdate,
		...
		userSpogServer.updateHypervisorFilterForLoggedinUser(filterID, filterNameUpdate, statusUpdate, hypervisorProductUpdate, hypervisorTypeUpdate, hypervisorNameUpdate, isDefaultUpdate, test);
	}
	...
	public final Object[][] updateHypervisorfilterInvalidParams() {
		return new Object[][] {
			...
			{initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 
				"filterName_initial", "status", "udp", "xen", "hypervisorName", "false", 400, "00A00501"},
			// update filter and set invalid hypervisorType
			{initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 
				"filterName_initial", "status", "udp", "hypervisorType", "hypervisorName", "false", 400, "40000006"},
			// update filter and set invalid isDefault
			{initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 
				"filterName_initial", "status", "udp", "xen", "hypervisorName", "isDefault", 400, "00100001"},
	...
	public void updateHypervisorfilterInvalid(String username, String filterName, String status, String hypervisorProduct, 
			String hypervisorType, String hypervisorName, String isDefault, String filterNameUpdate, String statusUpdate,
		...
		userSpogServer.updateHypervisorFilterForLoggedinUserWithCodeCheck(filterID, filterNameUpdate, statusUpdate, 
	...
	public final Object[][] updateHypervisorfilterNoTokenParams() {
		return new Object[][] {
			{initial_direct_email_full_added,  "filterName01", "status", "udp", "xen", "hypervisorName", "true", 
				"filterName_initial", "status", "udp", "xen", "hypervisorName", "false", 401, "00900006"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 
				"filterName_initial", "status", "udp", "xen", "hypervisorName", "false", 401, "00900006"},
			{initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 
				"filterName_initial", "status", "udp", "xen", "hypervisorName", "false", 401, "00900006"},
	...
	public void updateHypervisorfilterNoToken(String username, String filterName, String status, String hypervisorProduct, 
			String hypervisorType, String hypervisorName, String isDefault, String filterNameUpdate, String statusUpdate,
			String hypervisorProductUpdate, String hypervisorTypeUpdate, String hypervisorNameUpdate, String isDefaultUpdate, int statusCode, String expectedErrorCode) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken(spogServer.getJWTToken());
	...
	public final Object[][] updateHypervisorfilterNonExistingParams() {
		return new Object[][] {
			{initial_direct_email_full_added, "filterID", "filterName01", "status", "udp", "xen", "hypervisorName", "true", 400, "40000005"},
			{initial_direct_email_full_added, UUID.randomUUID().toString(), "filterName01", "status", "udp", "xen", "hypervisorName", "true", 404, "00A00502"},
		};}
	
	@Test(dataProvider = "update_hypervisorfilter_non_existing")
	public void updateHypervisorfilterNonExisting(String username, String filterID, String filterName, String status, String hypervisorProduct, 
			String hypervisorType, String hypervisorName, String isDefault, int statusCode, String expectedErrorCode) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken(spogServer.getJWTToken());
		userSpogServer.updateHypervisorFilterForLoggedinUserWithCodeCheck(filterID, filterName, status, 
