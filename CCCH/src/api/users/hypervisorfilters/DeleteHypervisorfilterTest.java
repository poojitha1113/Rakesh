...
public class DeleteHypervisorfilterTest {
	...
	@DataProvider(name = "delete_hypervisorfilter_valid")
	public final Object[][] deleteHypervisorfilterValidParams() {
		return new Object[][] {
	...
	@Test(dataProvider = "delete_hypervisorfilter_valid")
	public void deleteHypervisorfilterValid(String username, String userID, String filterName, String status, String hypervisorProduct, 
		...
		userSpogServer.deleteHypervisorFilterForSpecificUser(userID, filterID, test);
		
		userSpogServer.getHypervisorFilterForSpecificUserWithCodeCheck(userID, filterID, 404, "00A00502", test);
	}
	
	@DataProvider(name = "delete_hypervisorfilter_no_permission")
	public final Object[][] deleteHypervisorfilternNoPermissionParams() {
		return new Object[][] {
			...
			{initial_direct_email_full, initial_direct_user_ID_added, initial_msp_account_email_full, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			...
			{initial_msp_account_email_full, initial_msp_account_userID, initial_direct_email_full, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
	...
	@Test(dataProvider = "delete_hypervisorfilter_no_permission")
	public void deleteHypervisorfilterNoPermission(String username, String userID, String usernameGet, String filterName, String status, String hypervisorProduct, 
		...
		userSpogServer.setToken(spogServer.getJWTToken());
		userSpogServer.deleteHypervisorFilterForSpecificUserWithCodeCheck(userID, filterID, statusCode, expectedErrorCode, test);
	}
	
	@DataProvider(name = "delete_hypervisorfilter_no_token")
	public final Object[][] deleteHypervisorfilternNoTokenParams() {
		return new Object[][] {
	...
	@Test(dataProvider = "delete_hypervisorfilter_no_token")
	public void deleteHypervisorfilterNoToken(String username, String userID, String usernameGet, String filterName, String status, String hypervisorProduct, 
			String hypervisorType, String hypervisorName, String isDefault, int statusCode, String expectedErrorCode) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken(spogServer.getJWTToken());
		String prefix = RandomStringUtils.randomAlphanumeric(8);
	...
	@DataProvider(name = "delete_hypervisorfilter_non_existing")
	public final Object[][] deleteHypervisorfilternNonExistingParams() {
		return new Object[][] {
	...
	@Test(dataProvider = "delete_hypervisorfilter_non_existing")
	public void deleteHypervisorfilterNoExisting(String username, String userID, String filterID, int statusCode, String expectedErrorCode) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken(spogServer.getJWTToken());
		userSpogServer.deleteHypervisorFilterForSpecificUserWithCodeCheck(userID, filterID, statusCode, expectedErrorCode, test);
	}
