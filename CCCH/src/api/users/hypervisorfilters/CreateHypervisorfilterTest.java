...
public class CreateHypervisorfilterTest {
	...
	public final Object[][] createHypervisorfilterValidParams() {
		return new Object[][] {
			...
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName04", "status", "udp", "xen", "hypervisorName", "true"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName04", "status", "udp,cloud_direct", "xen", "hypervisorName", "true"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName04", "status", "none", "xen", "hypervisorName", "true"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName04", "status", "emptyarray", "xen", "hypervisorName", "true"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName04", "status", null, "xen", "hypervisorName", "true"},
			...
			// msp admin create users in sub org
			{initial_msp_email_full, initial_sub_user_ID_a_added, "filterName03", "status", "udp", "xen", "hypervisorName", "true"},
			
			// msp account admin
			{initial_msp_account_email_full, initial_sub_user_ID_a_added, "filterName04", "status", "udp", "xen", "hypervisorName", "true"},
			{initial_msp_email_full, initial_msp_account_userID, "filterName04", "status", "udp", "xen", "hypervisorName", "true"},
			
		};
	}
	
	@Test(dataProvider = "create_hypervisorfilter_valid")
	public void createHypervisorfilterValid(String username, String userID, String filterName, String status, String hypervisorProduct, 
			String hypervisorType, String hypervisorName, String isDefault) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken(spogServer.getJWTToken());
		String prefix = RandomStringUtils.randomAlphanumeric(8);
		filterName = prefix + filterName;
		userSpogServer.createHypervisorFilterForSpecificUser(userID, filterName, status, hypervisorProduct, hypervisorType, hypervisorName, isDefault, test);
	}
	...
	public final Object[][] createHypervisorfilterInvalidParams() {
		return new Object[][] {
			...
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName_initial", "status", "udp", "xen", "hypervisorName", "true", 400, "00A00501"},
			
			// invalid filter_name
			{initial_direct_email_full_added, initial_direct_user_ID_added, "", "status", "udp", "xen", "hypervisorName", "true", 400, "40000001"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, null, "status", "udp", "xen", "hypervisorName", "true", 400, "40000001"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, "none", "status", "udp", "xen", "hypervisorName", "true", 400, "40000001"},
			
			// invalid hypervisorType
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName", "status", "udp", "hypervisorType", "hypervisorName", "true", 400, "40000006"},
			
			// invalid is_default
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName", "status", "udp", "xen", "hypervisorName", "isDefault", 400, "00100001"},
			
			// TODO: invalid status
			// TODO: invalid hypervisor_product
			
			// without permission
			{initial_direct_email_full_added, initial_msp_user_ID_added, "filterName", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_direct_email_full_added, initial_sub_user_ID_a_added, "filterName", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_sub_email_full_a_added, initial_msp_user_ID_added, "filterName", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_sub_email_full_a_added, initial_direct_user_ID_added, "filterName", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_msp_email_full_added, initial_direct_user_ID_added, "filterName", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			// msp account admin
			{initial_msp_account_email_full, initial_direct_user_ID_added, "filterName", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_msp_account_email_full, initial_sub_user_ID_b_added, "filterName", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_msp_account_email_full, initial_msp_user_ID_added, "filterName", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_direct_email_full_added, initial_msp_account_userID, "filterName", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_sub_email_full_a_added, initial_msp_account_userID, "filterName", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
		};
	}
	
	@Test(dataProvider = "create_hypervisorfilter_invalid")
	public void createHypervisorfilterInvalid(String username, String userID, String filterName, String status, String hypervisorProduct, 
			String hypervisorType, String hypervisorName, String isDefault, int statusCode, String expectedErrorCode) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken(spogServer.getJWTToken());
		userSpogServer.createHypervisorFilterForSpecificUserWithCodeCheck(userID, filterName, status, hypervisorProduct, hypervisorType, hypervisorName, isDefault, statusCode,expectedErrorCode, test);
	}
	
	@DataProvider(name = "create_hypervisorfilter_notoken")
	public final Object[][] createHypervisorfilterNoTokenParams() {
		return new Object[][] {
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName", "status", "udp", "hypervisorType", "hypervisorName", "true", 401, "00900006"},
			{initial_msp_email_full_added, initial_msp_user_ID_added, "filterName", "status", "udp", "hypervisorType", "hypervisorName", "true", 401, "00900006"},
			{initial_sub_email_full_a_added, initial_sub_user_ID_a_added, "filterName", "status", "udp", "hypervisorType", "hypervisorName", "true", 401, "00900006"},
		};
	}
	
	@Test(dataProvider = "create_hypervisorfilter_notoken")
	public void createHypervisorfilterNoToken(String username, String userID, String filterName, String status, String hypervisorProduct, 
			String hypervisorType, String hypervisorName, String isDefault, int statusCode, String expectedErrorCode) {
