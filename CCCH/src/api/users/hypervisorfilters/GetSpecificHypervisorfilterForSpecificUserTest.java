...
public class GetSpecificHypervisorfilterForSpecificUserTest {
	...
	public final Object[][] getHypervisorfilterValidParams() {
		return new Object[][] {
			...
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName01", "status", "udp", "xen", "hypervisorName", "false"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName01", "status", "udp", "xen", "hypervisorName", "none"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName01", "status", "udp", "xen", "hypervisorName", null},
			
			// get filter with different hypervisorName
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName02", "status", "udp", "xen", "", "true"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName02", "status", "udp", "xen", "none", "true"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName02", "status", "udp", "xen", null, "true"},
			
			// get filter with different hypervisorType
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName08", "status", "udp", "xen,vmware", "hypervisorName", "true"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName08", "status", "udp", "none", "hypervisorName", "true"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName08", "status", "udp", "emptyarray", "hypervisorName", "true"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName08", "status", "udp", null, "hypervisorName", "true"},
			
			// TODO: create filter with different status
			
			// TODO: create filter with different hypervisor_product
			
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterName03", "status", "udp", "xen", "hypervisorName", "true"},
			{initial_msp_email_full_added, initial_msp_user_ID_added, "filterName03", "status", "udp", "xen", "hypervisorName", "true"},
			{initial_sub_email_full_a_added, initial_sub_user_ID_a_added, "filterName03", "status", "udp", "xen", "hypervisorName", "true"},
			
			// get filter for other users in same org
			{initial_direct_email_full, initial_direct_user_ID_added, "filterName03", "status", "udp", "xen", "hypervisorName", "true"},
			{initial_msp_email_full, initial_msp_user_ID_added, "filterName03", "status", "udp", "xen", "hypervisorName", "true"},
			{initial_sub_email_full_a, initial_sub_user_ID_a_added, "filterName03", "status", "udp", "xen", "hypervisorName", "true"},
			// msp admin get filter in sub org
			{initial_msp_email_full, initial_sub_user_ID_a_added, "filterName03", "status", "udp", "xen", "hypervisorName", "true"},
			
			// msp account admin
			{initial_msp_email_full, initial_msp_account_userID, "filterName03", "status", "udp", "xen", "hypervisorName", "true"},
			{initial_msp_account_email_full, initial_sub_user_ID_a_added, "filterName03", "status", "udp", "xen", "hypervisorName", "true"},
		};
	}
	
	@Test(dataProvider = "get_hypervisorfilter_valid")
	public void getHypervisorfilterValid(String username, String userID, String filterName, String status, String hypervisorProduct, 
		...
		Response response = userSpogServer.getHypervisorFilterForSpecificUser(userID, filterID, test);
	...
	@DataProvider(name = "get_hypervisorfilter_no_permission")
	public final Object[][] getHypervisorfilternNoPermissionParams() {
		return new Object[][] {
			{initial_direct_email_full_added, initial_direct_user_ID_added, initial_msp_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, initial_sub_email_full_a_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_msp_email_full_added, initial_msp_user_ID_added, initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_msp_email_full_added, initial_msp_user_ID_added, initial_sub_email_full_a_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_sub_email_full_a_added, initial_sub_user_ID_a_added, initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			// msp account admin
			{initial_msp_email_full_added, initial_msp_user_ID_added, initial_msp_account_email_full, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_sub_email_full_b_added, initial_sub_user_ID_b_added, initial_msp_account_email_full, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, initial_msp_account_email_full, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_msp_account_email_full, initial_msp_account_userID, initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
			{initial_msp_account_email_full, initial_msp_account_userID, initial_sub_email_full_a_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 403, "00100101"},
		};}
	
	@Test(dataProvider = "get_hypervisorfilter_no_permission")
	public void getHypervisorfilterNoPermission(String username, String userID, String usernameGet, String filterName, String status, String hypervisorProduct, 
		...
		userSpogServer.setToken(spogServer.getJWTToken());
		userSpogServer.getHypervisorFilterForSpecificUserWithCodeCheck(userID, filterID, statusCode, expectedErrorCode, test);
	}
	
	@DataProvider(name = "get_hypervisorfilter_no_token")
	public final Object[][] getHypervisorfilternNoTokenParams() {
		return new Object[][] {
			{initial_direct_email_full_added, initial_direct_user_ID_added, initial_msp_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 401, "00900006"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, initial_sub_email_full_a_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 401, "00900006"},
			{initial_msp_email_full_added, initial_msp_user_ID_added, initial_direct_email_full_added, "filterName01", "status", "udp", "xen", "hypervisorName", "true", 401, "00900006"}
		};}
	
	@Test(dataProvider = "get_hypervisorfilter_no_token")
	public void getHypervisorfilterNoToken(String username, String userID, String usernameGet, String filterName, String status, String hypervisorProduct, 
			String hypervisorType, String hypervisorName, String isDefault, int statusCode, String expectedErrorCode) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken(spogServer.getJWTToken());
		String prefix = RandomStringUtils.randomAlphanumeric(8);
	...
	public final Object[][] getHypervisorfilternNonExistingParams() {
		return new Object[][] {
			{initial_direct_email_full_added, initial_direct_user_ID_added, "filterID", 400, "40000005"},
			{initial_direct_email_full_added, initial_direct_user_ID_added, UUID.randomUUID().toString(), 404, "00A00502"},
			{initial_direct_email_full_added, UUID.randomUUID().toString(), UUID.randomUUID().toString(), 404, "00200007"},
		};}
	
	@Test(dataProvider = "get_hypervisorfilter_non_existing")
	public void getHypervisorfilterNoExisting(String username, String userID, String filterID, int statusCode, String expectedErrorCode) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken(spogServer.getJWTToken());
		userSpogServer.getHypervisorFilterForSpecificUserWithCodeCheck(userID, filterID, statusCode, expectedErrorCode, test);
	}
	...
	public final Object[][] getHypervisorfilternIsDefaultParams() {
		return new Object[][] {
			{initial_direct_email_full_added, initial_direct_user_ID_added},
			{initial_msp_email_full_added, initial_msp_user_ID_added},
			{initial_sub_email_full_a_added, initial_sub_user_ID_a_added},
		};}
	
	@Test(dataProvider = "get_hypervisorfilter_is_default")
	public void getHypervisorfilterIsDefaultTest(String username, String userID) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken(spogServer.getJWTToken());
		
		String filterID1 = userSpogServer.createHypervisorFilterForSpecificUser(userID, "filterName_isDefault01", "status", "udp", "xen", "hypervisorName", "true", test);
		String filterID2 = userSpogServer.createHypervisorFilterForSpecificUser(userID, "filterName_isDefault02", "status", "udp", "xen", "hypervisorName", "true", test);
		Response response = userSpogServer.getHypervisorFilterForSpecificUser(userID, filterID1, test);
		response.then().body("data.is_default", equalTo(false));
		response = userSpogServer.getHypervisorFilterForSpecificUser(userID, filterID2, test);
		response.then().body("data.is_default", equalTo(true));
		
		String filterID3 = userSpogServer.createHypervisorFilterForSpecificUser(userID, "filterName_isDefault03", "status", "udp", "xen", "hypervisorName", "false", test);
		userSpogServer.updateHypervisorFilterForSpecificUser(userID, filterID3, "filterName_isDefault03", "status", "udp", "xen", "hypervisorName", "true", test);
		response = userSpogServer.getHypervisorFilterForSpecificUser(userID, filterID2, test);
		response.then().body("data.is_default", equalTo(false));
		response = userSpogServer.getHypervisorFilterForSpecificUser(userID, filterID3, test);
		response.then().body("data.is_default", equalTo(true));
	}
