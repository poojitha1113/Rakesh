...
public class GetHypervisorfiltersForLoggedinUserTest {
	...
	public final Object[][] getHypervisorfilterValidParams() {
		return new Object[][] {
			...
			{initial_direct_email_full_added, 8},
			{initial_msp_email_full_added, 8},
			{initial_sub_email_full_a_added, 8},
			{initial_msp_account_email_full, 8},
		};
	}
	
	@Test(dataProvider = "get_hypervisorfilters_valid")
	public void getHypervisorfilterValid(String username, int expectedNumber) {
	...
	public void getHypervisorfilterNoToken(String username, String userID, int statusCode, String expectedErrorCode) {
		...
		userSpogServer.getHypervisorFiltersForLoggedinUserWithCodeCheck(statusCode, expectedErrorCode,test);
	}
	...
	public void getHypervisorfiltersPagination(String filterStr, String sortStr, int pageNumber, int pageSize, String[] expectedFilterNames) {
		...
		Response response = userSpogServer.getHypervisorFiltersForLoggedinUser(filterStr, sortStr, pageNumber, pageSize, test);
