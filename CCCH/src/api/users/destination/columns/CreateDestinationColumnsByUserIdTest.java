...
public class CreateDestinationColumnsByUserIdTest extends base.prepare.Is4Org {
   ...
   /* private ExtentReports rep;
	...
	public void beforeClass(String baseURI, String port,String logFolder,String runningMachine,String buildVersion) {
		...
		rep = ExtentManager.getInstance("CreateDestinationColumnsByUserIdTest", logFolder);
	...
	@DataProvider(name="CreateDestinationColumns_201")
	public final Object[][] CreateDestinationColumns_201() {
		
		return new Object[][] {
			// different users
				{ "csrc", ti.csr_token,ti.csr_admin_user_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
				...
				{ "direct-visibleTrue", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true"},new String[]{"2","3","1","4","10","7","5","6","9","8"},4},
				{ "direct-visibleFalse", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
								new String[] {"false"},new String[]{"2","3","1","10","4","7","5","6","9","8"},4},
				
				{ "msp", ti.root_msp_org1_user1_token,ti.root_msp_org1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"3","10","6","2","9","8","1","4","5","7"},7},
...
//				Delete the existing user job columns and create the same columns 
				{ "direct-deleteCreateSame", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
								new String[] { "true", "false","none"},new String[]{"2","10","3","1","4","7","5","6","9","8"},4},
				...
				{ "direct-sameColIdOrderId", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
										new String[] { "true", "false","none"},new String[]{"2","10","2","2","2","3","3","3","2","2"},2},
				...
				{ "direct-sameorderid", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","3","2","2","3","3","2","3","10","8"},4},
		};
	}
	@Test(dataProvider="CreateDestinationColumns_201")
	public void createDestinationColumnsForSpecifiedUserTest_201(String organizationType,
			  												String validToken,
			  												String user_Id,
			  												String[] sort,
			  												String[] filter,
			...
			for(int i=0;i<noofcolstocreate ;i++)
			{
				...
				{
					temp = spogDestinationServer.composedestination_Column(columnIdList.get(0), sort[index1], filter[index2], visible[index3], orderId[i]);
					if(i!=1) {
			...
			test.log(LogStatus.INFO, "Create destination columns for specified user in the org: "+organizationType);
			...
			test.log(LogStatus.INFO, "Compare the destination columns created for specified user in org: "+organizationType);
			if(organizationType.contains("direct-sameColId"))
			{
				spogDestinationServer.CompareDestinationColumnsContent(response, expected_columns1, columnsHeadContent, SpogConstants.SUCCESS_POST, null, test);
			}
			else {
			spogDestinationServer.CompareDestinationColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.SUCCESS_POST, null, test);
			}
			
			test.log(LogStatus.INFO, "delete destination columns for specified user in org: "+organizationType);
...
//			Delete the existing user job columns and create the same columns 
			...
			{
				test.log(LogStatus.INFO, "Create destination columns again for specified user in the org: "+organizationType);
				response= spogDestinationServer.createDestinationColumnsForSpecifiedUser(user_Id, validToken, expected_columns, test);
				
				test.log(LogStatus.INFO, "Compare the destination columns created again for specified user in org: "+organizationType);
				spogDestinationServer.CompareDestinationColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.SUCCESS_POST, null, test);

				test.log(LogStatus.INFO, "delete destination columns created again for specified user in org: "+organizationType);
				spogDestinationServer.deleteDestinationColumnsforSpecifiedUserwithCheck(user_Id, validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);

			}			
	}

	@DataProvider(name="CreateDestinationColumns_400")
	public final Object[][] CreateDestinationColumns_400() {
		...
		return new Object[][] {
			...
			{ "direct-moreOrderIds", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","11","1","10","7","10","5","6","9","8","4","12","3"},10},
	...
	@Test(dataProvider="CreateDestinationColumns_400",enabled=true)
	public void createDestinationColumnsForSpecifiedUserTest_400(String organizationType,
			  												String validToken,
			  												String user_Id,
			  												String[] sort,
			  												String[] filter,
...
//				int index4 = gen_random_index(orderId);
				...
				{
					temp = spogDestinationServer.composedestination_Column("", sort[index1], filter[index2], visible[index3], orderId[i]);
				}
				else {
					temp = spogDestinationServer.composedestination_Column(columnIdList.get(i), sort[index1], filter[index2], visible[index3], orderId[i]);				
				}
			...
			test.log(LogStatus.INFO, "Compare the destination columns created for specified user in org: "+organizationType);
			spogDestinationServer.CompareDestinationColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.REQUIRED_INFO_NOT_EXIST, expectedErrorMessage, test);
			
		}
	
	@DataProvider(name="CreateDestinationColumns_401")
	public final Object[][] CreateDestinationColumns_401() {
		
		return new Object[][] {
			// different users
			{ "direct-invalidT", "invalid",ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
				new String[] { "true", "false","none"},new String[]{"2","3","10","1","4","7","5","6","9","8"},4},
			{ "direct-missingT", "",ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","10","3","1","4","7","5","6","9","8"},4},

			{ "msp-invalidT", "invalid",ti.root_msp_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","10","1","4","7","5","6","9","8"},4},
			{ "msp-missingT", "",ti.root_msp_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","10","3","1","4","7","5","6","9","8"},4},

			{ "suborg-invalidT", "invalid",ti.root_msp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
								new String[] { "true", "false","none"},new String[]{"2","3","10","1","4","7","5","6","9","8"},4},
			{ "suborg-missingT", "",ti.root_msp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
									new String[] { "true", "false","none"},new String[]{"2","10","3","1","4","7","5","6","9","8"},4},
		};
	}
	@Test(dataProvider="CreateDestinationColumns_401",enabled=true)
	public void createDestinationColumnsForSpecifiedUserTest_401(String organizationType,
			  												String validToken,
			  												String user_Id,
			  												String[] sort,
			  												String[] filter,
...
//				int index4 = gen_random_index(orderId);
			...
			test.log(LogStatus.INFO, "Compare the destination columns created for specified user in org: "+organizationType);
			spogDestinationServer.CompareDestinationColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, expectedErrorMessage, test);
							
	}
	
	@DataProvider(name="createDestinationColumns_403")
	public final Object[][] createDestinationColumns_403() {
		...
		return new Object[][] {
			// different users
				...
				{ "msp-directT", ti.root_msp_org1_user1_token,ti.direct_org1_user1_token,ti.root_msp_org1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"3","6","10","2","9","8","1","4","5","7"},7},
				...
				{ "submsp-mspbT", ti.root_msp1_submsp1_user1_token,ti.root_msp_org2_user1_token,ti.root_msp1_submsp1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
														new String[] { "true", "false"},new String[]{"3","10","6","2","9","8","1","4","5","7"},7},
				{ "msp-submspsuborgT", ti.root_msp1_submsp1_user1_token,ti.msp1_submsp1_suborg1_user1_token,ti.root_msp1_submsp1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
																new String[] { "true", "false"},new String[]{"3","10","6","2","9","8","1","4","5","7"},7},
				...
				{ "suborg-directT", ti.root_msp1_suborg1_user1_token,ti.direct_org1_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","2","3","10","4","5","6","7","8","9"},1},			
				{ "suborg-suborgbT", ti.root_msp1_suborg1_user1_token,ti.root_msp1_suborg2_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
						new String[] { "true", "false"},new String[]{"1","2","3","4","10","5","6","7","8","9"},1},
				...
				{ "csr-suborgT", ti.csr_token,ti.root_msp1_suborg1_user1_token,ti.csr_admin_user_id, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","7","5","4","3","10","6","2","8","9"},1},
				
		
		};
	}
	@Test(dataProvider="createDestinationColumns_403",enabled=true)
	public void createDestinationColumnForSpecifiedUserTest_403(String organizationType,
															String validToken,
		...
		Response response= spogDestinationServer.createDestinationColumnsForSpecifiedUser(user_Id,otherUserValidToken,expected_columns,test);
		...
		test.log(LogStatus.INFO, "Get the destination columns for the specified user in the org: "+organizationType);
		spogDestinationServer.CompareDestinationColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.INSUFFICIENT_PERMISSIONS, expected_errormessage, test);

	}
	
	
	@DataProvider(name="CreateDestinationColumns_404")
	public final Object[][] CreateDestinationColumns_404() {
		
		return new Object[][] {
			// different users
				{ "csr-uidNotExist", ti.csr_token,UUID.randomUUID().toString(), new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","10","3","1","4","7","5","6","9","8"},1},
				...
				{ "msp-uidNotExist", ti.root_msp_org1_user1_token,UUID.randomUUID().toString(), new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","10","1","4","7","5","6","9","8"},1},
				...
				{ "suborg-uidNotExist-mspAccAdminT", ti.root_msp_org1_msp_accountadmin1_token,UUID.randomUUID().toString(), new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","3","10","1","4","7","5","6","9","8"},1},
				{ "suborg-colIdNotExist-mspAccAdminT", ti.root_msp_org1_msp_accountadmin1_token,ti.root_msp_org1_msp_accountadmin1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","3","10","1","4","7","5","6","9","8"},1},
								
		};
	}
	@Test(dataProvider="CreateDestinationColumns_404",enabled=true)
	public void createDestinationColumnsForSpecifiedUserTest_404(String organizationType,
			  												String validToken,
			  												String user_Id,
			  												String[] sort,
			  												String[] filter,
...
//				int index4 = gen_random_index(orderId);
				...
				{
					temp = spogDestinationServer.composedestination_Column(columnid, sort[index1], filter[index2], visible[index3], orderId[i]);
				}
				else {
					temp = spogDestinationServer.composedestination_Column(columnIdList.get(i), sort[index1], filter[index2], visible[index3], orderId[i]);	
				}
			...
			if(organizationType.contains("uidNotExist")) {
				test.log(LogStatus.INFO, "Compare the destination columns created for specified user in org: "+organizationType);
				spogDestinationServer.CompareDestinationColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.USER_ID_DOESNOT_EXIST, test);	
			}
			else {
				test.log(LogStatus.INFO, "Compare the destination columns created for specified user in org: "+organizationType);
				spogDestinationServer.CompareDestinationColumnsContent(response, expected_columns, columnsHeadContent, SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.COLUMN_ID_DOESNOT_EXIST, test);
			}
