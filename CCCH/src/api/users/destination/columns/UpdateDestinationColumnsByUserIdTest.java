...
public class UpdateDestinationColumnsByUserIdTest extends base.prepare.Is4Org{
   ...
   /* private ExtentReports rep;
	...
	public void beforeClass(String baseURI, String port,String logFolder,String runningMachine,String buildVersion) {
		...
		rep = ExtentManager.getInstance("UpdateDestinationColumnBySpecifiedUserTest", logFolder);
	...
	@DataProvider(name="updateDestinationColumnsByUserId_201")
	public Object[][] updateDestinationColumnsByUserId_201(){
		
		return new Object[][] {
			{"direct", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
				new String[] { "true", "false","none"},new String[]{"2","3","1","4","10","7","5","6","9","8"},new String[] { "true"},new String[]{"4","7","5","6","9","8"},4,2},
			{"msp", ti.root_msp_org1_user1_token, ti.root_msp_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
				new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","10","5","6","9","8"},new String[] { "false"},new String[]{"1","6","9","8"},4,3},
			{"suborg", ti.root_msp1_suborg1_user1_token, ti.root_msp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","10","5","6","9","8"},new String[] { "true"},new String[]{"7","5","6","9","8"},4,1},
			...
			{"suborg-mspT", ti.root_msp_org1_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","4","10","7","5","6","9","8"},new String[] { "false"},new String[]{"7","5","6","9","8"},4,2},
	...
	@Test(priority=0,dataProvider="updateDestinationColumnsByUserId_201")
	public void updateDestinationColumnsByUserId_201(String organizationType,
													String validToken,
													String user_Id,
													String[] sort,
													String[] filter,
		...
		test.log(LogStatus.INFO, "Create destination columns for specified user in org : "+ organizationType);
		...
		test.log(LogStatus.INFO, "Update destination columns for specified User in org : "+organizationType);
		spogDestinationServer.updateDestinationColumnsByUserId(user_Id, validToken, expected_updated_columns, columnsHeadContent, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
		...
		return new Object[][] {
			// different users
				...
				{ "direct-invalidOrderId_1", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
									new String[] { "true", "false","none"},new String[]{"2","3","10","1","4","7","5","6","9","8"},2},
				...
				{ "direct-moreOrderIds", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
										new String[] { "true", "false","none"},new String[]{"2","10","3","4","7","5","6","9","8","1"},10},
		
		};
	}
	@Test(dataProvider="UpdateDestinationColumns_400")
	public void updateDestinationColumnsByUserId_400(String organizationType,
			  												String validToken,
			  												String user_Id,
			  												String[] sort,
			  												String[] filter,
...
//				int index4 = gen_random_index(orderId);
			...
			test.log(LogStatus.INFO, "Update the destination columns for specified user in org: "+organizationType);
			spogDestinationServer.updateDestinationColumnsByUserId(user_Id, validToken, expected_columns1, columnsHeadContent, SpogConstants.REQUIRED_INFO_NOT_EXIST, expectedErrorMessage, test);
	...
	@DataProvider(name="UpdateDestinationColumnsForSpecifiedUser_401")
	public final Object[][] UpdateDestinationColumnsForSpecifiedUser_401() {
		...
		return new Object[][] {
			// different users
				...
				{ "msp", ti.root_msp_org1_user1_token,"invalid_token",ti.root_msp_org1_user1_id,new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"3","6","2","10","9","8","1","4","5","7"},7},
				...
				{ "suborg", ti.root_msp1_suborg1_user1_token,"invalid_token",ti.root_msp1_suborg1_user1_id,new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"5","2","9","10","4","1","6","7","8","3"},1},
						
		};
	}
	@Test(dataProvider="UpdateDestinationColumnsForSpecifiedUser_401")
	public void updateDestinationColumnsByUserId_401(String organizationType,
															String validToken,
															String invalidToken,
															String user_id,
															String[] sort,
		...
		test.log(LogStatus.INFO, "Update the destination columns for the specified user in the org: "+organizationType);
		spogDestinationServer.updateDestinationColumnsByUserId(user_id, invalidToken, expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT, test);
			
		test.log(LogStatus.INFO, "Update the destination columns for the specified user in the org: "+organizationType);
		spogDestinationServer.updateDestinationColumnsByUserId(user_id, "",	expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED, test);
				
		test.log(LogStatus.INFO, "Delete the destination columns for the Specified user in the org: "+organizationType);
		spogDestinationServer.deleteDestinationColumnsforSpecifiedUserwithCheck(user_id, validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	}
	
	@DataProvider(name="updateDestinationColumns_403")
	public final Object[][] updateDestinationColumns_403() {
		...
		return new Object[][] {
			// different users
				...
				{ "suborg-directT", ti.root_msp1_suborg1_user1_token,ti.direct_org1_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","10","7","8","9"},1},
	...
	@Test(dataProvider="updateDestinationColumns_403")
	public void updateDestinationColumnsByUserId_403(String organizationType,
															String validToken,
		...
		test.log(LogStatus.INFO, "Update the destination columns for the specified user in the org: "+organizationType);
		spogDestinationServer.updateDestinationColumnsByUserId(user_Id, otherUserValidToken, expected_columns, columnsHeadContent, SpogConstants.INSUFFICIENT_PERMISSIONS, expected_errormessage, test);
		
		test.log(LogStatus.INFO, "Delete the destination columns for the specified user of the org: "+organizationType);	
		spogDestinationServer.deleteDestinationColumnsforSpecifiedUserwithCheck(user_Id, validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	}
	//400 and 404
		@DataProvider(name="updateDestinationColumns_404")
		public final Object[][] updateDestinationColumns_404() {
			...
			return new Object[][] {
				// different users
					...
					{ "msp-randomUserId", ti.root_msp_org1_user1_token,ti.root_msp_org1_user1_id,UUID.randomUUID().toString(), new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"3","6","2","9","10","8","1","4","5","7"},7},	
		...
		@Test(dataProvider="updateDestinationColumns_404")
		public void updateDestinationColumnsByUserId_404(String organizationType,
																String validToken,
			...
			test.log(LogStatus.INFO, "Create the destination columns for the specified user in the org: "+organizationType);
			Response response= spogDestinationServer.createDestinationColumnsForSpecifiedUser(valid_user_Id,validToken,expected_columns,test);
			spogServer.checkResponseStatus(response, SpogConstants.SUCCESS_POST);
			//getDestinationColumn for specified user
			
			if(invalid_user_Id=="invalid_user_id")
			{	//400
				test.log(LogStatus.INFO, "Update the destination columns for the specified user in the org: "+organizationType);
				spogDestinationServer.updateDestinationColumnsByUserId(invalid_user_Id, validToken, expected_columns, columnsHeadContent, SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_USERID_IS_NOT_UUID, test);
			}
			
			else
			{	//404
				test.log(LogStatus.INFO, "Update the destination columns for the specified user in the org: "+organizationType);
				spogDestinationServer.updateDestinationColumnsByUserId(invalid_user_Id, validToken, expected_columns, columnsHeadContent, SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.USER_ID_DOESNOT_EXIST, test);
			}
			
			test.log(LogStatus.INFO, "Delete the destination columns for the specified user of the org: "+organizationType);	
			spogDestinationServer.deleteDestinationColumnsforSpecifiedUserwithCheck(valid_user_Id, validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	}
		//403 csr user id
		@DataProvider(name="updateDestinationColumns_403_csrUserId")
		public final Object[][] updateDestinationColumns_403_csrUserId() {
		...
		@Test(dataProvider="updateDestinationColumns_403_csrUserId")
		public void updateDestinationColumnsByUserId_403_csrUserId(String organizationType,
																		String validToken,
																		String user_Id,
																		String[] sort,
																		String[] filter,
			...
			test.log(LogStatus.INFO, "Update the destination columns for the specified user in the org: "+organizationType);
			spogDestinationServer.updateDestinationColumnsByUserId(ti.csr_admin_user_id, validToken, expected_columns, columnsHeadContent, SpogConstants.INSUFFICIENT_PERMISSIONS, expectedMessageCode, test);
