...
public class CreateDestinationColumnsForLoggedInUserTest extends base.prepare.Is4Org{
   ...
   /* private ExtentReports rep;
	...
	public void beforeClass(String baseURI, String port,String logFolder,String runningMachine,String buildVersion) {
		...
		rep = ExtentManager.getInstance("CreateDestinationColumnsForLoggedInUserTest", logFolder);
	...
	public final Object[][] CreateDestinationColumns_201() {
		...
		return new Object[][] {
			// different users
				...
				{ "direct", ti.direct_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true"},new String[]{"2","3","1","10","4","7","5","6","9","8"},4},
				{ "direct", ti.direct_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
								new String[] {"false"},new String[]{"2","3","10","1","4","7","5","6","9","8"},4},
...
//				Delete the existing user job columns and create the same columns 
				...
				{ "direct-sameColIdOrderId", ti.direct_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
									new String[] { "true", "false","none"},new String[]{"2","2","2","2","3","3","3","2","2"},2},
	...
	public void createDestinationColumnsForLoggedinUserTest_201(String organizationType,
			  												String validToken,
			  												String[] sort,
			  												String[] filter,
			  												String[] visible,
...
//				int index4 = gen_random_index(orderId);
			...
			test.log(LogStatus.INFO, "Compare the destination columns created for loggedin user in org: "+organizationType);
			if(organizationType.contains("direct-sameColId"))
			{
...
//			Delete the existing user job columns and create the same columns 
			...
			{
				test.log(LogStatus.INFO, "Create destination columns for loggedin user in the org: "+organizationType);
				response= spogDestinationServer.createDestinationColumnsForLoggedInUser(validToken, expected_columns, test);
	...
	public final Object[][] CreateDestinationColumns_400() {
		...
		return new Object[][] {
			...
			{ "direct-moreOrderIds", ti.direct_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","13","1","10","7","5","6","9","8","4","12","3"},10},
	...
	@Test(dataProvider="CreateDestinationColumns_400")
	public void createDestinationColumnsForLoggedinUserTest_400(String organizationType,
			  												String validToken,
			  												String[] sort,
			  												String[] filter,
			  												String[] visible,
	...
	public final Object[][] CreateDestinationColumns_401() {
		...
		return new Object[][] {
			// different users
				...
				{ "msp-invalidT", "invalid", new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","10","3","1","4","7","5","6","9","8"},4},
				{ "msp-missingT", "", new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
								new String[] { "true", "false","none"},new String[]{"2","3","10","1","4","7","5","6","9","8"},4},

				{ "suborg-invalidT", "invalid", new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
									new String[] { "true", "false","none"},new String[]{"2","10","3","1","4","7","5","6","9","8"},4},
				{ "suborg-missingT", "", new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
										new String[] { "true", "false","none"},new String[]{"2","3","10","1","4","7","5","6","9","8"},4},
		};
	}
	@Test(dataProvider="CreateDestinationColumns_401")
	public void createDestinationColumnsForLoggedinUserTest_401(String organizationType,
			  												String validToken,
			  												String[] sort,
			  												String[] filter,
			  												String[] visible,
...
//				int index4 = gen_random_index(orderId);
	...
	public final Object[][] CreateDestinationColumns_404() {
		...
		return new Object[][] {
				{ "csr-colIdNotExist", ti.csr_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","10","4","7","5","6","9","8"},1},
				{ "csr_readonlyc-colIdNotExist", ti.csr_readonly_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","10","4","7","5","6","9","8"},1},			
	...
	@Test(dataProvider="CreateDestinationColumns_404")
	public void createDestinationColumnsForLoggedinUserTest_404(String organizationType,
			  												String validToken,
			  												String[] sort,
			  												String[] filter,
			  												String[] visible,
