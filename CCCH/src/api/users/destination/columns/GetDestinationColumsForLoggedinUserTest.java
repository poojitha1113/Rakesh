...
public class GetDestinationColumsForLoggedinUserTest extends base.prepare.Is4Org{
   ...
   /* private ExtentReports rep;
	...
	public void beforeClass(String baseURI, String port, String logFolder,String runningMachine,String buildVersion) {
		...
		rep = ExtentManager.getInstance("GetDestinationColumsForLoggedinUserTest", logFolder);
	...
	@DataProvider(name="GetDestinationColumnsForLoggedinUser_200")
	public final Object[][] GetDestinationColumnsForLoggedinUser_200() {
		...
		return new Object[][] {
			// different users
				...
				{ "suborg", ti.root_msp1_suborg1_user1_token,new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","7","10","3","6","5","9","2","8","4"},6},	
				{ "suborg-mspAccAdminT", ti.root_msp1_suborg1_user1_token,new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"1","7","10","3","6","5","9","2","8","4"},7},	
		};
	}
	@Test(dataProvider="GetDestinationColumnsForLoggedinUser_200")
	public void getDestinationColumnsForLoggedinUserTest_200(String organizationType,
															String validToken,
															String[] sort,
															String[] filter,
															String[] visible,
		...
		test.log(LogStatus.INFO, "Get the destination columns for the Loggedin user in the org: "+organizationType);
		spogDestinationServer.getDestinationColumnsForLoggedinUser(validToken, expected_columns, columnsHeadContent, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	...
	@DataProvider(name="GetDestinationColumnsForLoggedinUser_401")
	public final Object[][] GetDestinationColumnsForLoggedinUser_401() {
	...
	@Test(dataProvider="GetDestinationColumnsForLoggedinUser_401")
	public void getDestinationColumnsForLoggedinUserTest_401(String organizationType,
															String validToken,
															String invalidToken,
															String[] sort,
															String[] filter,
		...
		test.log(LogStatus.INFO, "Get the destination columns for the Loggedin user in the org: "+organizationType);
		spogDestinationServer.getDestinationColumnsForLoggedinUser(invalidToken, expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT, test);
	
		test.log(LogStatus.INFO, "Get the destination columns for the Loggedin user in the org: "+organizationType);
		spogDestinationServer.getDestinationColumnsForLoggedinUser("", expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED, test);
