...
public class GetDestinationColumnByUserIdTest extends base.prepare.Is4Org{
	...
	public void beforeClass(String baseURI, String port, String logFolder,String runningMachine,String buildVersion) {
		...
		rep = ExtentManager.getInstance("GetDestinationColumnByUserIdTest", logFolder);
	...
	@DataProvider(name="getDestinationColumns_valid")
	public final Object[][] getDestinationColumns_valid() {
...
//				Get destination columns by user id of sub org using msp token should return  200 and validate the response
				{ "suborg-mspT", ti.root_msp_org1_user1_token,ti.root_msp1_suborg1_user1_id,new String[] { "true", "false"}, new String[] { "true", "false"},
						new String[] { "true", "false"},new String[]{"1","2","3","4","10","5","6","7","8","9"},5},	
	...
	@Test(dataProvider="getDestinationColumns_valid")
	public void getDestinationColumnForSpecifiedUserTest_200(String organizationType,
															String validToken,
															String user_Id,
															String[] sort,
															String[] filter,
		...
		spogDestinationServer.getDestinationColumnsForSpecifiedUser(user_Id, validToken, expected_columns, columnsHeadContent, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
		
		//getDestinationColumns with csr token
		test.log(LogStatus.INFO, "Get the destination columns for the specified user in the org: "+organizationType);
		spogDestinationServer.getDestinationColumnsForSpecifiedUser(user_Id, ti.csr_token, expected_columns, columnsHeadContent, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
		...
		{	//creating with suborg token
			...
			test.log(LogStatus.INFO, "Get the destination columns for the specified user in the org: "+organizationType);
			spogDestinationServer.getDestinationColumnsForSpecifiedUser(user_Id, ti.root_msp_org1_user1_token, expected_columns, columnsHeadContent, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
			...
			test.log(LogStatus.INFO, "Create the destination columns for the specified user in the org: "+organizationType);
			response= spogDestinationServer.createDestinationColumnsForSpecifiedUser(user_Id,ti.root_msp_org1_user1_token,expected_columns,test);
	...
	@DataProvider(name="GetDestinationColumns_401")
	public final Object[][] GetDestinationColumns_401() {
		...
		return new Object[][] {
			// different users
				...
				{ "msp", ti.root_msp_org1_user1_token,"invalid_token",ti.root_msp_org1_user1_id,new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"3","6","2","9","8","10","1","4","5","7"},7},
				...
				{ "suborg", ti.root_msp1_suborg1_user1_token,"invalid_token",ti.root_msp1_suborg1_user1_id,new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"5","2","9","4","1","10","6","7","8","3"},1},
						
		};
	}
	@Test(dataProvider="GetDestinationColumns_401",enabled=true)
	public void getDestinationColumnForSpecifiedUserTest_401(String organizationType,
															String validToken,
															String invalidToken,
															String user_Id,
															String[] sort,
		...
		test.log(LogStatus.INFO, "Get the destination columns for the specified user in the org: "+organizationType);
		spogDestinationServer.getDestinationColumnsForSpecifiedUser(user_Id, invalidToken, expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT, test);
			
		test.log(LogStatus.INFO, "Get the destination columns for the specified user in the org: "+organizationType);
		spogDestinationServer.getDestinationColumnsForSpecifiedUser(user_Id, "", expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED, test);
				
		test.log(LogStatus.INFO, "Delete the destination columns for the logged in user in the org: "+organizationType);
		spogDestinationServer.deleteDestinationColumnsforSpecifiedUserwithCheck(user_Id, validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);		
	}
	
	//403
	@DataProvider(name="getDestinationColumns_403")
	public final Object[][] getDestinationColumns_403() {
		...
		return new Object[][] {
			// different users
				...
				{ "suborg-directT", ti.root_msp1_suborg1_user1_token,ti.direct_org1_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","7","10","8","9"},1},
	...
	@Test(dataProvider="getDestinationColumns_403",enabled=true)
	public void getDestinationColumnForSpecifiedUserTest_403(String organizationType,
															String validToken,
		...
		test.log(LogStatus.INFO, "Get the destination columns for the specified user in the org: "+organizationType);
		spogDestinationServer.getDestinationColumnsForSpecifiedUser(user_Id, otherUserValidToken, expected_columns, columnsHeadContent, SpogConstants.INSUFFICIENT_PERMISSIONS, expected_errormessage, test);
	...
	//400 and 404
	@DataProvider(name="getDestinationColumns_404")
	public final Object[][] getDestinationColumns_404() {
		...
		return new Object[][] {
			// different users
				...
				{ "csr-invalidUserId", ti.csr_token,ti.csr_admin_user_id,"invalid_user_id", new String[] { "true", "false"}, new String[] { "true", "false"},
						new String[] { "true", "false"},new String[]{"1","2","4","6","5","10","3","7","8","9"},1},
				...
				{ "csr-randomUserId", ti.csr_token,ti.csr_admin_user_id,UUID.randomUUID().toString(), new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"1","2","4","6","10","5","3","7","8","9"},1},
	...
	@Test(dataProvider="getDestinationColumns_404",enabled=true)
	public void getDestinationColumnForSpecifiedUserTest_404(String organizationType,
															String validToken,
		...
		{	//400
			test.log(LogStatus.INFO, "Get the destination columns for the specified user in the org: "+organizationType);
			spogDestinationServer.getDestinationColumnsForSpecifiedUser(invalid_user_Id, validToken, expected_columns, columnsHeadContent, SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_USERID_IS_NOT_UUID, test);
		}
		
		else
		{	//404
			test.log(LogStatus.INFO, "Get the destination columns for the specified user in the org: "+organizationType);
			spogDestinationServer.getDestinationColumnsForSpecifiedUser(invalid_user_Id, validToken, expected_columns, columnsHeadContent, SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.USER_ID_DOESNOT_EXIST, test);
		}
	...
	//403 csr user id
		@DataProvider(name="getDestinationColumns_403_csrUserId")
		public final Object[][] getDestinationColumns_403_csrUserId() {
			...
			return new Object[][] {
				// different users
					{ "direct-csrUserId", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","10","5","6","9","8"},4},
		...
		@Test(dataProvider="getDestinationColumns_403_csrUserId",enabled=true)
		public void getDestinationColumnForSpecifiedUserTest_403_csrUserId(String organizationType,
																String validToken,
																String user_Id,
																String[] sort,
																String[] filter,
			...
			test.log(LogStatus.INFO, "Get the destination columns for the specified user in the org: "+organizationType);
			spogDestinationServer.getDestinationColumnsForSpecifiedUser(ti.csr_admin_user_id, validToken, expected_columns, columnsHeadContent, SpogConstants.INSUFFICIENT_PERMISSIONS, expectedMessageCode, test);	
