...
public class CreateUserFilterForLoggedInUserTest extends base.prepare.Is4Org {
	...
	@DataProvider(name = "Create_User_Filters")
	...
	@Test(dataProvider = "Create_User_Filters")
	public void CreateUserFilterForLoggedInUserValid_200(String organizationType,
	...
	public void CreateUserFilters_401(String organizationType,
			String organization_id,
			String validToken,
			String user_id,
			String filter_name,
			...
			int count) 
	{
		...
		test.log(LogStatus.INFO, "Validate the response");
		filter_Id = userSpogServer.verifyUserFilters(response, filter_name, search_string, user_is_blocked, user_status, role_id, is_default, count, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED, test);



		userSpogServer.setToken("123");
		test.log(LogStatus.INFO, "Create user filter in org of type "+organizationType);
		...
		test.log(LogStatus.INFO, "Validate the response");
		filter_Id = userSpogServer.verifyUserFilters(response, filter_name, search_string, user_is_blocked, user_status, role_id, is_default, count, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT,test);
