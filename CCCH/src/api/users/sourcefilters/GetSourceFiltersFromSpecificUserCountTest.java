...
public class GetSourceFiltersFromSpecificUserCountTest {
...
//	    }
	...
	public final Object[][] getbasicfilterInfo() {
		return new Object[][] {
			{"filter_name01", initial_direct_email_full, initial_direct_orgID, "protect", "none", "online", "none", "none", "windows", "SQL", siteID, "source_Name","machine", "true", 2},
			{"filter_name02", initial_direct_email_full, initial_direct_orgID, "unprotect", "none", "online", "none", "none", "windows", "SQL", siteID, "source_Name","machine", "true", 1},
			{"filter_name03", initial_direct_email_full, initial_direct_orgID, "protect", "none", "offline", "none", "none", "windows", "SQL", siteID, "source_Name","machine", "true", 1},
			{"filter_name04", initial_direct_email_full, initial_direct_orgID, "protect", "none", "offline", "none", "none", "windows", "SQL", siteID, "source_Name","machine", "true", 1},
			{"filter_name05", initial_direct_email_full, initial_direct_orgID, "none", "none", "online", "none", "none", "windows", "SQL", siteID, "source_Name","machine", "true", 3},
			{"filter_name06", initial_direct_email_full, initial_direct_orgID, "none", "none", "none", "none", "none", "windows", "SQL", siteID, "source_Name","machine", "true", 4},
			{"filter_name07", initial_direct_email_full, initial_direct_orgID, "none", "none", "none", "none", "none", "linux", "SQL", siteID, "source_Name","machine", "true", 1},
			{"filter_name08", initial_direct_email_full, initial_direct_orgID, "none", "none", "none", "none", "none", "unknown", "SQL", siteID, "source_Name","office_365", "true", 1},
			{"filter_name09", initial_direct_email_full, initial_direct_orgID, "none", "none", "none", "none", "none", "none", "SQL", siteID, "source_Name","none", "true", 11},
	...
	@Test(dataProvider = "basicfilterInfo", priority=0)
	public void createFilters(String filter_name, String userName, String organization_id, String protection_status, String protection_policy, 
	...
	@Test
	public void getSourceFiltersTest() {
		int[] counts = {2, 1, 1, 1, 3, 4, 1, 1, 11, 11, 3, 0};
		...
		for (Integer i = 0; i < 12; i++) {
			...
			Integer expected_count = counts[i];
			if (expected_count == response_filters.get(i).get("count")){
				assertTrue("compare count passed", true);
			} else {
				assertTrue("compare count failed", false);
			}
		}
	}
