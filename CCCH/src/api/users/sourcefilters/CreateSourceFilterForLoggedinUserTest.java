...
public class CreateSourceFilterForLoggedinUserTest extends base.prepare.Is4Org{
...
//	private ExtentReports rep;
	...
	public void beforeClass(String baseURI, String port, String csrAdminUserName, String csrAdminPassword,
		...
		source4spogServer.createSourcefilterForLoggedinUserWithCheck("initial_filtername", "protect", "online", null, "active", null, "windows", siteID1, "source_Name", "machine", "true", test);
	}

	@DataProvider(name = "filter_info_valid_params")
	public final Object[][] createSourcefilterInfoValid() {
		return new Object[][] {
			...
			{"filter_name03_b", itd.getRoot_msp_org_1_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "source_Name","machine", "true"},
			{"filter_name03_c", itd.getRoot_msp_org_1_sub_msp_1_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "source_Name","machine", "true"},
			...
			{"filter_name03_e", itd.getRoot_msp_org_1_sub_msp_1_account_admin_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "source_Name","machine", "true"},
			{"filter_name03_f", itd.getRoot_msp_org_1_sub_msp_1_account_1_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "source_Name","machine", "true"},
			
			// monitor user related
			{"filter_name01_a", itd.getRoot_msp_org_1_monitor_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "source_Name","machine", "true"},
			{"filter_name01_b", itd.getRoot_msp_org_1_account_1_monitor_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "source_Name","machine", "true"},
			{"filter_name01_c", itd.getRoot_msp_org_1_sub_msp_1_monitor_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "source_Name","machine", "true"},
			{"filter_name01_d", itd.getMsp_org_1_monitor_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "source_Name","machine", "true"},
			{"filter_name01_e", itd.getDirect_org_1_monitor_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "source_Name","machine", "true"},
			
			// create source filter with different protection status
...
//			{"filter_name29", itd.getDirect_org_1_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "none", null, ""},
//			{"filter_name30", itd.getDirect_org_1_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "none", null, "none"},
			// create source filter with different policyID and groupID
			{"filter_name31", itd.getDirect_org_1_user_1_email(), "protect", UUID.randomUUID().toString() + ","  + UUID.randomUUID().toString(), "online", "none", UUID.randomUUID().toString() + ","  + UUID.randomUUID().toString(), "windows", siteID1, "none", null, "true"},
			{"filter_name32", itd.getDirect_org_1_user_1_email(), "protect", "emptyarray", "online", "none", "emptyarray", "windows", siteID1, "none", null, "true"},
			{"filter_name33", itd.getDirect_org_1_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "none", null, "true"},
			{"filter_name34", itd.getDirect_org_1_user_1_email(), "protect", null, "online", "none", null, "windows", siteID1, "none", null, "true"},
		};
	}
	
	@Test(dataProvider = "filter_info_valid_params")
	public void createSourceFilterValidTest(String filter_name, String userName, String protection_status, String protection_policy, 
		...
		source4spogServer.createSourcefilterForLoggedinUserWithCheck(filter_name, protection_status, 
	...
	public final Object[][] createSourcefilterInfoInvalid() {
		return new Object[][] {
			// create source filter and specify a name already existed;
			...
			// invalid filter name
			{"", itd.getDirect_org_1_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "source_Name","machine", "true", 400, "40000001"},
//			{null, itd.getDirect_org_1_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "source_Name","machine", "true", 400, "40000001"},
//			{"none", itd.getDirect_org_1_user_1_email(), "protect", "none", "online", "none", "none", "windows", siteID1, "source_Name","machine", "true", 400, "40000001"},
...
//			{"filterName", itd.getDirect_org_1_user_1_email(), "protect", "none", "none", "none", "none", "windows", siteID1, "source_Name", "machine", "isDefault", 400, "00100001"},
	...
	public void createSourceFilterInvalidTest(String filter_name, String userName, String protection_status, String protection_policy, 
			String connection_status, String backup_status, String source_group, String operating_system, String site_id, String source_name, String source_type, String is_default, 
			int statusCode, String errorCode) {
		spogServer.userLogin(userName, password);
		source4spogServer.setToken(spogServer.getJWTToken());

		source4spogServer.createSourcefilterForLoggedinUserWithCodeCheck(filter_name, protection_status, 
	...
	public final Object[][] createSourcefilterInfoNoToken() {
		return new Object[][] {
	...
	public void createSourceFilterNoTokenTest(String filter_name, String userName, String protection_status, String protection_policy, 
			String connection_status, String backup_status, String source_group, String operating_system, String site_id, String source_name, String source_type, String is_default, 
			int statusCode, String errorCode) {
		spogServer.userLogin(userName, password);
		source4spogServer.setToken(spogServer.getJWTToken());
	...
	public void csrReadonlyTest() {
		...
		String sourceFilterID_1 = source4spogServer.createSourcefilterForLoggedinUserWithCheck("filterName" + RandomStringUtils.randomAlphanumeric(8), "protect", "online", uuid1, "finished", 
