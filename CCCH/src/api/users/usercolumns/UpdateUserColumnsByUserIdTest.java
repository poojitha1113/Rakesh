...
public class UpdateUserColumnsByUserIdTest extends base.prepare.Is4Org {
	...
	public void beforeClass(String baseURI, String port, String logFolder,String runningMachine,String buildVersion) {
		...
		rep = ExtentManager.getInstance("UpdateUserColumnsByUserIdTest", logFolder);
	...
	@DataProvider(name="updateUserColumnsByUserId_201")
	public Object[][] updateUserColumnsByUserId_201(){
		...
		return new Object[][] {
			...
			{"submsp", ti.root_msp1_submsp1_user1_token, ti.root_msp1_submsp1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},new String[] { "false"},new String[]{"1","6","3"},4,3},
			{"submspsuborg", ti.msp1_submsp1_suborg1_user1_token,ti.msp1_submsp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},new String[] { "true"},new String[]{"7","5","6"},4,1},
			...
			{"suborg-mspT", ti.root_msp_org1_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},new String[] { "false"},new String[]{"7","5","6"},4,2},
			{"suborg-mspAccAdminT", ti.root_msp_org1_msp_accountadmin1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},new String[] { "false"},new String[]{"7","5","6"},4,2},
			{"suborg-submspT", ti.root_msp1_submsp1_user1_token,ti.msp1_submsp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},new String[] { "false"},new String[]{"7","5","6"},4,2},
			{"suborg-submspAccAdminT", ti.root_msp1_submsp1_account_admin_token,ti.msp1_submsp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
								new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},new String[] { "false"},new String[]{"7","5","6"},4,2},
				
		};
	}

	@Test(dataProvider="updateUserColumnsByUserId_201",enabled=true)
	public void updateUserColumnsByUserId_201(String organizationType,
													String validToken,
													String user_Id,
													String[] sort,
													String[] filter,
		...
		test.log(LogStatus.INFO, "Create user columns for specified user in org : "+ organizationType);
		...
		test.log(LogStatus.INFO, "Update user columns for specified User in org : "+organizationType);
		userSpogServer.updateUserColumnsByUserId(validToken, user_Id, expected_updated_columns, columnsHeadContent, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
		
		test.log(LogStatus.INFO, "Delete user columns for specified user in org : " + organizationType);
	...
	public final Object[][] UpdateUserColumns_400() {
		...
		return new Object[][] {
			...
			{ "submsp-noColId", ti.root_msp1_submsp1_user1_token,ti.root_msp1_submsp1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
												new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},4},
			{ "submsp-invalidOrderId_0", ti.root_msp1_submsp1_user1_token,ti.root_msp1_submsp1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
													new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},2},
			{ "submsp-invalidOrderId_1", ti.root_msp1_submsp1_user1_token,ti.root_msp1_submsp1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
														new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},2},
			...
			{ "submspsuborg-noColId", ti.msp1_submsp1_suborg1_user1_token,ti.msp1_submsp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
																new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},4},
			{ "submspsuborg-invalidOrderId_0", ti.msp1_submsp1_suborg1_user1_token,ti.msp1_submsp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
																	new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},2},
			{ "submspsuborg-invalidOrderId_1", ti.msp1_submsp1_suborg1_user1_token,ti.msp1_submsp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
																		new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},2},
			{ "submspsuborg-moreOrderIds", ti.msp1_submsp1_suborg1_user1_token,ti.msp1_submsp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
																			new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},7},
	...
	public void updateUserColumnsByUserIdTest_400(String organizationType,
			  												String validToken,
			  												String user_Id,
			  												String[] sort,
			  												String[] filter,
...
//				int index4 = gen_random_index(orderId);
			...
			test.log(LogStatus.INFO, "Update the user columns created for specified user in org: "+organizationType);
			userSpogServer.updateUserColumnsByUserId(validToken, user_Id, expected_columns1, columnsHeadContent, SpogConstants.REQUIRED_INFO_NOT_EXIST, expectedErrorMessage, test);
	...
	@DataProvider(name="UpdateUserColumnsForSpecifiedUser_401")
	public final Object[][] UpdateUserColumnsForSpecifiedUser_401() {
	...
	@Test(dataProvider="UpdateUserColumnsForSpecifiedUser_401",enabled=true)
	public void updateUserColumnsForSpecifiedUserTest_401(String organizationType,
															String validToken,
															String invalidToken,
															String user_id,
															String[] sort,
		...
		test.log(LogStatus.INFO, "Update the user columns for the specified user in the org: "+organizationType);
		userSpogServer.updateUserColumnsByUserId(invalidToken, user_id, expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT, test);
			
		test.log(LogStatus.INFO, "Update the user columns for the specified user in the org: "+organizationType);
		userSpogServer.updateUserColumnsByUserId("", user_id, expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED, test);
				
		test.log(LogStatus.INFO, "Delete the user columns for the Specified user in the org: "+organizationType);
		userSpogServer.deleteUserColumnsforSpecifiedUserwithCheck(user_id, validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	}
	
	@DataProvider(name="updateUserColumns_403")
	public final Object[][] updateUserColumns_403() {
		...
		return new Object[][] {
			// different users
				...
				{ "direct-suborgT", ti.direct_org1_user1_token,ti.root_msp1_suborg1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},4},
				{ "direct-submspT", ti.direct_org1_user1_token,ti.root_msp1_submsp1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","5","6"},4},
				...
				{ "submsp-mspbT", ti.root_msp1_submsp1_user1_token,ti.root_msp_org2_user1_token,ti.root_msp1_submsp1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
												new String[] { "true", "false"},new String[]{"3","6","2","1","4","5","7"},7},
				{ "submsp-submspbT", ti.root_msp1_submsp1_user1_token,ti.msp1_submsp2_suborg1_user1_token,ti.root_msp1_submsp1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
													new String[] { "true", "false"},new String[]{"3","6","2","1","4","5","7"},7},
				...
				{ "suborgb-mspAccAdminT", ti.root_msp1_suborg2_user1_token,ti.root_msp_org1_msp_accountadmin1_token,ti.root_msp1_suborg2_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","7"},1},
				{ "suborgb-submspsuborgT", ti.root_msp1_suborg2_user1_token,ti.msp1_submsp1_suborg1_user1_token,ti.root_msp1_suborg2_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
								new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","7"},1},
				...
				{ "submspsuborg-directT", ti.msp1_submsp1_suborg1_user1_token,ti.direct_org1_user1_token,ti.msp1_submsp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
								new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","7"},1},
				{ "submspsuborg-suborgbT", ti.msp1_submsp1_suborg1_user1_token,ti.root_msp1_suborg2_user1_token,ti.msp1_submsp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
									new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","7"},1},
				{ "submspsuborgb-mspAccAdminT", ti.msp1_submsp1_suborg2_user1_token,ti.root_msp_org1_msp_accountadmin1_token,ti.msp1_submsp1_suborg2_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
										new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","7"},1},
		
		};
	}
	@Test(dataProvider="updateUserColumns_403",enabled=true)
	public void updateUserColumnForSpecifiedUserTest_403(String organizationType,
															String validToken,
		...
		test.log(LogStatus.INFO, "Update the user columns for the specified user in the org: "+organizationType);
		userSpogServer.updateUserColumnsByUserId(otherUserValidToken, user_Id, expected_columns, columnsHeadContent, SpogConstants.INSUFFICIENT_PERMISSIONS, expected_errormessage, test);
		
		test.log(LogStatus.INFO, "Delete the user columns for the specified user of the org: "+organizationType);	
		userSpogServer.deleteUserColumnsforSpecifiedUserwithCheck(user_Id, validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	}
	
	//400 and 404
			@DataProvider(name="updateUserColumns_404")
			public final Object[][] updateUserColumns_404() {
				...
				return new Object[][] {
					// different users
						...
						{ "msp-invalidUserId", ti.root_msp_org1_user1_token,ti.root_msp_org1_user1_id,"invalid_user_id", new String[] { "true", "false"}, new String[] { "true", "false"},
									new String[] { "true", "false"},new String[]{"3","6","2","1","4","5","7"},7},
						{ "submsp-invalidUserId", ti.root_msp1_submsp1_user1_token,ti.root_msp1_submsp1_user1_id,"invalid_user_id", new String[] { "true", "false"}, new String[] { "true", "false"},
										new String[] { "true", "false"},new String[]{"3","6","2","1","4","5","7"},7},
						{ "suborg-invalidUserId", ti.root_msp1_suborg1_user1_token,ti.root_msp1_suborg1_user1_id,"invalid_user_id", new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","7"},1},
						{ "submspsuborg-invalidUserId", ti.msp1_submsp1_suborg1_user1_token,ti.msp1_submsp1_suborg1_user1_id,"invalid_user_id", new String[] { "true", "false"}, new String[] { "true", "false"},
								new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","7"},1},
						{ "csr-invalidUserId", ti.csr_token,ti.csr_admin_user_id,"invalid_user_id", new String[] { "true", "false"}, new String[] { "true", "false"},
								new String[] { "true", "false"},new String[]{"1","2","4","6","5","3","7"},1},
						...
						{ "msp-randomUserId", ti.root_msp_org1_user1_token,ti.root_msp_org1_user1_id,UUID.randomUUID().toString(), new String[] { "true", "false"}, new String[] { "true", "false"},
								new String[] { "true", "false"},new String[]{"3","6","2","1","4","5","7"},7},	
						{ "submsp-randomUserId", ti.root_msp1_submsp1_user1_token,ti.root_msp1_submsp1_user1_id,UUID.randomUUID().toString(), new String[] { "true", "false"}, new String[] { "true", "false"},
									new String[] { "true", "false"},new String[]{"3","6","2","1","4","5","7"},7},	
						{ "suborg-randomUserId", ti.root_msp1_suborg1_user1_token,ti.root_msp1_suborg1_user1_id,UUID.randomUUID().toString(), new String[] { "true", "false"}, new String[] { "true", "false"},
								new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","7"},1},
						{ "submspsuborg-randomUserId", ti.msp1_submsp1_suborg1_user1_token,ti.msp1_submsp1_suborg1_user1_id,UUID.randomUUID().toString(), new String[] { "true", "false"}, new String[] { "true", "false"},
									new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","7"},1},
						{ "suborg-randomUserId-mspAccAdminT", ti.root_msp_org1_msp_accountadmin1_token,ti.root_msp_org1_msp_accountadmin1_id,UUID.randomUUID().toString(), new String[] { "true", "false"}, new String[] { "true", "false"},
									new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","7"},1},
						{ "submspsuborg-randomUserId-mspAccAdminT", ti.root_msp1_submsp1_account_admin_token,ti.root_msp1_submsp1_account_admin_1_id,UUID.randomUUID().toString(), new String[] { "true", "false"}, new String[] { "true", "false"},
										new String[] { "true", "false"},new String[]{"1","2","3","4","5","6","7"},1},
			...
			@Test(dataProvider="updateUserColumns_404",enabled=true)
			public void updateUserColumnForSpecifiedUserTest_404(String organizationType,
																	String validToken,
				...
				// delete if there are any previous columns exist.
				test.log(LogStatus.INFO, "Delete the user columns for the specified user of the org: "+organizationType);	
				userSpogServer.deleteUserColumnsforSpecifiedUserwithCheck(valid_user_Id, validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
				
				test.log(LogStatus.INFO, "Create the user columns for the specified user in the org: "+organizationType);
				Response response= userSpogServer.createUserColumnsByUserId(validToken, valid_user_Id, expected_columns, test);
				spogServer.checkResponseStatus(response, SpogConstants.SUCCESS_POST);
				//getUserColumn for specified user
				
				if(invalid_user_Id=="invalid_user_id")
				{	//400
					test.log(LogStatus.INFO, "Update the user columns for the specified user in the org: "+organizationType);
					userSpogServer.updateUserColumnsByUserId(validToken, invalid_user_Id, expected_columns, columnsHeadContent, SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_USERID_IS_NOT_UUID, test);
				}
				
				else
				{	//404
					test.log(LogStatus.INFO, "Update the user columns for the specified user in the org: "+organizationType);
					userSpogServer.updateUserColumnsByUserId(validToken, invalid_user_Id, expected_columns, columnsHeadContent, SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.USER_ID_DOESNOT_EXIST, test);
				}
			...
			//403 csr user id
			@DataProvider(name="getUserColumns_403_csrUserId")
			public final Object[][] getUserColumns_403_csrUserId() {
				...
				// different users
					...
					{ "msp-csrUserId", ti.root_msp_org1_user1_token,ti.root_msp_org1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"3","6","2","1","4","5","7"},7},
					{ "submspmsp-csrUserId", ti.root_msp1_submsp1_user1_token,ti.root_msp1_submsp1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
								new String[] { "true", "false"},new String[]{"3","6","2","1","4","5","7"},7},
			...
			@Test(dataProvider="getUserColumns_403_csrUserId",enabled=true)
			public void getUserColumnForSpecifiedUserTest_403_csrUserId(String organizationType,
																			String validToken,
																			String user_Id,
																			String[] sort,
																			String[] filter,
				...
				test.log(LogStatus.INFO, "Update the user columns for the specified user in the org: "+organizationType);
				userSpogServer.updateUserColumnsByUserId(validToken, ti.csr_admin_user_id, expected_columns, columnsHeadContent, SpogConstants.INSUFFICIENT_PERMISSIONS, expectedMessageCode, test);
