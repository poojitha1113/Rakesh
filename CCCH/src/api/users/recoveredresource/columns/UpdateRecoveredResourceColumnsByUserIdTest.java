...
public class UpdateRecoveredResourceColumnsByUserIdTest extends base.prepare.Is4Org{
   ...
   /* private ExtentReports rep;
	...
	@DataProvider(name="updateRecoveredResourceColumnsByUserId_201")
	public Object[][] updateRecoveredResourceColumnsByUserId_201(){
		
		return new Object[][] {
			{"csr", ti.csr_token,ti.csr_admin_user_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
				new String[] { "true", "false","none"},new String[]{"2","3","1","4","10","11","7","5","6","9","8"},new String[] { "true"},new String[]{"4","7","5","6","9","8"},4,2},
			...
			{"msp", ti.root_msp_org1_user1_token, ti.root_msp_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
				new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","10","11","5","6","9","8"},new String[] { "false"},new String[]{"1","6","9","8"},4,3},
			{"suborg", ti.root_msp1_suborg1_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","4","7","10","11","5","6","9","8"},new String[] { "true"},new String[]{"7","5","6","9","8"},4,1},
			...
			{"suborg-mspT", ti.root_msp_org1_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","4","10","11","7","5","6","9","8"},new String[] { "false"},new String[]{"7","5","6","9","8"},4,2},
	...
	@Test(dataProvider="updateRecoveredResourceColumnsByUserId_201")
	public void updateRecoveredResourceColumnsByUserId_201(String organizationType,
													String validToken,
													String user_Id,
													String[] sort,
													String[] filter,
		...
		test.log(LogStatus.INFO, "Create RecoveredResource columns for specified user in org : "+ organizationType);
		...
		for(int i=0;i<noofcolumnstobeupdated ;i++)
		{
			...
			temp1 = spogRecoveredResourceServer.composeRecoveredResource_Column(columnIdList.get(i),null,null,visible[index3],updatedOrderId[i]);
			expected_updated_columns.add(temp1);
		}
		
		test.log(LogStatus.INFO, "Update RecoveredResource columns for specified User in org : "+organizationType);
		spogRecoveredResourceServer.updateRecoveredResourceColumnsByUserId(user_Id, validToken, expected_updated_columns, columnsHeadContent, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	...
	@DataProvider(name="UpdateRecoveredResourceColumns_400")
	public final Object[][] UpdateRecoveredResourceColumns_400() {
		...
		return new Object[][] {
			...
			{ "direct-invalidOrderId_1", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","10","11","1","4","7","5","6","9","8"},2},
			{ "direct-moreOrderIds", ti.direct_org1_user1_token,ti.direct_org1_user1_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","10","11","3","1","4","7","5","6","9","8"},11},
	...
	@Test(dataProvider="UpdateRecoveredResourceColumns_400")
	public void updateRecoveredResourceColumnsByUserIdTest_400(String organizationType,
			  												String validToken,
			  												String user_Id,
			  												String[] sort,
			  												String[] filter,
			...
			String[] moreOrderIds = new String[]{"2","13","1","10","7","5","6","9","8","4","11","3"};
...
//				int index4 = gen_random_index(orderId);
				...
				{
					temp1 = spogRecoveredResourceServer.composeRecoveredResource_Column("", sort[index1], filter[index2], visible[index3], orderId[i]);
				}
				else if(organizationType.contains("-invalidOrderId_0")) {
					temp1 = spogRecoveredResourceServer.composeRecoveredResource_Column(columnIdList.get(i), sort[index1], filter[index2], visible[index3], updateOrderId_0[i]);
				}
				else if(organizationType.contains("-invalidOrderId_1")) {
					temp1 = spogRecoveredResourceServer.composeRecoveredResource_Column(columnIdList.get(i), sort[index1], filter[index2], visible[index3], updateOrderId_1[i]);
				}
				else if(organizationType.contains("-moreOrderIds"))
				{
					temp1 = spogRecoveredResourceServer.composeRecoveredResource_Column(columnIdList.get(i), sort[index1], filter[index2], visible[index3], moreOrderIds[i]);
				}
				else {
					temp1 = spogRecoveredResourceServer.composeRecoveredResource_Column(columnIdList.get(i), sort[index1], filter[index2], visible[index3], orderId[i]);
				}
			...
			test.log(LogStatus.INFO, "Update the RecoveredResource columns for specified user in org: "+organizationType);
			spogRecoveredResourceServer.updateRecoveredResourceColumnsByUserId(user_Id, validToken, expected_columns1, columnsHeadContent, SpogConstants.REQUIRED_INFO_NOT_EXIST, expectedErrorMessage, test);
	...
	@DataProvider(name="UpdateRecoveredResourceColumnsForSpecifiedUser_401")
	public final Object[][] UpdateRecoveredResourceColumnsForSpecifiedUser_401() {
		...
		return new Object[][] {
			// different users
				...
				{ "suborg", ti.root_msp1_suborg1_user1_token,"invalid_token",ti.root_msp1_suborg1_user1_id,new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"5","2","9","10","11","4","1","6","7","8","3"},1},
						
		};
	}
	@Test(dataProvider="UpdateRecoveredResourceColumnsForSpecifiedUser_401")
	public void updateRecoveredResourceColumnsForSpecifiedUserTest_401(String organizationType,
															String validToken,
															String invalidToken,
															String user_id,
															String[] sort,
		...
		test.log(LogStatus.INFO, "Update the RecoveredResource columns for the specified user in the org: "+organizationType);
		spogRecoveredResourceServer.updateRecoveredResourceColumnsByUserId(user_id, invalidToken, expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT, test);
			
		test.log(LogStatus.INFO, "Update the RecoveredResource columns for the specified user in the org: "+organizationType);
		spogRecoveredResourceServer.updateRecoveredResourceColumnsByUserId(user_id, "",	expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED, test);
				
		test.log(LogStatus.INFO, "Delete the RecoveredResource columns for the Specified user in the org: "+organizationType);
		spogRecoveredResourceServer.deleteRecoveredResourceColumnsforSpecifiedUserwithCheck(user_id, validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	}
	
	@DataProvider(name="updateRecoveredResourceColumns_403")
	public final Object[][] updateRecoveredResourceColumns_403() {
	...
	@Test(dataProvider="updateRecoveredResourceColumns_403")
	public void updateRecoveredResourceColumnForSpecifiedUserTest_403(String organizationType,
															String validToken,
		...
		test.log(LogStatus.INFO, "Update the RecoveredResource columns for the specified user in the org: "+organizationType);
		spogRecoveredResourceServer.updateRecoveredResourceColumnsByUserId(user_Id, otherUserValidToken, expected_columns, columnsHeadContent, SpogConstants.INSUFFICIENT_PERMISSIONS, expected_errormessage, test);
		
		test.log(LogStatus.INFO, "Delete the RecoveredResource columns for the specified user of the org: "+organizationType);	
		spogRecoveredResourceServer.deleteRecoveredResourceColumnsforSpecifiedUserwithCheck(user_Id, validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	}
	//400 and 404
		@DataProvider(name="updateRecoveredResourceColumns_404")
		public final Object[][] updateRecoveredResourceColumns_404() {
			...
			return new Object[][] {
				// different users
					...
					{ "csr-invalidUserId", ti.csr_token,ti.csr_admin_user_id,"invalid_user_id", new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"1","2","4","10","11","6","5","3","7","8","9"},1},
		...
		@Test(dataProvider="updateRecoveredResourceColumns_404")
		public void updateRecoveredResourceColumnForSpecifiedUserTest_404(String organizationType,
																String validToken,
			...
			{	//400
				test.log(LogStatus.INFO, "Update the RecoveredResource columns for the specified user in the org: "+organizationType);
				spogRecoveredResourceServer.updateRecoveredResourceColumnsByUserId(invalid_user_Id, validToken, expected_columns, columnsHeadContent, SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_USERID_IS_NOT_UUID, test);
			}
			
			else
			{	//404
				test.log(LogStatus.INFO, "Update the RecoveredResource columns for the specified user in the org: "+organizationType);
				spogRecoveredResourceServer.updateRecoveredResourceColumnsByUserId(invalid_user_Id, validToken, expected_columns, columnsHeadContent, SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.USER_ID_DOESNOT_EXIST, test);
			}
		...
		@Test(dataProvider="getRecoveredResourceColumns_403_csrUserId")
		public void getRecoveredResourceColumnForSpecifiedUserTest_403_csrUserId(String organizationType,
			...
			test.log(LogStatus.INFO, "Update the RecoveredResource columns for the specified user in the org: "+organizationType);
			spogRecoveredResourceServer.updateRecoveredResourceColumnsByUserId(ti.csr_admin_user_id, validToken, expected_columns, columnsHeadContent, SpogConstants.INSUFFICIENT_PERMISSIONS, expectedMessageCode, test);
