...
public class GetRecoveredResourceColumnsForLoggedInUserTest extends base.prepare.Is4Org{
   ...
   /* private ExtentReports rep;
	...
	@DataProvider(name="GetRecoveredResourceColumnsForLoggedinUser_200")
	public final Object[][] GetRecoveredResourceColumnsForLoggedinUser_200() {
		...
		return new Object[][] {
			// different users
				...
				{ "suborg", ti.root_msp1_suborg1_user1_token,new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","7","10","11","3","6","5","9","2","8","4"},1},	
				{ "suborg-mspAccAdminT", ti.root_msp1_suborg1_user1_token,new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"1","7","10","11","3","6","5","9","2","8","4"},1},	
		};
	}
	@Test(dataProvider="GetRecoveredResourceColumnsForLoggedinUser_200")
	public void getRecoveredResourceColumnsForLoggedinUserTest_200(String organizationType,
															String validToken,
															String[] sort,
															String[] filter,
															String[] visible,
		...
		test.log(LogStatus.INFO, "Get the RecoveredResource columns for the Loggedin user in the org: "+organizationType);
		spogRecoveredResourceServer.getRecoveredResourceColumnsForLoggedinUser(validToken, expected_columns, columnsHeadContent, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	...
	@DataProvider(name="GetRecoveredResourceColumnsForLoggedinUser_401")
	public final Object[][] GetRecoveredResourceColumnsForLoggedinUser_401() {
	...
	@Test(dataProvider="GetRecoveredResourceColumnsForLoggedinUser_401")
	public void getRecoveredResourceColumnsForLoggedinUserTest_401(String organizationType,
															String validToken,
															String invalidToken,
															String[] sort,
															String[] filter,
		...
		test.log(LogStatus.INFO, "Get the RecoveredResource columns for the Loggedin user in the org: "+organizationType);
		spogRecoveredResourceServer.getRecoveredResourceColumnsForLoggedinUser(invalidToken, expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT, test);
	
		test.log(LogStatus.INFO, "Get the RecoveredResource columns for the Loggedin user in the org: "+organizationType);
		spogRecoveredResourceServer.getRecoveredResourceColumnsForLoggedinUser("", expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED, test);
