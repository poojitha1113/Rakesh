...
public class DeleteRecoveredResourceColumnsByUserIdTest extends base.prepare.Is4Org{
   ...
   /* private ExtentReports rep;
	...
	public final Object[][] Delete_RecoveredResource_coloumns_valid() {
		
		return new Object[][] {
			// different users
				{ "csr", ti.csr_org_id,ti.csr_token,ti.csr_admin_user_id, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","4","3","1","5","7","11","5","10","6","9","8"},4},
				...
				{ "msp", ti.root_msp_org1_id,ti.root_msp_org1_user1_token,ti.root_msp_org1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","2","3","4","6","7","8","5","10","6","9","8"},7},
				{ "suborg", ti.root_msp1_suborg1_id,ti.root_msp1_suborg1_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","4","2","8","3","13","7","11","5","10","6","9"},1},
				{ "suborg-mspT", ti.root_msp1_suborg1_id,ti.root_msp_org1_user1_token,ti.root_msp1_suborg1_user1_id, new String[] { "true", "false"}, new String[] { "true", "false"},
						new String[] { "true", "false"},new String[]{"1","4","2","8","3","13","7","11","5","10","6","9","14"},1},
	...
	public void deleteRecoveredResourceColumnsForSpecifiedUser_valid(String organizationType,
												 String org_Id,
												 String validToken,
												 String user_Id,
												 String[] sort,
	...
	@Test(dataProvider = "Delete_RecoveredResource_coloumns_valid")
	public void deleteRecoveredResourceColumnsForSpecifiedUser_401(String organizationType,
												 String org_Id,
												 String validToken,
												 String user_Id,
												 String[] sort,
		...
		spogRecoveredResourceServer.deleteRecoveredResourceColumnsforSpecifiedUserwithCheck(user_Id, validToken+"A", SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT, test);
		
		test.log(LogStatus.INFO, "Delete the RecoveredResource columns for the specified user in the org: "+organizationType);	
		spogRecoveredResourceServer.deleteRecoveredResourceColumnsforSpecifiedUserwithCheck(user_Id,"", SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED, test);
		
	}
	
	@DataProvider(name = "Delete_RecoveredResource_coloumns_403")
	public final Object[][] Delete_RecoveredResource_coloumns_403() {
		...
		return new Object[][] {
			{ "direct-mspT", ti.direct_org1_id,ti.direct_org1_user1_token,ti.direct_org1_user1_id,ti.root_msp_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
				new String[] { "true", "false","none"},new String[]{"1","2","3","4","5","7","11","5","10","14","6","9","8"},5},
			{ "direct-suborgT", ti.direct_org1_id,ti.direct_org1_user1_token,ti.direct_org1_user1_id, ti.root_msp1_suborg1_user1_token,new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"1","2","3","4","5","7","6","7","8","9","11","14","10"},5},
			...
			{ "msp-directT", ti.root_msp_org1_id,ti.root_msp_org1_user1_token,ti.root_msp_org1_user1_id,ti.direct_org1_user1_token, new String[] { "true", "false"}, new String[] { "true", "false"},
							new String[] { "true", "false"},new String[]{"1","2","3","4","5","7","11","5","10","14","6","9","8"},6},
			{ "msp-suborgT", ti.root_msp_org1_id,ti.root_msp_org1_user1_token,ti.root_msp_org1_user1_id,ti.root_msp1_suborg1_user1_token, new String[] { "true", "false"}, new String[] { "true", "false"},
								new String[] { "true", "false"},new String[]{"1","2","3","4","5","7","11","5","10","14","6","9","8"},6},
			{ "msp-msp2T", ti.root_msp_org1_id,ti.root_msp_org1_user1_token,ti.root_msp_org1_user1_id,ti.root_msp_org2_user1_token, new String[] { "true", "false"}, new String[] { "true", "false"},
									new String[] { "true", "false"},new String[]{"1","2","3","4","5","7","11","5","10","14","6","9","8"},6},
			...
			{ "submsp-suborgT", ti.root_msp1_submsp_org1_id,ti.root_msp1_submsp1_user1_token,ti.root_msp1_submsp1_user1_id,ti.root_msp1_suborg1_user1_token, new String[] { "true", "false"}, new String[] { "true", "false"},
													new String[] { "true", "false"},new String[]{"1","2","3","4","5","7","11","5","10","14","6","9","8"},6},
			{ "submsp-msp2T", ti.root_msp1_submsp_org1_id,ti.root_msp1_submsp1_user1_token,ti.root_msp1_submsp1_user1_id,ti.root_msp_org2_user1_token, new String[] { "true", "false"}, new String[] { "true", "false"},
														new String[] { "true", "false"},new String[]{"1","2","3","4","5","7","11","5","10","14","6","9","8"},6},
			...
			{ "suborg-suborg_bT", ti.root_msp1_suborg1_id,ti.root_msp1_suborg1_user1_token,ti.root_msp1_suborg1_user1_id, ti.root_msp1_suborg2_user1_token, new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"1","2","3","4","5","7","11","5","10","14","6","9","8"},4},
	...
	@Test(dataProvider = "Delete_RecoveredResource_coloumns_403")
	public void deleteRecoveredResourceColumnsForSpecifiedUser_403(String organizationType,
												 String org_Id,
												 String validToken,
												 String user_Id,
												 String Othertoken,
		...
		if(organizationType.contains("msp-")) {
			test.log(LogStatus.INFO, "Delete the RecoveredResource columns for the specified user in the org: "+organizationType);	
			spogRecoveredResourceServer.deleteRecoveredResourceColumnsforSpecifiedUserwithCheck(user_Id, Othertoken, SpogConstants.INSUFFICIENT_PERMISSIONS, SpogMessageCode.RESOURCE_PERMISSION_DENY, test);
	...
	@Test(dataProvider = "Delete_RecoveredResource_coloumns_valid")
	public void deleteRecoveredResourceColumnsForSpecifiedUser_400(String organizationType,
												 String org_Id,
												 String validToken,
												 String user_Id,
												 String[] sort,
		...
		test.log(LogStatus.INFO, "Delete the RecoveredResource columns for the specified user in the org invalid user_id");	
		spogRecoveredResourceServer.deleteRecoveredResourceColumnsforSpecifiedUserwithCheck(null, validToken, SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_USERID_IS_NOT_UUID, test);
		
		test.log(LogStatus.INFO, "Delete the RecoveredResource columns for the specified user in the org user id is not UUID");	
		spogRecoveredResourceServer.deleteRecoveredResourceColumnsforSpecifiedUserwithCheck("INVALIDUSER", validToken, SpogConstants.REQUIRED_INFO_NOT_EXIST, SpogMessageCode.ELEMENT_USERID_IS_NOT_UUID, test);
	...
	public void deleteRecoveredResourceColumnsForSpecifiedUser_valid_404(String organizationType,
												 String org_Id,
												 String validToken,
												 String user_Id,
												 String[] sort,
		...
		for(int i=0;i<noofcolumnstobecreated ;i++)
		{
			...
			temp = spogRecoveredResourceServer.composeRecoveredResource_Column(columnIdList.get(i),sort[index1],filter[index2],visible[index3],orderId[i+1]);
			expected_columns.add(temp);
		}			    
		test.log(LogStatus.INFO, "Delete the RecoveredResource columns for the specified user in the org: "+organizationType);	
		spogRecoveredResourceServer.deleteRecoveredResourceColumnsforSpecifiedUserwithCheck(UUID.randomUUID().toString(), validToken, SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.USER_ID_DOESNOT_EXIST, test);
	}
