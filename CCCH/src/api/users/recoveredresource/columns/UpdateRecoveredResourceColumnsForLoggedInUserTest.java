...
public class UpdateRecoveredResourceColumnsForLoggedInUserTest extends base.prepare.Is4Org{
   ...
   /* private ExtentReports rep;
	...
	@DataProvider(name="updateRecoveredResourceColumnsForLoggedInUser_201")
	public Object[][] updateRecoveredResourceColumnsForLoggedInUser_201(){
		
		return new Object[][] {
			{"csr", ti.csr_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
				new String[] { "true", "false","none"},new String[]{"2","3","10","11","1","4","7","5","6","9","8"},new String[] { "true"},new String[]{"4","7","5","6","9","8"},4,2},
			...
			{"msp", ti.root_msp_org1_user1_token,  new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
				new String[] { "true", "false","none"},new String[]{"2","3","10","11","1","4","7","5","6","9","8"},new String[] { "false"},new String[]{"1","6","9","8"},4,3},
			{"suborg", ti.root_msp1_suborg1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","10","11","4","7","5","6","9","8"},new String[] { "true"},new String[]{"7","5","6","9","8"},4,1},
				
			{"suborg-mspT", ti.root_msp_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
					new String[] { "true", "false","none"},new String[]{"2","3","1","10","11","4","7","5","6","9","8"},new String[] { "false"},new String[]{"7","5","6","9","8"},4,2},
			{"suborg-mspAccAdminT", ti.root_msp_org1_msp_accountadmin1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
						new String[] { "true", "false","none"},new String[]{"2","3","1","10","11","4","7","5","6","9","8"},new String[] { "false"},new String[]{"7","5","6","9","8"},4,2}
		};
	}

	@Test(dataProvider="updateRecoveredResourceColumnsForLoggedInUser_201")
	public void updateRecoveredResourceColumnsForLoggedInUser_201(String organizationType,
													String validToken,
													String[] sort,
													String[] filter,
													String[] visible,
		...
		test.log(LogStatus.INFO, "Create RecoveredResource columns for Loggedin user in org : "+ organizationType);
		...
		test.log(LogStatus.INFO, "Update RecoveredResource columns for Loggedin User in org : "+organizationType);
		spogRecoveredResourceServer.updateRecoveredResourceColumnsForLoggedinUser(validToken, expected_updated_columns, columnsHeadContent, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	...
	public final Object[][] UpdateRecoveredResourceColumns_400() {
		...
		return new Object[][] {
			...
			{ "direct-moreOrderIds", ti.direct_org1_user1_token, new String[] { "true", "false","none"}, new String[] { "true", "false","none"},
							new String[] { "true", "false","none"},new String[]{"2","3","10","11","1","4","7","5","6","9","8"},11},
...
//				int index4 = gen_random_index(orderId);
			...
			test.log(LogStatus.INFO, "Update the RecoveredResource columns created for Loggedin user in org: "+organizationType);
			spogRecoveredResourceServer.updateRecoveredResourceColumnsForLoggedinUser(validToken, expected_columns1, columnsHeadContent, SpogConstants.REQUIRED_INFO_NOT_EXIST, expectedErrorMessage, test);
									
			test.log(LogStatus.INFO, "Delete RecoveredResource columns for Loggedin user in org: "+organizationType);
			spogRecoveredResourceServer.deleteRecoveredResourceColumnsforLoggedInUserwithCheck(validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
						
		}
	@DataProvider(name="UpdateRecoveredResourceColumnsForLoggedinUser_401")
	public final Object[][] UpdateRecoveredResourceColumnsForLoggedinUser_401() {
		...
		return new Object[][] {
			// different users
				...
				{ "suborg", ti.root_msp1_suborg1_user1_token,"invalid_token",new String[] { "true", "false"}, new String[] { "true", "false"},
					new String[] { "true", "false"},new String[]{"5","2","9","4","1","6","10","11","7","8","3"},1},
						
		};
	}
	@Test(dataProvider="UpdateRecoveredResourceColumnsForLoggedinUser_401")
	public void updateRecoveredResourceColumnsForLoggedinUserTest_401(String organizationType,
															String validToken,
															String invalidToken,
															String[] sort,
															String[] filter,
		...
		test.log(LogStatus.INFO, "Update the RecoveredResource columns for the Loggedin user in the org: "+organizationType);
		spogRecoveredResourceServer.updateRecoveredResourceColumnsForLoggedinUser(invalidToken, expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT, test);
					
		test.log(LogStatus.INFO, "Update the RecoveredResource columns for the Loggedin user in the org: "+organizationType);
		spogRecoveredResourceServer.updateRecoveredResourceColumnsForLoggedinUser("", expected_columns, columnsHeadContent, SpogConstants.NOT_LOGGED_IN, SpogMessageCode.COMMON_AUTHENTICATION_FAILED, test);
						
		test.log(LogStatus.INFO, "Delete the RecoveredResource columns for the Loggedin user in the org: "+organizationType);
		spogRecoveredResourceServer.deleteRecoveredResourceColumnsforLoggedInUserwithCheck(validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
	}
