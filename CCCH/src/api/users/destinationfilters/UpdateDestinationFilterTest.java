...
public class UpdateDestinationFilterTest extends base.prepare.TestApiBase {
  ...
  public void prepareJobData() {
    ...
    //
    // userInfoMap = composeRandomUserMap(TestPrefix, SpogConstants.CSR_ADMIN, csrOrgId);
    // createUser(userInfoMap, csrToken);
  ...
  @DataProvider(
      name = "csrUpdateDestFilterId")
  public final Object[][] csrUpdateDestFilterId() {

    return new Object[][] {
        {mspAdminA, mspPassword, getUserId(mspAdminA, mspPasswordA), destFiltId_MspA_1},
        {mspAdminA, mspPassword, getUserId(mspAdminA, mspPasswordA), destFiltId_MspA_Other},
        {childOrgA_Admin, childOrgA_Password, getUserId(childOrgA_Admin, childOrgA_Password),
            destFiltId_AccountA_1},
        {childOrgA_Admin, childOrgA_Password, getUserId(childOrgA_Admin, childOrgA_Password),
            destFiltId_AccountA_Other1},
        {directAdminA, directPasswordA, getUserId(directAdminA, directPasswordA),
            destFiltId_DirectA_1},
        {directAdminA, directPasswordA, getUserId(directAdminA, directPasswordA),
            destFiltId_DirectA_Other}};

  }


  @Test(
      dataProvider = "csrUpdateDestFilterId")
  public void Given_CsrAdmin_When_UpdateDestFilter_Should_Successful(String userName,
      String password, String userId, String destFilterId) {

    test = ExtentManager.getNewTest(this.getClass().getName() + "."
        + Thread.currentThread().getStackTrace()[1].getMethodName());
    test.assignAuthor("yin.li");

    login(csrAdminUserName, csrAdminPassword);

    Response response = updateDestinationFilter(userId, destFilterId, "", "", true);
  ...
  public void Given_Csr_ReadOnly_User_When_UpdateDestFilter_Should_Failed() {
    ...
    Response response = updateDestinationFilter(getUserId(directAdminA, directPasswordA), destFiltId_DirectA_1, "", "", false);
  ...
  @DataProvider(
      name = "mspUpdateDestFilterId")
  public final Object[][] mspUpdateDestFilterId() {
  ...
  @Test(
      dataProvider = "mspUpdateDestFilterId")
  public void Given_MspAdmin_When_UpdateDestFilter_Should_Successful(String userName,
      String password, String userId, String destFilterId) {
    ...
    login(mspAdminB, mspPasswordB);
    Response response = updateDestinationFilter(userId, destFilterId, "", "", true);
    response.then().assertThat().statusCode(ServerResponseCode.Success_Put);
    response.then().assertThat().body("data.errors", is(nullValue()));
  }


  @DataProvider(
      name = "mspUpdateDestFilterIdFailed")
  public final Object[][] mspUpdateDestFilterIdFailed() {
  ...
  @Test(
      dataProvider = "mspUpdateDestFilterIdFailed")
  public void Given_MspAdmin_When_UpdateDestFilterInOtherOrg_Should_Failed(String userName,
    ...
    login(mspAdminA, mspPasswordA);

    Response response = updateDestinationFilter(userId, destFilterId, "", "", false);
  ...
  @DataProvider(
      name = "accountUpdateDestFilterId")
  public final Object[][] accountUpdateDestFilterId() {
  ...
  @Test(
      dataProvider = "accountUpdateDestFilterId")
  public void Given_accountAdmin_When_UpdateDestFilter_Should_Successful(String userName,
      String password, String userId, String destFilterId) {
    ...
    login(childOrgA_Admin, childOrgA_Password);
  ...
  @DataProvider(
      name = "accountUpdateDestFilterIdFailed")
  public final Object[][] accountUpdateDestFilterIdFailed() {
  ...
  @Test(
      dataProvider = "accountUpdateDestFilterIdFailed")
  public void Given_accountAdmin_When_UpdateDestFilterInOtherOrg_Should_Failed(String userName,
      String password, String userId, String destFilterId) {
  ...
  @DataProvider(
      name = "directUpdateDestFilterId")
  public final Object[][] directUpdateDestFilterId() {
  ...
  @Test(
      dataProvider = "directUpdateDestFilterId")
  public void Given_DirectAdmin_When_UpdateDestFilter_Should_Successful(String userName,
      String password, String userId, String destFilterId) {
    ...
    login(directAdminB, directPasswordB);
  ...
  @DataProvider(
      name = "directUpdateDestFilterIdFailed")
  public final Object[][] directUpdateDestFilterIdFailed() {
  ...
  @Test(
      dataProvider = "directUpdateDestFilterIdFailed")
  public void Given_DirectAdmin_When_UpdateDestFilter_Should_Failed(String userName,
      String password, String userId, String destFilterId) {
  ...
  @Test
  public void Given_DirectAdmin_When_UpdateDestFilterWithInvalidDestFilterId_Should_Failed() {
    ...
    String destFilterId = "invalidId";
    String policyId = UUID.randomUUID().toString();
    String destinationType = DestinationType.cloud_direct_volume.toString();
    String isDefault = "false";

    Response response =
        updateDestinationFilter(userId, destFilterId, policyId, destinationType, isDefault, false);
    ...
    response =
        updateDestinationFilter(userId, destFilterId, policyId, destinationType, isDefault, false);
    response.then().assertThat().statusCode(ServerResponseCode.Method_Not_Allowed_On_Resource);
    response.then().assertThat().body("errors.code.size()", is(1)).body("errors.code",
        hasItem("00900002"));
  }
  ...
  @Test
  public void Given_DirectAdmin_When_UpdateDestFilterWithNotExistDestFilterId_Should_Failed() {
    ...
    String userId = getUserId(directAdminB, directPasswordB);
    String destFilterId = UUID.randomUUID().toString();
    String policyId = UUID.randomUUID().toString();
    String destinationType = DestinationType.cloud_direct_volume.toString();
    String isDefault = "false";
  ...
  @Test
  public void Given_DirectAdmin_When_UpdateDestFilterWithInvalidPolicyId_Should_Failed() {
    ...
    String userId = getUserId(directAdminB, directPasswordB);
    String destFilterId = destFiltId_DirectB_1;
    String policyId = "invalidId";
    String destinationType = DestinationType.cloud_direct_volume.toString();
    String isDefault = "false";
  ...
  @Test
  public void Given_DirectAdmin_When_UpdateDestFilterWithInvalidDestType_Should_Failed() {
  ...
  @Test
  public void Given_DirectAdmin_When_UpdateDestFilterWithInvalidIsDefaultValue_Should_Failed() {
  ...
  public final Object[][] accountMgrTest() {
    ...
    return new Object[][] {{childOrgA_Admin, destFiltId_AccountA_1, "true"},
        {childOrgB_Admin, destFiltId_AccountB_1, "false"}, {mspAdminA, destFiltId_MspA_1, "false"},
        {directAdminA, destFiltId_DirectA_1, "false"}};
  }


  @Test(
      dataProvider = "accountmgr")
  public void Given_AccountManager_when_GetDestinationFilterList_Should_work(String destFilterOwner,
      String destFilterId, String expectResult) {
    ...
    spogServer.userLogin(destFilterOwner, getTestPassword());
    String destFilterOwnerId = spogServer.GetLoggedinUser_UserID();

    spogServer.userLogin(accountMgr, getTestPassword());
    spogDestinationServer.setToken(spogServer.getJWTToken());

    Response response = updateDestinationFilter(destFilterOwnerId, destFilterId, "", "",
  ...
  public Response updateDestinationFilter(String userID, String destFilterId,
  ...
  public String createDestFilterInfo(String userName, String password, String usrId) {
    ...
    if (StringUtils.isEmpty(usrId)) { // the user id is owner userid
