...
public class DeleteDestinationFilterForLoggedInUserTest extends base.prepare.Is4Org {
	...
	@BeforeClass
	@Parameters({ "baseURI", "port",  "logFolder",
			"runningMachine", "buildVersion" })
	public void beforeClass(String baseURI, String port,String logFolder, String runningMachine, String buildVersion) {
		...
		rep = ExtentManager.getInstance("DeleteDestinationFilterForLoggedInUserTest", logFolder);
	...
	public final Object[][] getdestinationfilter() {
		return new Object[][] {
				...
				{ "msp", ti.normal_msp_org1_id, ti.normal_msp_org1_user1_token, ti.normal_msp_org1_user1_id,
						...
						DestinationType.cloud_direct_volume.toString(), "none" },
				/*
				 * {"suborg",sub_org_Id,sub_orga_user_validToken,suborga_user_id
				 * ,suborga_site_id,DestinationType.cloud_direct_volume.toString
				 * (),DestinationStatus.creating.toString(),"20.1","2","22",
				 * "normal","host-abc","1M",
				 * "0","0","0","0","0","0",RandomStringUtils.randomAlphanumeric(
				 * 4)+"ramesh-test34","none",DestinationType.cloud_direct_volume
				 * .toString(),"none"},
				 * {"msp",msp_organization_id,msp_user_validToken,msp_user_id,
				 * msp_site_id,DestinationType.cloud_direct_volume.toString(),
				 * DestinationStatus.creating.toString(),"20.1","2","22",
				 * "normal","host-abc","14D",
				 * "0","0","0","0","0","0",RandomStringUtils.randomAlphanumeric(
				 * 4)+"test",RandomStringUtils.randomAlphanumeric(4)+"test",
				 * "none","none"},
				 */
	...
	public void deletedestinationfilterforLoggedInuser_valid(String organizationType, String organization_id,
		...
		spogDestinationServer.deletedestinationfilterforLoggedInuser(filter_Id, validToken,
		...
		/*if (organizationType.equals("suborg")) {
			spogDestinationServer.setToken(ti.normal_msp_org1_msp_accountadmin1_token);
			user_id = spogServer.GetLoggedinUser_UserID();
			test.log(LogStatus.INFO, "Create the destination filter for destination type");
			filter_Id = spogDestinationServer.createDestinationFilterWithCheck(user_id, prefix + "filter",
					filter_destination_name, filter_policy_id, filter_destination_type, "true", test);
			
			test.log(LogStatus.INFO,
					"delete destination filter by filter id using valid token of org " + organizationType);
			spogDestinationServer.deletedestinationfilterforLoggedInuser(filter_Id, ti.normal_msp_org1_msp_accountadmin1_token,
					SpogConstants.SUCCESS_GET_PUT_DELETE, null, test);
		}
	...
	public void deletedestinationfilterforLoggedInUser_401_andcsrtoken(String organizationType, String organization_id,
			String validToken, String user_id, String destination_type, String destination_status, String primary_usage,
			String snapshot_usage, String total_usage, String volume_type, String hostname, String retention_id,
			String age_hours_max, String age_four_hours_max, String age_days_max, String age_weeks_max,
			String age_months_max, String age_years_max, String destination_name, String filter_destination_name,
		...
		spogDestinationServer.deletedestinationfilterforLoggedInuser(filter_Id, validToken + "J",
		...
		spogDestinationServer.deletedestinationfilterforLoggedInuser(filter_Id, "", SpogConstants.NOT_LOGGED_IN,
	...
	public void deletedestinationfilterforloggedInUser_doesnotexist(String organizationType, String organization_id,
			String validToken, String user_id, String destination_type, String destination_status, String primary_usage,
			String snapshot_usage, String total_usage, String volume_type, String hostname, String retention_id,
			String age_hours_max, String age_four_hours_max, String age_days_max, String age_weeks_max,
			String age_months_max, String age_years_max, String destination_name, String filter_destination_name,
		...
		test.log(LogStatus.INFO,
				"delete destination filter by filter id where the filter does not exist using token of "
						+ organizationType);
		spogDestinationServer.deletedestinationfilterforLoggedInuser(UUID.randomUUID().toString(), validToken,
		...
		spogDestinationServer.deletedestinationfilterforLoggedInuser(UUID.randomUUID().toString(), ti.csr_token,
				SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.DESTINATION_FILTER_NOT_FOUND_WITH_USER_ID, test);
	...
	@Test(dataProvider = "postdestination_cloudvolume")
	public void deletedestinationfilterforloggedInUser_invalidFilterId(String organizationType, String organization_id,
			String validToken, String user_id, String destination_type, String destination_status, String primary_usage,
			String snapshot_usage, String total_usage, String volume_type, String hostname, String retention_id,
			String age_hours_max, String age_four_hours_max, String age_days_max, String age_weeks_max,
			String age_months_max, String age_years_max, String destination_name, String filter_destination_name,
		...
		test.log(LogStatus.INFO,
				"delete destination filter by filter id where the filter does not exist using token of "
						+ organizationType);
		spogDestinationServer.deletedestinationfilterforLoggedInuser("123", validToken,
	...
	public final Object[][] getdestinationfilterbyfilterId_403() {
		return new Object[][] {
				 ...
				 * 4)+"ramesh-test34","none",DestinationType.cloud_direct_volume
				 * .toString(),"none"},
				 * {"suborgusingmsptoken",sub_org_Id,msp_user_validToken,
				 * suborga_user_id,suborga_site_id,DestinationType.
				 * cloud_direct_volume.toString(),DestinationStatus.creating.
				 * toString(),"20.1","2","22","normal","host-abc","1M",
				 * "0","0","0","0","0","0",RandomStringUtils.randomAlphanumeric(
				 * 4)+"ramesh-test34",RandomStringUtils.randomAlphanumeric(4)+
				 * "ramesh-test34","none","none"},
				 */
	...
	public void deletedestinationfilterforloggedInUser_404_otherogtoken(String organizationType, String organization_id,
		...
		spogDestinationServer.deletedestinationfilterforLoggedInuser(filter_Id, otherorgtoken,
				SpogConstants.RESOURCE_NOT_EXIST, SpogMessageCode.DESTINATION_FILTER_NOT_FOUND_WITH_USER_ID, test);
