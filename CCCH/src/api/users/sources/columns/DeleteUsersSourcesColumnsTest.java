...
public class DeleteUsersSourcesColumnsTest  extends base.prepare.PrepareOrgInfo{
	
	 @Parameters({ "pmfKey"})
	 public DeleteUsersSourcesColumnsTest(String pmfKey) {
		super(pmfKey);
	...
	private String  org_model_prefix=this.getClass().getSimpleName();
	  ...
	  @DataProvider(name = "organizationAndUserInfo")
		public final Object[][] getOrganizationAndUserInfo() {
			return new Object[][] {
				{final_direct_user_name_email, common_password,"Name;true;1,Type;false;3", final_direct_user_name_email,  SpogConstants.DIRECT_ADMIN, direct_org_id,null, 
					SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{final_msp_user_name_email,  common_password,"Connection;true;2,Policy;true;1", final_msp_user_name_email,SpogConstants.MSP_ADMIN, msp_org_id, null, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				...
				{account_user_email,  common_password, "Name;true;3,Protection;true;1", account_user_email, SpogConstants.DIRECT_ADMIN, account_id, null,SpogConstants.SUCCESS_GET_PUT_DELETE, null},
			    {csrAdminUserName, csrAdminPassword,"OS;true;1,",csrAdminUserName,SpogConstants.DIRECT_ADMIN, direct_org_id, null,SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{csrAdminUserName, csrAdminPassword,"Name;true;1,Type;false;3", csrAdminUserName, SpogConstants.MSP_ADMIN, msp_org_id, null,SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{csrAdminUserName, csrAdminPassword,"Name;false;1",csrAdminUserName,  SpogConstants.DIRECT_ADMIN, account_id, null,SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				...
				{account_user_email,  common_password, "Name;true;3,Protection;true;1", final_msp_account_admin_email, null, null, account_user_id, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{another_account_user_email, common_password,"Name;true;1", final_msp_account_admin_email, null, null, another_account_user_id, SpogConstants.INSUFFICIENT_PERMISSIONS, ErrorCode.RESOURCE_PERMISSION},
				{final_msp_user_name_email, common_password,"Name;true;1", final_msp_account_admin_email, null, null, msp_user_id, SpogConstants.INSUFFICIENT_PERMISSIONS, ErrorCode.RESOURCE_PERMISSION},
				{final_direct_user_name_email, common_password,"Name;true;1", final_msp_account_admin_email, null, null, direct_user_id, SpogConstants.INSUFFICIENT_PERMISSIONS, ErrorCode.RESOURCE_PERMISSION},
					
				{csrAdminUserName,  csrAdminPassword, "Name;true;3,Protection;true;1", final_msp_user_name_email, null, null, msp_account_admin_id, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{csrAdminUserName,  csrAdminPassword, "Name;true;1", final_direct_user_name_email, null, null, msp_account_admin_id, SpogConstants.INSUFFICIENT_PERMISSIONS, ErrorCode.RESOURCE_PERMISSION},
				{csrAdminUserName,  csrAdminPassword, "Name;true;1", account_user_email, null, null, msp_account_admin_id, SpogConstants.INSUFFICIENT_PERMISSIONS, ErrorCode.RESOURCE_PERMISSION},
				{csrAdminUserName,  csrAdminPassword, "Name;true;3,Protection;true;1", final_msp_account_admin_email, null, null, msp_account_admin_id, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				{csrAdminUserName,  csrAdminPassword, "Name;true;3,Protection;true;1", csrAdminUserName, null, null, msp_account_admin_id, SpogConstants.SUCCESS_GET_PUT_DELETE, null},
			
				{final_direct_user_name_email, common_password,"Name;true;1", this.csrReadOnlyAdminUserName, null, null,direct_user_id , SpogConstants.INSUFFICIENT_PERMISSIONS, ErrorCode.RESOURCE_PERMISSION},
				{final_msp_user_name_email, common_password,"Name;true;1", this.csrReadOnlyAdminUserName, null, null,msp_user_id , SpogConstants.INSUFFICIENT_PERMISSIONS, ErrorCode.RESOURCE_PERMISSION},
				{account_user_email, common_password,"Name;true;1", this.csrReadOnlyAdminUserName,  null, null,account_user_id , SpogConstants.INSUFFICIENT_PERMISSIONS, ErrorCode.RESOURCE_PERMISSION},
				{final_msp_account_admin_email, common_password,"Name;true;1", this.csrReadOnlyAdminUserName,  null, null,msp_account_admin_id , SpogConstants.INSUFFICIENT_PERMISSIONS, ErrorCode.RESOURCE_PERMISSION},
				...
				{this.final_sub_msp1_msp_account_user_name_email, common_password,"Name;true;1,Type;false;3",  final_root_msp_account_admin_user_name_email, null, null, this.sub_msp1_msp_account_admin_id,SpogConstants.INSUFFICIENT_PERMISSIONS, ErrorCode.RESOURCE_PERMISSION},
				...
				{this.final_root_msp_account_admin_user_name_email, common_password,"Name;true;1,Type;false;3",final_sub_msp1_msp_account_user_name_email,    null, null, this.root_msp_account_admin_user_id,SpogConstants.INSUFFICIENT_PERMISSIONS, ErrorCode.RESOURCE_PERMISSION},
	  ...
	  /**
	   * 1. direct admin could delete in the same organization's specific user's source columns
	   * 2. msp admin could delete  in the same organization's specific user's source columns
	   * 4. msp admin could delete in the account's specific user's source columns
	   * 3. account admin could delete  in the same organization's specific user's source columns
	   * 5. csr admin could delete direct admin's source columns
	   * 23. csr admin could delete msp admin's source columns
	   * 24. csr admin could delete account admin's source columns
	   * 6. direct admin could not delete msp organization's user's source columns, report 403
	   * 26. direct admin could not delete account admin's source columns, report 403
	   * 
	   * 7. msp admin could not delete direct organization's user's source columns, report 403
	   * 8. account admin could not delete direct organization's user's source columns, report 403
	   * 27. account admin could not delete msp admin's source columns, report 403
	   * 28. account admin could not delete other account admin's source columns, report 403
	   * 
	   * 15. msp account admin could delete direct admin's source column in mastered account
	   * 16. msp account admin could not delete direct admin's source column in not mastered account
	   * 17. msp account admin could not delete msp admin's source column in its org
	   * 18. msp account admin could not delete direct admin's source column in direct org
	   * 20. msp admin could delete msp account admin's source column
	   * 21. direct admin can not delete msp account admin's source column
	   * 22. account admin can not delete msp account admin's source column
	   * 25. csr admin could delete msp account admin's source columns
	   * 
	   * 19. msp account admin could delete its own source column
	   * 
	   * 
	   * 
	   * @param userName
	  ...
	  public void adminCanDeleteUsersSourcesColumns(String createUserSourceColumnAdmin, String password, String createdSourceColumns, String deleteUserSourceColumnAdmin,   String role_id, String organization_id, 
			  String created_user_id, int statusCode, String errorCode){
		  ...
		  String deletePassword = password;
		  if(!deleteUserSourceColumnAdmin.equalsIgnoreCase(csrAdminUserName)){
			  deletePassword= common_password;
		  }
	
		  spogServer.userLogin(deleteUserSourceColumnAdmin, deletePassword, test);
		  token = spogServer.getJWTToken();
		  source4SpogServer.setToken(token);
		  
		  test.log(LogStatus.INFO,"delete user source columns");
		  source4SpogServer.deleteUsersSourcesColumnsWithCheck(created_user_id, token, statusCode, errorCode);
	 }
	  
	  @Test(enabled=true)
	  /**
	   * 9. fail to delete user's source column without login, report 401
	   * 10. fail to delete user's source column with invalid token, report 401
	   * 13. delete source column when not create source column before, it should sucess
	  ...
	  public void deleteUsersSourcesColumnsWithoutLogin(){
		  ...
		  String token = spogServer.getJWTToken();
		  test.log(LogStatus.INFO,"deleteUsersSourcesColumnsWithoutLoginAndCheck");
		  source4SpogServer.deleteUsersSourcesColumnsWithoutLoginAndCheck(direct_user_id);
		  test.log(LogStatus.INFO,"deleteUsersSourcesColumns With invalide token");
		  source4SpogServer.deleteUsersSourcesColumnsWithCheck(direct_user_id,  UUID.randomUUID().toString(), SpogConstants.NOT_LOGGED_IN,  ErrorCode.AUTHORIZATION_HEADER_BLANK);
	...
	/**
	 * 11. set user_id as non-existing id, delete source column, report 404
	 * 12. set user_id as null, delete source column, report 400
	 * 14. set user_id as "", delete source column, report 404
	...
	public void errorHandling( String user_id, int statusCode, String errorCode){
		  ...
		  source4SpogServer.deleteUsersSourcesColumnsWithCheck(user_id, token, statusCode, errorCode);
		  
	}

	  @Test( enabled=true)
	  public void csrReadOnlyAdminCanDeleteUsersSourcesColumns(){
