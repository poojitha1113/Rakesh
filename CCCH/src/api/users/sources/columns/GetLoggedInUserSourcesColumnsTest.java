...
public class GetLoggedInUserSourcesColumnsTest  extends base.prepare.PrepareOrgInfo{
	
	 @Parameters({ "pmfKey"})
	  public GetLoggedInUserSourcesColumnsTest(String pmfKey) {
		super(pmfKey);
	  ...
	  @DataProvider(name = "organizationAndUserInfo")
		public final Object[][] getOrganizationAndUserInfo() {
			return new Object[][] {
				 ...
				 {final_msp_user_name_email,  common_password,"Protection;true;3,Connection;true;2,Policy;false;3",SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				
				 {account_user_email,  common_password, "Group;true;3,VM Name;true;1", SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				 {final_msp_account_admin_email,  common_password, "Group;true;3,VM Name;true;1", SpogConstants.SUCCESS_GET_PUT_DELETE, null},
				 {this.csrReadOnlyAdminUserName, this.csrReadOnlyAdminPassword, "Group;true;3,VM Name;true;1", SpogConstants.SUCCESS_GET_PUT_DELETE, null},
	...
	/**
	 * 1. direct admin could get  its own source columns
	 * 2. msp admin could get  its own source columns
	 * 3. account admin could get   its own source columns
	 * 6. msp account admin could get own source columns
	 * 
	 ...
	 */
	  ...
	  public void getLoggedInUserSourcesColumns(String createUserSourceColumnAdmin, String password, String specifiedSourceColumns,  int statusCode, String errorCode){
		  ...
		  source4SpogServer.getLoggedInUserSourcesColumnsWithCheck(columnsList, token, statusCode, errorCode);
	  ...
	  @Test(enabled=true)
	  /**
	   *4. fail to get user's source column without login, report 401
	   * 5. fail to get user's source column with invalid token, report 401
	   */
	  public void getLoggedInUserSourcesColumnsWithoutLogin(){
		  ...
		  String token = spogServer.getJWTToken();
		  test.log(LogStatus.INFO,"getLoggedInUserSourcesColumnsWithoutLoginAndCheck");
		  source4SpogServer.getLoggedInUserSourcesColumnsWithoutLoginAndCheck();
		  
		  test.log(LogStatus.INFO,"getLoggedInUserSourcesColumnsWithCheck With invalid token");
		  source4SpogServer.getLoggedInUserSourcesColumnsWithCheck(null, UUID.randomUUID().toString(), SpogConstants.NOT_LOGGED_IN,  ErrorCode.AUTHORIZATION_HEADER_BLANK);
