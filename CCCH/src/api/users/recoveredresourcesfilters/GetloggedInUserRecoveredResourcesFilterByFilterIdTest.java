...
public class GetloggedInUserRecoveredResourcesFilterByFilterIdTest extends base.prepare.Is4Org {
	...
	public void getRecoveredResourcesFilterValid_200(String organizationType, String validToken, String user_id,
		...
		response = spogRecoveredResourceServer.getLoggedInUserRecoveredResourcesFilterByFilterId(validToken, filter_id,
	...
	public void getRecoveredResourcesFilterValid_401(String organizationType, String validToken, String user_id,
		...
		response = spogRecoveredResourceServer.getLoggedInUserRecoveredResourcesFilterByFilterId(inValidToken,
				filter_id, SpogConstants.NOT_LOGGED_IN, test);
		...
		response = spogRecoveredResourceServer.getLoggedInUserRecoveredResourcesFilterByFilterId(MissingToken,
				filter_id, SpogConstants.NOT_LOGGED_IN, test);
	...
	// get the user defined job columns using csr/valid token
	@Test(dataProvider = "get_RecoveredResources_filter_invalid")
	public void getRecoveredResourcesFilterInValid_filter(String organizationType, String validToken, String user_id,
			String org_id, String policy_id, String state, String OSmajor, String RecoveredResourceType,
			String filter_name, String is_default) {
		...
		test.log(LogStatus.INFO, "get filters in the organization with invalid filter id");

		response = spogRecoveredResourceServer.getLoggedInUserRecoveredResourcesFilterByFilterId(validToken, "abc",
		...
		response = spogRecoveredResourceServer.getLoggedInUserRecoveredResourcesFilterByFilterId(validToken,
				invalidfilter, SpogConstants.RESOURCE_NOT_EXIST, test);
