...
public class CreateSpecifiedUserRecoveredResourcesFiltersTest extends base.prepare.Is4Org {
	...
	public final Object[][] createRecoveredResourcesFilterValidParams() {
		...
		return new Object[][] {
				...
				{ "CSR-Read-only", ti.csr_readonly_token, ti.csr_readonly_admin_user_id, ti.csr_org_id,
				...
				{ "SUBORG_MSP", ti.normal_msp_org1_msp_accountadmin1_token, ti.normal_msp1_suborg1_user1_id,
						ti.normal_msp1_suborg1_id, UUID.randomUUID().toString(), State.get(5), OSMajor.windows.name(),
						recoveredResourceType.get(3), spogServer.ReturnRandom("filter"), "false" }
	...
	public final Object[][] createRecoveredResourcesFilterInValidParams() {
		...
		return new Object[][] {
				...
				{ "DIRECT", ti.direct_org1_user1_token, ti.direct_org1_user1_id, ti.direct_org1_id,
						UUID.randomUUID().toString(), State.get(0), OSMajor.windows.name(),
						recoveredResourceType.get(0), spogServer.ReturnRandom("filter"), "true" },
				{ "MSP", ti.normal_msp_org1_user1_token, ti.normal_msp_org1_user1_id, ti.normal_msp_org2_id,
						UUID.randomUUID().toString(), State.get(1), OSMajor.windows.name(),
						recoveredResourceType.get(1), spogServer.ReturnRandom("filter"), "false" },
				{ "SUBORG", ti.normal_msp1_suborg1_user1_token, ti.normal_msp1_suborg1_user1_id,
						ti.normal_msp1_suborg1_id, UUID.randomUUID().toString(), State.get(3), OSMajor.windows.name(),
	...
	public void createRecoveredResourcesFilterValid_401(String organizationType, String validToken, String user_id,
		...
		Response response = spogRecoveredResourceServer.createSpecifiedUserRecoveredResourcesFilters(user_id,
				inValidToken, policy_id, state, OSmajor, recoveredResourceType, filter_name, is_default, test);
		...
		response = spogRecoveredResourceServer.createSpecifiedUserRecoveredResourcesFilters(user_id, MissingToken,
	...
	@DataProvider(name = "create_RecoveredResources_filter_invalid_403")
	public final Object[][] createRecoveredResourcesFilterInValidParams_403() {

		return new Object[][] {

				{ "direct-msp", ti.direct_org1_user1_token, ti.direct_org1_user1_id, ti.direct_org1_id,
						UUID.randomUUID().toString(), State.get(0), OSMajor.windows.name(),
						recoveredResourceType.get(0), spogServer.ReturnRandom("filter"), "true",
				...
				{ "csr-msp", ti.csr_token, ti.csr_admin_user_id, ti.csr_org_id, UUID.randomUUID().toString(),
						State.get(0), OSMajor.windows.name(), recoveredResourceType.get(0),
						spogServer.ReturnRandom("filter"), "true", ti.normal_msp_org2_user1_token },
				{ "csr-suborg", ti.csr_token, ti.csr_admin_user_id, ti.csr_org_id, UUID.randomUUID().toString(),
						State.get(0), OSMajor.windows.name(), recoveredResourceType.get(0),
						spogServer.ReturnRandom("filter"), "true", ti.normal_msp1_suborg2_user1_token },
				{ "csr-mspAdminAccount", ti.csr_token, ti.csr_admin_user_id, ti.csr_org_id,
						UUID.randomUUID().toString(), State.get(0), OSMajor.windows.name(),
						recoveredResourceType.get(0), spogServer.ReturnRandom("filter"), "true",
						ti.normal_msp_org1_msp_accountadmin1_token },
				// csrreadonly cases
				{ "csrreadonly-direct", ti.csr_readonly_token, ti.csr_readonly_admin_user_id, ti.csr_org_id,
						UUID.randomUUID().toString(), State.get(0), OSMajor.windows.name(),
						recoveredResourceType.get(0), spogServer.ReturnRandom("filter"), "true",
						ti.direct_org1_user1_token },
				{ "csrreadonly-msp", ti.csr_readonly_token, ti.csr_readonly_admin_user_id, ti.csr_org_id,
						UUID.randomUUID().toString(), State.get(0), OSMajor.windows.name(),
						recoveredResourceType.get(0), spogServer.ReturnRandom("filter"), "true",
						ti.normal_msp_org2_user1_token },
				{ "csrreadonly-suborg", ti.csr_readonly_token, ti.csr_readonly_admin_user_id, ti.csr_org_id,
						UUID.randomUUID().toString(), State.get(0), OSMajor.windows.name(),
						recoveredResourceType.get(0), spogServer.ReturnRandom("filter"), "true",
						ti.normal_msp1_suborg2_user1_token },
				{ "csrreadonly-mspAdminAccount", ti.csr_readonly_token, ti.csr_readonly_admin_user_id, ti.csr_org_id,
						UUID.randomUUID().toString(), State.get(0), OSMajor.windows.name(),
						recoveredResourceType.get(0), spogServer.ReturnRandom("filter"), "true",
						ti.normal_msp_org1_msp_accountadmin1_token },

				// 3 tier cases
				{ "rootmsp-suborg", ti.root_msp_org1_user1_token, ti.root_msp_org1_user1_id, ti.root_msp_org1_id,
						UUID.randomUUID().toString(), State.get(0), OSMajor.windows.name(),
						recoveredResourceType.get(0), spogServer.ReturnRandom("filter"), "true",
						ti.root_msp1_suborg1_user1_token },
				{ "rootmsp-submsp", ti.root_msp_org1_user1_token, ti.root_msp_org1_user1_id, ti.root_msp_org1_id,
						UUID.randomUUID().toString(), State.get(0), OSMajor.windows.name(),
						recoveredResourceType.get(0), spogServer.ReturnRandom("filter"), "true",
						ti.root_msp1_submsp1_user1_token },
				{ "rootmsp-submsp_sub", ti.root_msp_org1_user1_token, ti.root_msp_org1_user1_id, ti.root_msp_org1_id,
						UUID.randomUUID().toString(), State.get(0), OSMajor.windows.name(),
						recoveredResourceType.get(0), spogServer.ReturnRandom("filter"), "true",
						ti.msp1_submsp1_suborg1_user1_token },
				{ "submsp-submsp_sub", ti.root_msp1_submsp1_user1_token, ti.root_msp1_submsp1_user1_id,
						ti.root_msp1_submsp_org1_id, UUID.randomUUID().toString(), State.get(0), OSMajor.windows.name(),
						recoveredResourceType.get(0), spogServer.ReturnRandom("filter"), "true",
						ti.msp1_submsp1_suborg1_user1_token },
				{ "submsp-rootmsp_sub", ti.root_msp1_submsp1_user1_token, ti.root_msp1_submsp1_user1_id,
						ti.root_msp1_submsp_org1_id, UUID.randomUUID().toString(), State.get(0), OSMajor.windows.name(),
						recoveredResourceType.get(0), spogServer.ReturnRandom("filter"), "true",
						ti.root_msp1_suborg1_user1_token },

				{ "rootmsp_sub-submsp", ti.root_msp1_suborg1_user1_token, ti.root_msp1_suborg1_user1_id,
						ti.root_msp1_suborg1_id, UUID.randomUUID().toString(), State.get(0), OSMajor.windows.name(),
						recoveredResourceType.get(0), spogServer.ReturnRandom("filter"), "true",
						ti.root_msp1_submsp1_user1_token },
	...
	// get the user defined job columns using csr/valid token
	@Test(dataProvider = "create_RecoveredResources_filter_invalid_403")
	public void createRecoveredResourcesFilterValid_403(String organizationType, String validToken, String user_id,
			String org_id, String policy_id, String state, String OSmajor, String recoveredResourceType,
		...
		test.log(LogStatus.INFO, "created filters in the organization with other org token");

		Response response = spogRecoveredResourceServer.createSpecifiedUserRecoveredResourcesFilters(user_id,
				otherorgToken, policy_id, state, OSmajor, recoveredResourceType, filter_name, is_default, test);
	...
	// get the user defined job columns using csr/valid token
	@Test(dataProvider = "create_RecoveredResources_filter_invalid")
	public void createRecoveredResourcesFilterValid_404(String organizationType, String validToken, String user_id,
			String org_id, String policy_id, String state, String OSmajor, String recoveredResourceType,
			String filter_name, String is_default) {
		...
		test.log(LogStatus.INFO, "created filters in the organization with random user id");

		Response response = spogRecoveredResourceServer.createSpecifiedUserRecoveredResourcesFilters(random_user_id,
				validToken, policy_id, state, OSmajor, recoveredResourceType, filter_name, is_default, test);

		spogRecoveredResourceServer.checkRecoveredResourceFilters(response, "", policy_id, state, OSmajor,
	...
	// get the user defined job columns using csr/valid token
	@Test(dataProvider = "create_RecoveredResources_filter_invalid")
	public void createRecoveredResourcesFilterValid_400(String organizationType, String validToken, String user_id,
			String org_id, String policy_id, String state, String OSmajor, String recoveredResourceType,
			String filter_name, String is_default) {
		...
		test.log(LogStatus.INFO, "created filters in the organization with invalid user id");

		Response response = spogRecoveredResourceServer.createSpecifiedUserRecoveredResourcesFilters(invalid_user_id,
				validToken, policy_id, state, OSmajor, recoveredResourceType, filter_name, is_default, test);
