...
public class DeleteloggedInUserRecoveredResourcesFiltersTest extends base.prepare.Is4Org {
	...
	public void deleteRecoveredResourcesFilterValid_401(String organizationType, String validToken, String user_id,
		...
		response = spogRecoveredResourceServer.deleteLoggedInUserRecoveredResourcesFilters(inValidToken, filter_id,
		...
		response = spogRecoveredResourceServer.deleteLoggedInUserRecoveredResourcesFilters(MissingToken, filter_id,
				SpogConstants.NOT_LOGGED_IN, test);
	...
	// get the user defined job columns using csr/valid token
	@Test(dataProvider = "delete_RecoveredResources_filter_invalid")
	public void deleteRecoveredResourcesFilterInValid_filter(String organizationType, String validToken, String user_id,
			String org_id, String policy_id, String state, String OSmajor, String recoveredResourceType,
			String filter_name, String is_default) {
		...
		test.log(LogStatus.INFO, "delete filters in the organization with invalid filter id");

		response = spogRecoveredResourceServer.deleteLoggedInUserRecoveredResourcesFilters(validToken, "abc",
		...
		response = spogRecoveredResourceServer.deleteLoggedInUserRecoveredResourcesFilters(validToken, invalidfilter,
