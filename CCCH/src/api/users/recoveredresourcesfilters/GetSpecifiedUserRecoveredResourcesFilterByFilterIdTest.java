...
public class GetSpecifiedUserRecoveredResourcesFilterByFilterIdTest extends base.prepare.Is4Org {
	...
	public void getRecoveredResourcesFilterValid_200(String organizationType, String validToken, String user_id,
		...
		response = spogRecoveredResourceServer.getSpecifiedUserRecoveredResourcesFilterByFilterId(user_id, filter_id,
				validToken, SpogConstants.SUCCESS_GET_PUT_DELETE, test);

		spogRecoveredResourceServer.checkRecoveredResourceFilters(response, filter_id, policy_id, state, OSmajor,
				RecoveredResourceType, filter_name, is_default, org_id, user_id, SpogConstants.SUCCESS_GET_PUT_DELETE,
	...
	public void getRecoveredResourcesFilterValid_401(String organizationType, String validToken, String user_id,
		...
		response = spogRecoveredResourceServer.getSpecifiedUserRecoveredResourcesFilterByFilterId(user_id, filter_id,
				MissingToken, SpogConstants.NOT_LOGGED_IN, test);
		...
		response = spogRecoveredResourceServer.getSpecifiedUserRecoveredResourcesFilterByFilterId(user_id, filter_id,
				inValidToken, SpogConstants.NOT_LOGGED_IN, test);
	...
	public void getRecoveredResourcesFilterValid_403(String organizationType, String validToken, String user_id,
		...
		response = spogRecoveredResourceServer.getSpecifiedUserRecoveredResourcesFilterByFilterId(user_id,
	...
	public void getRecoveredResourcesFilterValid_404(String organizationType, String validToken, String user_id,
		...
		Response response = spogRecoveredResourceServer.getSpecifiedUserRecoveredResourcesFilterByFilterId(user_id,
				random_filter_id, validToken, SpogConstants.RESOURCE_NOT_EXIST, test);

		spogRecoveredResourceServer.checkRecoveredResourceFilters(response, random_filter_id, policy_id, state, OSmajor,
