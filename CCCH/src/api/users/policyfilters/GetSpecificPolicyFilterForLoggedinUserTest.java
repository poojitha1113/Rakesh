...
public class GetSpecificPolicyFilterForLoggedinUserTest extends base.prepare.Is4Org{
...
//	private String buildVersion;
	...
	public void getPolicyFilterValidParamsTest(String user_name, String filter_name, String policy_name, String group_id,
		...
		Response response = userSpogServer.getSpecificPolicyFilterForLoggedinUser(filter_id, test);
	...
	public void getPolicyFilternoTokenTest(String user_name, String filter_name, String policy_name, String group_id,
			String last_backup_status, String status, String is_default, int status_code, String error_code) {
		
		userSpogServer.setToken("");
		userSpogServer.getSpecificPolicyFilterForLoggedinUserWithErrorCheck(UUID.randomUUID().toString(), status_code, error_code, test);
	}
	...
	public void getPolicyFilterInvalidID() {
		spogServer.userLogin(itd.getDirect_org_1_user_2_email(), password);
		userSpogServer.setToken(spogServer.getJWTToken());
		userSpogServer.getSpecificPolicyFilterForLoggedinUserWithErrorCheck(UUID.randomUUID().toString(), 404, "00A00A02", test);
		userSpogServer.getSpecificPolicyFilterForLoggedinUserWithErrorCheck("invalid_uuid", 400, "40000005", test);
	}
	...
	public void csrReadonlyTest() {
	    ...
	    userSpogServer.setToken(spogServer.getJWTToken());
		String policyId = userSpogServer.createPolicyFilterForLoggedinUserWithCheck("filter_name"+RandomStringUtils.randomAlphanumeric(8), "policy_name", UUID.randomUUID().toString(), 
				"active", "deploying", "true", test);
		userSpogServer.getSpecificPolicyFilterForLoggedinUser(policyId, test);
	}
