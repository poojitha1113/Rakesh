...
public class GetPolicyFiltersForLoggedinUserTest extends base.prepare.Is4Org{
...
//	private String buildVersion;
	...
	public final Object[][] getPolicyFilterValidParams() {
		return new Object[][] {
			{itd.getDirect_org_1_user_2_email(), 8},
			{itd.getMsp_org_1_user_2_email(), 8},
			{itd.getMsp_org_1_sub_1_user_2_email(), 8},
			{itd.getMsp_org_1_account_admin_1_email(), 8},
			{itd.getRoot_msp_org_1_account_admin_1_email(), 8},
			{itd.getRoot_msp_org_1_user_1_email(), 8},
			{itd.getRoot_msp_org_1_sub_msp_1_account_admin_1_email(), 8},
			{itd.getRoot_msp_org_1_sub_msp_1_user_1_email(), 8},
			{itd.getRoot_msp_org_1_account_1_user_1_email(), 8},
			{itd.getRoot_msp_org_1_monitor_user_1_email(), 8},
			{itd.getRoot_msp_org_1_sub_msp_1_monitor_user_1_email(), 8},
			{itd.getRoot_msp_org_1_account_1_monitor_user_1_email(), 8},
			{itd.getMsp_org_1_monitor_user_1_email(), 8},
			{itd.getDirect_org_1_monitor_user_1_email(), 8},
		};
	}
	
	@Test(dataProvider = "valid_params")
	public void getPolicyFilterValid(String username, int expectedNumber) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken(spogServer.getJWTToken());
		String prefix = RandomStringUtils.randomAlphanumeric(8);
		
		Response response = userSpogServer.getPolicyFiltersForLoggedinUser(test);
	...
	public final Object[][] getPolicyFilterNoTokenParams() {
		return new Object[][] {
			...
			{itd.getDirect_org_1_user_2_email(), 401, "00900006"},
		
		};
	}
	
	@Test(dataProvider = "no_token")
	public void getPolicyFilterNoToken(String username, int statusCode, String expectedErrorCode) {
		spogServer.userLogin(username, password);
		userSpogServer.setToken("");
	
		userSpogServer.getPolicyFiltersForLoggedinUserWithErrorCheck(statusCode, expectedErrorCode,test);
	}
	...
	public void getpolicyFiltersPagination(String filterStr, String sortStr, int pageNumber, int pageSize, String[] expectedFilterNames) {
		...
		Response response = userSpogServer.getPolicyFiltersForLoggedinUser(filterStr, sortStr, pageNumber, pageSize, test);
	...
	public void csrReadonlyTest() {
		...
		userSpogServer.getPolicyFiltersForLoggedinUser(test);
	}
