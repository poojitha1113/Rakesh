...
public class UpdateLogFilterTest extends base.prepare.PrepareOrgInfo{
	@Parameters({ "pmfKey"})
	public UpdateLogFilterTest(String pmfKey) {
		super(pmfKey);
...
//	  private String buildVersion;
	  ...
	  public void createFilterWithDifferentLogTs(String loginUserType,String log_ts){	 
		  ...
		  if (loginUserType.equalsIgnoreCase("csr")){
			  ...
			  no_permission_users_id=no_permission_id.split(",");	
			  permission_id=this.csrAdmin+","+this.final_root_msp_user_name_email;
			  permission_users_id=permission_id.split(",");
			  ...
			  no_permission_users_id=no_permission_id.split(",");	
			  permission_id=this.csrAdmin+","+this.final_sub_msp1_user_name_email;
			  permission_users_id=permission_id.split(",");
			  ...
			  no_permission_id=mspOrgEmailForPrepare1+","+directOrgEmailForPrepare+","+directOrgEmailForPrepare1+","+accountEmailForPrepare1+","+this.final_sub_msp2_account1_user_email+","+this.final_sub_msp2_user_name_email+","+this.final_root_msp_direct_org_user_email;
			  no_permission_users_id=no_permission_id.split(",");	
			  permission_id=this.csrAdmin+","+this.final_root_msp_direct_org1_user_email;
			  permission_users_id=permission_id.split(",");
			  ...
			  no_permission_id=mspOrgEmailForPrepare1+","+directOrgEmailForPrepare+","+directOrgEmailForPrepare1+","+accountEmailForPrepare1+","+this.final_sub_msp2_account1_user_email+","+this.final_sub_msp2_user_name_email+","+this.final_root_msp_direct_org1_user_email;
			  no_permission_users_id=no_permission_id.split(",");	
			  permission_id=this.csrAdmin+","+this.final_root_msp_user_name_email;
			  permission_users_id=permission_id.split(",");
			  ...
			  no_permission_users_id=no_permission_id.split(",");	
			  permission_id=this.csrAdmin+","+this.final_sub_msp2_account1_user_email;
			  permission_users_id=permission_id.split(",");
	  ...
	  public void updateFilterWithDifferentDefaultFlag(String loginUserType,String default_flag){	 
		  ...
		  test.log(LogStatus.INFO,"Login as "+loginUserType+" admin");	
		  String pre_filter_name=spogServer.returnRandomUUID();
		  String true_filter_id=log4SPOGServer.createLogFilterwithCheck(user_id, expected_organization_id, pre_filter_name,  null,null, "none", "none", "true",test);
		  
		  String tem_filter_name = spogServer.returnRandomUUID();
		  String false_filter_id=log4SPOGServer.createLogFilterwithCheck(user_id, expected_organization_id, tem_filter_name, null, null, "none", "none", "false",test);
		  if(default_flag==null || default_flag=="" || default_flag=="none" || default_flag=="false"){
			  log4SPOGServer.updateLogFilterwithCheck(user_id, true_filter_id,expected_organization_id,pre_filter_name+"dd", null, null, "none","none", default_flag,test);
			  ...
			  log4SPOGServer.updateLogFilterwithCheck(user_id, false_filter_id,expected_organization_id,pre_filter_name+"dd", null, null, "none","none", default_flag,test);
			  test.log(LogStatus.INFO,loginUserType+ " admin update filter with default_flag is null or emtpy string"); 			  
		  }		  
		  ...
		  if(permission_users_id!=null){
			  for(int i=0;i<permission_users_id.length;i++){
				  spogServer.userLogin(permission_users_id[i], OrgPwdForPrepare,test);
				  log4SPOGServer.updateLogFilterwithCheck(user_id, false_filter_id,expected_organization_id,pre_filter_name+"dd1",  null,null, "none","none", "true",test);
				  test.log(LogStatus.INFO,permission_users_id[i]+" can update others' filter"); 
			  }	
		  }
	  }
