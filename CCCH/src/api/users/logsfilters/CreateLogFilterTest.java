...
public class CreateLogFilterTest extends base.prepare.PrepareOrgInfo{
	@Parameters({ "pmfKey"})
	public CreateLogFilterTest(String pmfKey) {
		super(pmfKey);
...
//	  private String buildVersion;
	  ...
	  public void updateFilterWithDifferentDefaultFlag(String loginUserType,String default_flag){	 
		  ...
		  log4SPOGServer.createLogFilterwithCheck(user_id, expected_organization_id, filter_name, null,null, "none", "information", default_flag,test);
