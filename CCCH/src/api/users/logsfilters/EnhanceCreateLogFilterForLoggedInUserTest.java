...
public class EnhanceCreateLogFilterForLoggedInUserTest extends base.prepare.PrepareOrgInfo{
	@Parameters({ "pmfKey"})
	public EnhanceCreateLogFilterForLoggedInUserTest(String pmfKey) {
		super(pmfKey);
...
//	  private String buildVersion;
	  ...
	  public void createFilterWithDifferentMessageId(String loginUserType,String messageId){	 
		  ...
		  if(messageId!=null && messageId.equalsIgnoreCase("invalidString")){
			  ...
			  log4SPOGServer.createLogFilterForLoggedInUserFailedWithExpectedStatusCode(user_id, expected_organization_id, filter_name, null, null, job_type, serverity, "false",messageId,"none","none","none","none",SpogConstants.REQUIRED_INFO_NOT_EXIST, errorCode,test);
			  test.log(LogStatus.INFO,loginUserType+ " admin create log filter with message Id is "+messageId+" failed"); 
		  }else{
			  log4SPOGServer.createLogFilterForLoggedInUserwithCheck(user_id, expected_organization_id, filter_name,  null,null, job_type, serverity, "false",messageId,"none","none","none","none",test);
	  ...
	  public void createFilterWithDifferentMessage(String loginUserType,String message){	 
		  ...
		  if(message!=null && message.equalsIgnoreCase("invalidString")){
			  //String[] timeRange ={"2018-01-01 00:00:00","2018-01-18 00:00:00"};
			  errorCode=ErrorCode.NOT_VALID_ENUM;
			  log4SPOGServer.createLogFilterForLoggedInUserFailedWithExpectedStatusCode(user_id, expected_organization_id, filter_name, null, null, job_type, serverity, "false","none","none",message,"none","none",SpogConstants.REQUIRED_INFO_NOT_EXIST, errorCode,test);
			  test.log(LogStatus.INFO,loginUserType+ " admin create log filter with message is "+message+" failed"); 
		  }else{
			  log4SPOGServer.createLogFilterForLoggedInUserwithCheck(user_id, expected_organization_id, filter_name, null, null, job_type, serverity, "false","none","none",message,"none","none",test);
	  ...
	  public void createFilterWithDifferentSourceName(String loginUserType,String sourceName){	 
		  ...
		  if(sourceName!=null && sourceName.equalsIgnoreCase("invalidString")){
			  //String[] timeRange ={"2018-01-01 00:00:00","2018-01-18 00:00:00"};
			  errorCode=ErrorCode.NOT_VALID_ENUM;
			  log4SPOGServer.createLogFilterForLoggedInUserFailedWithExpectedStatusCode(user_id, expected_organization_id, filter_name, null, null, job_type, serverity, "false","none","none","none",sourceName,"none",SpogConstants.REQUIRED_INFO_NOT_EXIST, errorCode,test);
			  test.log(LogStatus.INFO,loginUserType+ " admin create log filter with source name is "+sourceName+" failed"); 
		  }else{
			  log4SPOGServer.createLogFilterForLoggedInUserwithCheck(user_id, expected_organization_id, filter_name, null, null, job_type, serverity, "false","none","none","none",sourceName,"none",test);
	  ...
	  public void createFilterWithDifferentOrigin(String loginUserType,String origin){	 
		  ...
		  if(origin!=null && origin.equalsIgnoreCase("invalidString")){
			  //String[] timeRange ={"2018-01-01 00:00:00","2018-01-18 00:00:00"};
			  errorCode=ErrorCode.NOT_VALID_ENUM;
			  log4SPOGServer.createLogFilterForLoggedInUserFailedWithExpectedStatusCode(user_id, expected_organization_id, filter_name,  null,null, job_type, serverity, "false","none","none","none","none",origin,SpogConstants.REQUIRED_INFO_NOT_EXIST, errorCode,test);
			  test.log(LogStatus.INFO,loginUserType+ " admin create log filter with origin is "+origin+" failed"); 
		  }else{
			  log4SPOGServer.createLogFilterForLoggedInUserwithCheck(user_id, expected_organization_id, filter_name, null, null, job_type, serverity, "false","none","none","none","none",origin,test);
	  ...
	  public void createFilterWithDifferentSourceId(String loginUserType,String sourceId){	 
		  ...
		  if(sourceId!=null && sourceId.equalsIgnoreCase("invalidString")){
			  //String[] timeRange ={"2018-01-01 00:00:00","2018-01-18 00:00:00"};
			  errorCode=ErrorCode.NOT_VALID_ENUM;
			  log4SPOGServer.createLogFilterForLoggedInUserFailedWithExpectedStatusCode(user_id, expected_organization_id, filter_name, null, null, job_type, serverity, "false","none",sourceId,"none","none","none",SpogConstants.REQUIRED_INFO_NOT_EXIST, errorCode,test);
			  test.log(LogStatus.INFO,loginUserType+ " admin create log filter with source Id is "+sourceId+ " failed"); 
		  }else{
			  log4SPOGServer.createLogFilterForLoggedInUserwithCheck(user_id, expected_organization_id, filter_name, null, null, job_type, serverity, "false","none",sourceId,"none","none","none",test);
