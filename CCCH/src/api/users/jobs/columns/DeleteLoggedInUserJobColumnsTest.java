...
public class DeleteLoggedInUserJobColumnsTest extends base.prepare.Is4Org {
	...
	public void DeleteJobColumnsForLoggedInUser_200(String organizationType, String validToken, String[] sort,
	...
	public final Object[][] createJobColumnInValidParams() {
		...
		return new Object[][] {
				{ "MSP ADMIN ACCOUNT", ti.normal_msp_org1_msp_accountadmin1_token,
						new String[] { "true", "false", "none" }, new String[] { "true", "false", "none" },
	...
	// Delete job columns with Invalid Jwt token, Missed Token

	@Test(dataProvider = "delete_job_Column_Invalid")
	public void DeleteJobColumnsForLoggedInUser_401(String organizationType, String validToken, String[] sort,
			String[] filter, String[] visible, String[] orderId, int userInput) {
		...
		spogJobServer.deleteJobColumnsForLoggedInUser(Not_valid_Token, SpogConstants.NOT_LOGGED_IN,
				SpogMessageCode.COMMON_AUTENTICATION_FAILED_FOR_JWT, test);

		String MissingToken = "";

		test.log(LogStatus.INFO, "deleting the job columns in org: with the Missing Token");
		spogJobServer.deleteJobColumnsForLoggedInUser(MissingToken, SpogConstants.NOT_LOGGED_IN,
	...
	@Test(dataProvider = "delete_job_Column_Invalid")
	public void DeleteJobColumnsForLoggedInUser_404(String organizationType, String validToken, String[] sort,
			String[] filter, String[] visible, String[] orderId, int userInput) {
	...
	public final Object[][] delete_job_Column_msp_admin_account() {
		...
		return new Object[][] { { "suborg_mspadmin", ti.normal_msp_org1_msp_accountadmin1_token,
				new String[] { "true", "false", "none" }, new String[] { "true", "false", "none" },
				new String[] { "true", "false", "none" }, new String[] { "4", "7", "3", "2", }, 4 }
	...
	public void DeleteJobColumnsForLoggedInUser_msp_admin_account(String organizationType, String validToken,
		...
		test.log(LogStatus.INFO, "deleting the created job columns in org: " + organizationType
				+ " with the valid msp admin account Token");

		spogJobServer.deleteJobColumnsForLoggedInUser(ti.normal_msp_org1_msp_accountadmin1_token,
