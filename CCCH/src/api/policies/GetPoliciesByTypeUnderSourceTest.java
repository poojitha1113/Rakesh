...
public class GetPoliciesByTypeUnderSourceTest extends base.prepare.PrepareOrgInfo{
	@Parameters({ "pmfKey"})
	public GetPoliciesByTypeUnderSourceTest(String pmfKey) {
		super(pmfKey);
...
//	  private String direct_source_name="shaji02-spog2";
	  ...
	  public final Object[][] getLoginUserToGetPolicy4ValidSource() {
			return new Object[][] { 
				{"csr",this.direct_source_id},				
				{"msp",this.direct_source_win7},
				{"msp",this.direct_source_win10},				
				{"account",this.direct_source_win7},
				{"account",this.direct_source_win10},
	  ...
	  public void getPolicy4ValidSource(String loginUserType,String source_id){	 
		  ...
		  response=policy4SPOGServer.getPoliciesByTypeUnderSource(source_id,  test);
...
//			  }
	  ...
	  public final Object[][] getLoginUserToGetPolicy4ValidSource1() {
			return new Object[][] { 
				...
				{"msp",this.direct_source_id},
				
				{"account",this.direct_source_id}
				};
	  }
	  ...
	  public final Object[][] getLoginUserToGetPolicy4InvalidSource() {
			return new Object[][] { 
				...
				{"csr",this.direct_udp_source_id},
				{"csr",this.direct_udp_source_id1},
