...
public class GetPoliciesBackuptypesTest extends base.prepare.Is4Org {
   ...
   * @testcase
   * 0 csr admin could get /policies/backuptypes
   * 1 direct admin could get /policies/backuptypes
	 2 MSP admin could get /policies/backuptypes
	 3 account admin could get /policies/backuptypes
	 4.MSP account admin could get /policies/backuptypes
   * @author leiyu.wang
   * @param userName
   * @param password
 * @throws JSONException 
  ...
  public void getBackuptypes(String userName,String password)  {
		...
		spogDestinationServer.getPoliciesBackuptypes(SpogConstants.SUCCESS_GET_PUT_DELETE, test);	 	 
  }
